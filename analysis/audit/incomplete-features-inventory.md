...
생성: `2026-08-23T23:02:50.750566+00:00` (`debug/generate_incomplete_features_inventory.py`)
...
- `도서물류관리프로그램/backend/app/routers/returns.py:742` — `status_code=status.HTTP_501_NOT_IMPLEMENTED,`
