# 화면 카드: Sobo24 (TSobo24)

_생성: 2026-04-18 04:10 UTC — `tools/analysis/screen_card_builder.py`_

## 0. 한눈 요약
- 파일(DFM): /Users/speeno/Delphi_porting/legacy_delphi_source/legacy_source/Subu24.dfm
- 파일(PAS 추정): /Users/speeno/Delphi_porting/legacy_delphi_source/legacy_source/Subu24.pas
...
## 1. UI 구성
### TSobo24 — /Users/speeno/Delphi_porting/legacy_delphi_source/legacy_source/Subu24.dfm
...
- 레이아웃 메타: (없음 — `analysis/form_layouts/Sobo24.json` 미생성)
...
| OnActivate | 1 | Sobo24 | FormActivate |
| OnClose | 1 | Sobo24 | FormClose |
| OnShow | 1 | Sobo24 | FormShow |
...
- L298 **SELECT** `S1_Ssub` — `Select * From S1_Ssub Where`
- L317 **SELECT** `G4_Book` — `Select Gname,Gjeja From G4_Book Where`
...
- (수동) 위 문서에서 form `Sobo24` 또는 인접 unit 검색.
