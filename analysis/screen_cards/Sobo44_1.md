# 화면 카드: Sobo44_1 (TSobo44_1)

_생성: 2026-04-18 04:10 UTC — `tools/analysis/screen_card_builder.py`_

## 0. 한눈 요약
- 파일(DFM): /Users/speeno/Delphi_porting/legacy_delphi_source/legacy_source/Subu44_1.dfm
- 파일(PAS 추정): /Users/speeno/Delphi_porting/legacy_delphi_source/legacy_source/Subu44_1.pas
...
## 1. UI 구성
### TSobo44_1 — /Users/speeno/Delphi_porting/legacy_delphi_source/legacy_source/Subu44_1.dfm
...
- 레이아웃 메타: (없음 — `analysis/form_layouts/Sobo44_1.json` 미생성)
...
| OnActivate | 1 | Sobo44_1 | FormActivate |
| OnClose | 1 | Sobo44_1 | FormClose |
| OnShow | 1 | Sobo44_1 | FormShow |
...
- L330 **SELECT** `T7_Ssub` — `Select * From T7_Ssub Where`
- L345 **SELECT** `G7_Ggeo` — `Select Gname From G7_Ggeo Where`
...
- (수동) 위 문서에서 form `Sobo44_1` 또는 인접 unit 검색.
