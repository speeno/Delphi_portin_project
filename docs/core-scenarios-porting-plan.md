...
| ID | 항목 | 우선순위 |
|----|------|---------|
| OQ-RT-1 | `D_Select` 기반 권한키 분기 구현 (DEC-009 해제 필요) | Phase 2 |
| OQ-RT-2 | Sobo34_4 반품 원장 보고서 + Sobo58 기간별 반품내역서 | Phase 2 |
| OQ-RT-3 | DB 기반 audit 비밀번호 검증 + 실패 횟수 추적 (DEC-029 완전 구현) | Phase 2 |

## 8. 변경 이력

- 2026-04-19 — §7 C4 반품 처리 1차 완료 현황 + OQ-RT-1/2/3 Phase 2 권고 추가. DEC-029 동결.
