...
procedure TSobo43_1.FormActivate(Sender: TObject);
begin
  nForm:='43_1';
  nSqry:=T4_Sub31;
  mSqry:=T4_Sub32;
...
procedure TSobo43_1.FormShow(Sender: TObject);
begin
  T00:=0;
  Edit101.Text:=FormatDateTime('yyyy"."mm"."dd',Date);
end;

procedure TSobo43_1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo43_1:=nil;
...
procedure TSobo43_1.Button001Click(Sender: TObject);
begin
...
procedure TSobo43_1.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo43_1.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo43_1.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo43_1.Button011Click(Sender: TObject);
begin
{ Tong20.DBGridSaveHtml(DBGrid201, Caption); }
end;

procedure TSobo43_1.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo43_1.Button013Click(Sender: TObject);
begin
{ oSqry:=mSqry;
  Base10.ColumnX1(oSqry,DBGrid201,ProgressBar1); }
end;

procedure TSobo43_1.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('43-01');
end;

procedure TSobo43_1.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('43-02');
end;

procedure TSobo43_1.Button016Click(Sender: TObject);
begin
  Tong40.print_43_01(Self);
end;

procedure TSobo43_1.Button017Click(Sender: TObject);
begin
{ Tong40.print_43_02(Self); }
end;

procedure TSobo43_1.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont4(DBGrid101);
end;

procedure TSobo43_1.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Button101Click(Sender: TObject);
var St1,St2: String;
begin
//if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;
  ...
  St1:=St1+' and '+'('+'Check is null '+' or '+'Check'+'<>'+#39+'A'+#39+')';

  St2:=' Order By Gdate,Hcode,Gname';

  {-H1_Ssub-}
  Sqlen := 'Select * From T7_Ssub Where '+D_Select+St1+St2;
  ...
  nSqry.BeforePost:=T4_Sub31BeforePost;

  Tong40.Hide;
{ Tong40.Free; }
end;

procedure TSobo43_1.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo43_1.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo43_1.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo43_1.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo43_1.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo43_1.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo43_1.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo43_1.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo43_1.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
      Button101Click(Self);
  end;
...
procedure TSobo43_1.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo43_1.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo43_1.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo43_1.DBGrid101Exit(Sender: TObject);
begin
  T4_Sub31BeforeClose(Base10.T4_Sub31);
end;

procedure TSobo43_1.DBGrid101Enter(Sender: TObject);
begin
//
end;

procedure TSobo43_1.DBGrid101KeyPress(Sender: TObject; var Key: Char);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
...
procedure TSobo43_1.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
...
procedure TSobo43_1.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo43_1.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo43_1.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo43_1.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo43_1.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo43_1.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo43_1.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo43_1.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo43_1.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo43_1.Button701Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit301.Text;
...
procedure TSobo43_1.BitBtn101Click(Sender: TObject);
begin
  Edit300.Text:='';
  Edit301.Text:='';
  Edit302.Text:='';
...
procedure TSobo43_1.BitBtn102Click(Sender: TObject);
begin
...
procedure TSobo43_1.BitBtn103Click(Sender: TObject);
begin
  T4_Sub31AfterDelete(nSqry);
  BitBtn101Click(Self);
  Edit301.SetFocus;
end;

procedure TSobo43_1.BitBtn104Click(Sender: TObject);
begin
if Edit301.Text<>'' then begin
...
procedure TSobo43_1.BitBtn105Click(Sender: TObject);
begin
  BitBtn101Click(Self);
  Edit301.SetFocus;
end;

procedure TSobo43_1.BitBtn106Click(Sender: TObject);
begin
...
//--반 품 비--//
procedure TSobo43_1.T4_Sub31AfterCancel(DataSet: TDataSet);
begin
  T4_Sub31AfterScroll(T4_Sub31);
end;

procedure TSobo43_1.T4_Sub31AfterScroll(DataSet: TDataSet);
begin
  Gdate:= T4_Sub31.FieldByName('Gdate').AsString;
  Gssum:=-T4_Sub31.FieldByName('Gssum').AsFloat;
end;

procedure TSobo43_1.T4_Sub31AfterPost(DataSet: TDataSet);
begin
//
end;

procedure TSobo43_1.T4_Sub31AfterDelete(DataSet: TDataSet);
var MeDlg: Integer;
begin
  ...
  mrYes: begin
    ...
    Sqlen := 'DELETE FROM T7_Ssub WHERE ID=@ID and Gdate=''@Gdate''';
...
procedure TSobo43_1.T4_Sub31BeforePost(DataSet: TDataSet);
begin

  if(T4_Sub31.State=dsInsert)Then begin

    Sqlen := 'INSERT INTO T7_Ssub '+
    ...
    Base10.Update_ID(nSqry,'T7_SSUB_ID_GEN');

  end else begin

    Sqlen := 'UPDATE T7_Ssub SET '+
...
procedure TSobo43_1.T4_Sub31BeforeClose(DataSet: TDataSet);
begin
  With T4_Sub31 do
  if(State in dsEditModes)Then Post;
end;

procedure TSobo43_1.T4_Sub31NewRecord(DataSet: TDataSet);
begin
  T4_Sub31Gssum.Value:=0;
  T4_Sub31Gdate.Value:=Sobo43_1.Edit101.Text;
end;
