...
procedure TSobo34_2.FormActivate(Sender: TObject);
begin
  nForm:='34_2';
  nSqry:=T3_Sub41;
  mSqry:=T3_Sub42;
...
procedure TSobo34_2.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo34_2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo34_2:=nil;
...
procedure TSobo34_2.Button001Click(Sender: TObject);
begin
...
procedure TSobo34_2.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo34_2.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo34_2.Button004Click(Sender: TObject);
begin
  Base10.OpenExit(nSqry);
  Base10.OpenExit(mSqry);
{ Tong20.Srart_34_01(Self);
...
{ if Sobo34_2.Panel102.Caption ='창고도서' Then begin
     Sobo34_2.Panel102.Caption:='도 서 명';
  end else
  if Sobo34_2.Panel102.Caption ='도 서 명' Then begin
     Sobo34_2.Panel102.Caption:='본사도서';
  end else
  if Sobo34_2.Panel102.Caption ='본사도서' Then begin
     Sobo34_2.Panel102.Caption:='창고도서';
  end; }
  Edit101.SetFocus;
end;

procedure TSobo34_2.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('34');
end;

procedure TSobo34_2.Button006Click(Sender: TObject);
begin
  T00:=1;
  Button201Click(Self);
end;

procedure TSobo34_2.Button007Click(Sender: TObject);
begin
  T00:=0;
  Button201Click(Self);
end;

procedure TSobo34_2.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('34');
end;

procedure TSobo34_2.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Out_01('34');
end;

procedure TSobo34_2.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo34_2.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo34_2.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY2(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo34_2.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY2(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo34_2.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('34-01');
end;

procedure TSobo34_2.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('34-02');
end;

procedure TSobo34_2.Button016Click(Sender: TObject);
begin
  Tong40.print_34_01(Self);
end;

procedure TSobo34_2.Button017Click(Sender: TObject);
begin
  Tong40.print_34_02(Self);
end;

procedure TSobo34_2.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo34_2.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo34_2.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo34_2.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo34_2.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo34_2.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo34_2.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo34_2.Button101Click(Sender: TObject);
begin
...
procedure TSobo34_2.Button102Click(Sender: TObject);
...
procedure TSobo34_2.Button103Click(Sender: TObject);
var St1,St2,St3,St4,St5,St6: String;
    nSumX,nSumY: Double;
...
procedure TSobo34_2.Button201Click(Sender: TObject);
var St1: String;
begin
  Refresh;
  if(T00=0)Then begin
...
procedure TSobo34_2.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo34_2.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo34_2.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo34_2.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo34_2.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo34_2.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo34_2.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo34_2.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo34_2.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo34_2.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo34_2.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
...
procedure TSobo34_2.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo34_2.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo34_2.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo34_2.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo34_2.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo34_2.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo34_2.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo34_2.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo34_2.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo34_2.Button701Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit104.Text;
...
procedure TSobo34_2.Button702Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit106.Text;
