...
procedure TSobo22.FormActivate(Sender: TObject);
begin
  nForm:='22';
  nSqry:=Base10.T2_Sub21;
  mSqry:=Base10.T2_Sub22;
end;

procedure TSobo22.FormShow(Sender: TObject);
begin
  T00:=0;
  Edit101.Text:=FormatDateTime('yyyy"."mm"."dd',Date);
end;

procedure TSobo22.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo22:=nil;
...
procedure TSobo22.Button001Click(Sender: TObject);
begin
...
procedure TSobo22.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo22.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo22.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button005Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo22.Button006Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
    nSqry.First;
    While nSqry.EOF=False do begin
      if(nSqry.FieldByName('Yesno').AsString='2')or
        (nSqry.FieldByName('Yesno').AsString='1')or
        (nSqry.FieldByName('Yesno').AsString='0')then begin
      nSqry.Edit;
      nSqry.FieldByName('Yesno').AsString:='3';
      nSqry.Post;
      end;
      nSqry.Next;
    end;
    ...
    nSqry.First;
    if nSqry.FieldByName('Yesno').AsString<>'4' then
...
procedure TSobo22.Button007Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
    nSqry.First;
    While nSqry.EOF=False do begin
      if(nSqry.FieldByName('Yesno').AsString='3')or
        (nSqry.FieldByName('Yesno').AsString='2')or
        (nSqry.FieldByName('Yesno').AsString='1')or
        (nSqry.FieldByName('Yesno').AsString='0')then begin
      nSqry.Edit;
      nSqry.FieldByName('Yesno').AsString:='4';
      nSqry.Post;
      end;
      nSqry.Next;
    end;
...
procedure TSobo22.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo22.Button011Click(Sender: TObject);
begin
{ Tong20.DBGridSaveHtml(DBGrid201, Caption); }
end;

procedure TSobo22.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY0(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo22.Button013Click(Sender: TObject);
begin
{ oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1); }
end;

procedure TSobo22.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('22-01');
end;

procedure TSobo22.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('22-02');
end;

procedure TSobo22.Button016Click(Sender: TObject);
begin
  nSqry.First;
  While nSqry.EOF=False do begin
...
procedure TSobo22.Button017Click(Sender: TObject);
begin
  Button501Click(Self);
end;

procedure TSobo22.Button018Click(Sender: TObject);
begin
  Seak60.ShowModal;
end;

procedure TSobo22.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont4(DBGrid101);
end;

procedure TSobo22.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Button101Click(Sender: TObject);
begin
  if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;

  if Base10.Seek_Hgeo('Y',Edit104.Text,Edit107.Text)='X' Then Exit;
  ...
  nSqry.BeforePost:=Base10.T2_Sub21BeforePost;

  Tong40.Hide;
{ Tong40.Free; }
end;

procedure TSobo22.Button201Click(Sender: TObject);
var X: Word;
begin
    ...
    if Count > 0 then begin
      for X:=0 to Count-1 do begin
        ...
        { Sqlen := 'Select Grat1,Gssum From G6_Ggeo '+
                   'Where '+D_Select+'Gcode=''@Gcode'' and Bcode=''@Bcode'' and  and Hcode=''@Hcode''';
          Translate(Sqlen, '@Gcode', nSqry.FieldByName('Gcode').AsString);
...
procedure TSobo22.Button301Click(Sender: TObject);
begin
...
procedure TSobo22.Button401Click(Sender: TObject);
begin
...
procedure TSobo22.Button501Click(Sender: TObject);
begin
//
end;

procedure TSobo22.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo22.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo22.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo22.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo22.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo22.Edit112KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGridEh;
    Edits: TFlatComboBox;
begin
...
procedure TSobo22.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
procedure TSobo22.Edit113KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    Edits: TFlatComboBox;
begin
...
procedure TSobo22.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var Edits: TFlatComboBox;
begin
  Edits:=Edit106;
  if Edits.DropDownCount=9 Then begin
...
procedure TSobo22.Edit114KeyPress(Sender: TObject; var Key: Char);
var Str,St1: String;
begin
  if Key=#13 Then begin
  ...
  if(Edit104.Focused=True)or(Edit105.Focused=True)Then begin
    ...
    if Edit105.Focused=True Then begin
      ...
      Seek20.FilterTing(Edit105.Text,Edit107.Text);
      if Seek20.Query1.IsEmpty=True Then Exit;
    end;
    if Seek20.Query1.RecordCount=1 Then begin
      ...
      Edit202.Text:=Seek20.Query1Gtel1.AsString+'-'+Seek20.Query1Gtel2.AsString;
    //Edit204.Text:=Seek20.Query1Gadd1.AsString+' '+Seek20.Query1Gadd2.AsString;
...
procedure TSobo22.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo22.DBGrid101Exit(Sender: TObject);
begin
  Base10.T2_Sub21BeforeClose(Base10.T2_Sub21);
end;

procedure TSobo22.DBGrid101Enter(Sender: TObject);
var DGrid: TDBGridEh;
begin
  DGrid:=DBGrid101;
  if Edit102.Text='입고' Then begin
    DGrid.Columns.Items[0].PickList.Clear;
    DGrid.Columns.Items[0].PickList.Add('신간');
    DGrid.Columns.Items[0].PickList.Add('재판');
    DGrid.Columns.Items[0].PickList.Add('재생');
    DGrid.Columns.Items[0].PickList.Add('개정');
    DGrid.Columns.Items[0].PickList.Add('인상');
    DGrid.Columns.Items[0].PickList.Add('인하');
    DGrid.Columns.Items[0].PickList.Add('이동');
  { DGrid.Columns.Items[0].PickList.Add('위탁');
    DGrid.Columns.Items[0].PickList.Add('현매');
    DGrid.Columns.Items[0].PickList.Add('매절');
    DGrid.Columns.Items[0].PickList.Add('납품');
  ...
  Base10.T2_Sub21AfterScroll(Base10.T2_Sub21);
end;

procedure TSobo22.DBGrid101KeyPress(Sender: TObject; var Key: Char);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
  ...
  if Key=#13 Then begin
    ...
    //Tong20.PrinRat1(Edit107,Edit104,'');
    ...
    //Tong20.PrinRat1(Edit107,Edit104,nSqry.FieldByName('Bcode').AsString);
...
procedure TSobo22.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
  ...
  if sColumn=False Then begin
    ...
    if Key=VK_DELETE Then Base10.T2_Sub21AfterDelete(nSqry);
    if Key=VK_ESCAPE Then Edit101.SetFocus;
  end; end;
end;

procedure TSobo22.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo22.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo22.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo22.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo22.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo22.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo22.Edit301KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then
  Button801Click(Self);
end;

procedure TSobo22.Button801Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo22.Button802Click(Sender: TObject);
var St1: String;
begin
  if nSqry.Active=True Then begin
  Sqlen := 'Select Gname,Gadd1,Gadd2,Gtel1,Gtel2,Gposa From G2_Ggwo Where '+D_Select+
...
procedure TSobo22.Button803Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
  Cpost:='22';
...
procedure TSobo22.Edit205Click(Sender: TObject);
begin
...
procedure TSobo22.Edit205Exit(Sender: TObject);
begin
  StaticText1.Visible:=False;
  StaticText2.Visible:=False;
  StaticText3.Visible:=False;
...
procedure TSobo22.StaticText1Click(Sender: TObject);
begin
  StaticText1.Visible:=False;
  Edit205.SetFocus;
end;

procedure TSobo22.StaticText2Click(Sender: TObject);
begin
  StaticText2.Visible:=False;
  Edit206.SetFocus;
end;

procedure TSobo22.StaticText3Click(Sender: TObject);
begin
  StaticText3.Visible:=False;
  Edit207.SetFocus;
end;

procedure TSobo22.StaticText4Click(Sender: TObject);
begin
  StaticText4.Visible:=False;
  Edit208.SetFocus;
end;

procedure TSobo22.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo22.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo22.Button701Click(Sender: TObject);
begin
...
procedure TSobo22.Button702Click(Sender: TObject);
var Str,St1: String;
begin
  Seek20.Edit1.Text:=Edit105.Text;
  if Edit105.Text='' then
  Seek20.FilterTing('',Edit107.Text) else
  Seek20.FilterTing(Edit105.Text,Edit107.Text);
  if Seek20.ShowModal=mrOK Then begin
      Edit104.Text:=Seek20.Query1Gcode.AsString;
      Edit105.Text:=Seek20.Query1Gname.AsString;
