...
procedure TSobo53.FormActivate(Sender: TObject);
begin
  nForm:='53';
  nSqry:=Base10.T5_Sub31;
  mSqry:=Base10.T5_Sub32;
end;

procedure TSobo53.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo53.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo53:=nil;
...
procedure TSobo53.Button001Click(Sender: TObject);
begin
...
procedure TSobo53.Button002Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
...
procedure TSobo53.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo53.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo53.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo53.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo53.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo53.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo53.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo53.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('53-01');
end;

procedure TSobo53.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('53-02');
end;

procedure TSobo53.Button016Click(Sender: TObject);
begin
  Tong40.print_53_01(Self);
end;

procedure TSobo53.Button017Click(Sender: TObject);
begin
  Tong40.print_53_02(Self);
end;

procedure TSobo53.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo53.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo53.Button101Click(Sender: TObject);
...
procedure TSobo53.Button201Click(Sender: TObject);
...
procedure TSobo53.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo53.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo53.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo53.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo53.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo53.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo53.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo53.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo53.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo53.Edit115KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo53.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo53.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo53.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo53.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo53.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo53.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo53.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if mSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
  end;
...
procedure TSobo53.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo53.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo53.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo53.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
...
procedure TSobo53.DBGrid201DblClick(Sender: TObject);
begin
...
procedure TSobo53.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo53.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo53.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo53.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo53.Button701Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit104.Text;
...
procedure TSobo53.Button702Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit106.Text;
