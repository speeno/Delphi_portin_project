...
begin
  nForm:='63';
  nSqry:=Base10.T6_Sub31;
  mSqry:=Base10.T6_Sub32;
end;
...
begin
  ...
  Base10.OpenExit(mSqry);
  Tong20.Srart_63_01(Self);
  Tong20.Srart_63_02(Self);
  Tong20.Chang_00_01('63');
  Edit101.SetFocus;
end;

procedure TSobo63.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('63');
end;
...
begin
  Tong20.Print_00_00('63-01');
end;

procedure TSobo63.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('63-02');
end;
...
begin
  ...
  {-Sg_Csum-}
  Sqlen :=
  'Select Gdate,Gbsum From Sg_Csum Where '+St1;
...
begin
  ...
  if((Edit104.Focused=True)and(Edit104.SelStart=40)and(Length(Trim(Edit104.Text))=40))or
    ...
    ((Edit108.Focused=True)and(Edit108.SelStart=40)and(Length(Trim(Edit108.Text))=24))Then begin
...
procedure TSobo63.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo63.DBGrid201TitleClick(Column: TColumnEh);
begin
...
procedure TSobo63.Button702Click(Sender: TObject);
begin
    Seek40.Edit1.Text:='';
    Seek40.FilterTing(' ',Edit107.Text);
    if Seek40.Query1.RecordCount=1 Then begin
