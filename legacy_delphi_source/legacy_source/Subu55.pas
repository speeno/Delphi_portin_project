...
procedure TSobo55.FormActivate(Sender: TObject);
begin
  nForm:='55';
  nSqry:=Base10.T5_Sub51;
  mSqry:=Base10.T5_Sub52;
end;

procedure TSobo55.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo55.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo55:=nil;
...
procedure TSobo55.Button001Click(Sender: TObject);
begin
...
procedure TSobo55.Button002Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_55_02(Self);
  end; }
end;

procedure TSobo55.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo55.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo55.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo55.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo55.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo55.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo55.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo55.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('55-01');
end;

procedure TSobo55.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('55-02');
end;

procedure TSobo55.Button016Click(Sender: TObject);
begin
  Tong40.print_55_01(Self);
end;

procedure TSobo55.Button017Click(Sender: TObject);
begin
  Tong40.print_55_02(Self);
end;

procedure TSobo55.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo55.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo55.Button101Click(Sender: TObject);
...
procedure TSobo55.Button201Click(Sender: TObject);
...
procedure TSobo55.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo55.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo55.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo55.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo55.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo55.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo55.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo55.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo55.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo55.Edit115KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo55.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo55.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo55.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo55.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo55.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo55.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo55.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if mSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
  end;
...
procedure TSobo55.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo55.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo55.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo55.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
  ...
  nSqry.Filter:=St1;
  nSqry.Filtered:=True;
  Tong20.Srart_55_01(Self);
end;

procedure TSobo55.DBGrid201DblClick(Sender: TObject);
begin
  if(nSqry.RecordCount>0)Then begin
  Subu00.Menu203Click(Self);
  Sobo23.Edit103.Text:=Base10.T5_Sub51.FieldByName('Jubun').AsString;
  Sobo23.Edit101.Text:=Base10.T5_Sub51.FieldByName('Gdate').AsString;
  Sobo23.Edit104.Text:=Base10.T5_Sub51.FieldByName('Gcode').AsString;
  Sobo23.Edit105.Text:=Base10.T5_Sub51.FieldByName('Gname').AsString;
  Sobo23.Edit107.Text:=Base10.T5_Sub52.FieldByName('Hcode').AsString;
  Sobo23.Edit108.Text:=Base10.T5_Sub52.FieldByName('Hname').AsString;
  Sobo23.Label100.Visible:=False;
  Sobo23.Edit106.Visible:=False;
  Sobo23.Edit106.Items.Clear;
  if Base10.T5_Sub51.FieldByName('Gjisa').AsString<>'' then begin
  Sobo23.Label100.Visible:=True;
  Sobo23.Edit106.Visible:=True;
  Sobo23.Edit106.Items.Add(Base10.T5_Sub51.FieldByName('Gjisa').AsString);
...
procedure TSobo55.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo55.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo55.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo55.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo55.Button701Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit104.Text;
...
procedure TSobo55.Button702Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit106.Text;
