...
procedure TSobo62.FormActivate(Sender: TObject);
begin
  nForm:='62';
  nSqry:=Base10.T6_Sub21;
  mSqry:=Base10.T6_Sub22;
end;

procedure TSobo62.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo62.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo62:=nil;
...
procedure TSobo62.Button001Click(Sender: TObject);
begin
...
procedure TSobo62.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_62_01(Self);
  end;
end;

procedure TSobo62.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo62.Button004Click(Sender: TObject);
begin
  Base10.OpenExit(nSqry);
  Base10.OpenExit(mSqry);
  Tong20.Srart_62_01(Self);
  Tong20.Srart_62_02(Self);
  Tong20.Chang_00_01('62');
  Edit101.SetFocus;
end;

procedure TSobo62.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('62');
end;

procedure TSobo62.Button006Click(Sender: TObject);
begin
  T00:=1;
  Button201Click(Self);
end;

procedure TSobo62.Button007Click(Sender: TObject);
begin
  T00:=0;
  Button201Click(Self);
end;

procedure TSobo62.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('62');
end;

procedure TSobo62.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Out_01('62');
end;

procedure TSobo62.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo62.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo62.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY2(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo62.Button013Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY2(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo62.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('62-01');
end;

procedure TSobo62.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('62-02');
end;

procedure TSobo62.Button016Click(Sender: TObject);
begin
  Tong40.print_62_01(Self);
end;

procedure TSobo62.Button017Click(Sender: TObject);
begin
  Tong40.print_62_02(Self);
end;

procedure TSobo62.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo62.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo62.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo62.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo62.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo62.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo62.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo62.Button101Click(Sender: TObject);
...
//if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;
  ...
  List1:=List1+1;
    ...
    if Base10.G1_Ggeo.Locate('Hcode;Gcode',VarArrayOf([St1,St3]),[loCaseInsensitive])=false then
    St1:='';


    if nSqry.Locate('Hcode;Gcode;Gjisa',VarArrayOf([St1,St3,St6]),[loCaseInsensitive])=False then begin
      if St2='X' then begin
      ...
      { if Base10.G2_Ggwo.Locate('Hcode;Gcode',VarArrayOf(['',St3]),[loCaseInsensitive])=true then
        ...
        if St7='' then }
        if Base10.G2_Ggwo.Locate('Hcode;Gcode',VarArrayOf([St1,St3]),[loCaseInsensitive])=true then
        St7:=Base10.G2_Ggwo.FieldByName('Gname').AsString;
      end;
...
procedure TSobo62.Button201Click(Sender: TObject);
...
begin
  ...
  St1:=St1+' and '+'Gjisa'+'='+#39+nSqry.FieldByName('Gjisa').AsString+#39;
  ...
  List1:=List1+1;
    ...
    if mSqry.Locate('Gcode',St3,[loCaseInsensitive])=False then begin
      ...
      if St3='' then
      St3:=Base10.Seek_Code(SGrid.Cells[ 0,List1],'B',Edit107.Text);
...
procedure TSobo62.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo62.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo62.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo62.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo62.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo62.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo62.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo62.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo62.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo62.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo62.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo62.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo62.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo62.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo62.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo62.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo62.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo62.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo62.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo62.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo62.Button701Click(Sender: TObject);
begin
  Seek10.Edit1.Text:=Edit104.Text;
...
procedure TSobo62.Button702Click(Sender: TObject);
begin
  Seek10.Edit1.Text:=Edit106.Text;
