...
procedure TSobo11.FormPaint(Sender: TObject);
begin
{ Button023Click(Self);
  Button024Click(Self); }
  Sobo11.OnPaint:=Nil;
  Sobo11.OnShow:=FormShow;
  FormShow(Self);
end;

procedure TSobo11.FormActivate(Sender: TObject);
begin
  nForm:='11';
...
procedure TSobo11.FormShow(Sender: TObject);
begin
  Refresh;
  Application.CreateForm(TSobo19, Sobo19);
  Sobo19.Label101.Visible:=False;
  Sobo19.Label100.Visible:=True;
  Sobo19.Edit103.Visible:=False;
...
procedure TSobo11.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo11:=nil;
...
procedure TSobo11.Button001Click(Sender: TObject);
begin
...
procedure TSobo11.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo11.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo11.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button007Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Seok10.ShowModal;
end;

procedure TSobo11.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button010Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnX0(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo11.Button013Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnX0(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo11.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('11-01');
end;

procedure TSobo11.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('11-01');
end;

procedure TSobo11.Button016Click(Sender: TObject);
begin
  Tong40.print_11_01(Self);
end;

procedure TSobo11.Button017Click(Sender: TObject);
begin
  Tong40.print_11_02(Self);
end;

procedure TSobo11.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button021Click(Sender: TObject);
begin
//
end;

procedure TSobo11.Button022Click(Sender: TObject);
begin
  nSqry.SaveToFile('.\Data\G1_Ggeo.cds');
end;

procedure TSobo11.Button023Click(Sender: TObject);
begin
...
procedure TSobo11.Button024Click(Sender: TObject);
begin
  Edit201.Text := mSqry.FieldByName('Gcode').AsString;
  Edit202.Text := mSqry.FieldByName('Gname').AsString;
end;

procedure TSobo11.Button101Click(Sender: TObject);
begin
...
procedure TSobo11.Button102Click(Sender: TObject);
var MeDlg: Integer;
...
procedure TSobo11.Button103Click(Sender: TObject);
var MeDlg: Integer;
begin
...
procedure TSobo11.Button104Click(Sender: TObject);
begin
  Cpost:='11';
...
procedure TSobo11.Button201Click(Sender: TObject);
begin
  mSqry.Insert;
...
procedure TSobo11.Button202Click(Sender: TObject);
var MeDlg: Integer;
begin
MeDlg := MessageDlg('저장 하시겠습니까?', mtConfirmation, [mbYes, mbNo], 0);
case MeDlg of
...
procedure TSobo11.Button203Click(Sender: TObject);
var MeDlg: Integer;
begin
MeDlg := MessageDlg('삭제 하시겠습니까?', mtConfirmation, [mbYes, mbNo], 0);
case MeDlg of
...
procedure TSobo11.Edit101Exit(Sender: TObject);
var St1,St2: String;
begin
  if Edit103.Text='' Then begin
    ...
    ShowMessage('코드는 (9)로 시작할 수 없습니다.');
    Edit103.SetFocus; Exit;
    end;
    ...
    St1 := 'Select Gcode From G1_Ggeo Where '+D_Select+'Gcode=''@Gcode'' ';
    Translate(St1, '@Gcode', Edit103.Text);
    St2 := Base10.Seek_Name(St1);

    if St2<>'' Then begin
    ShowMessage('기타거래처에 코드가 이미 등록되어있습니다. 확인해 보세요.');
    end;
  end;
end;

procedure TSobo11.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo11.Edit101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo11.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo11.Edit102KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo11.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo11.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo11.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo11.Edit112KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGrid;
    Edits: TFlatComboBox;
begin
...
procedure TSobo11.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
procedure TSobo11.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
    Button202Click(Self);
    DBGrid201.SetFocus;
...
procedure TSobo11.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then begin
    Button202Click(Self);
...
procedure TSobo11.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then
...
procedure TSobo11.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo11.Edit115KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGrid;
    Edits: TFlatComboBox;
begin
...
procedure TSobo11.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var Edits: TFlatComboBox;
begin
  Edits:=Edit128;
  if Edits.DropDownCount=9 Then begin
...
procedure TSobo11.DBGrid101DblClick(Sender: TObject);
begin
  nSqry.Edit;
...
procedure TSobo11.DBGrid101Enter(Sender: TObject);
begin
  if nSqry.State=dsInsert Then Button102Click(Self);
end;

procedure TSobo11.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo11.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo11.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo11.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo11.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo11.DBGrid201Exit(Sender: TObject);
var St1: String;
begin
  Edit101.Items.Clear;
  St1:='Hcode'+'='+#39+''+#39;
...
procedure TSobo11.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo11.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo11.SeachClick(Str1,Str2: String);
var St1: String;
begin
  Tong40.Show;
  Tong40.Update;
  ...
  if Str1='_____' then
  St1:='SubString(Gcode,1,1)'+' ='+#39+'8'+#39 else
  St1:='SubString(Gcode,1,1)'+'<>'+#39+'8'+#39+' and '+'('+St1+')';

  Sqlen := 'Select * From G1_Ggeo Where '+D_Select+St1+' Order By Gcode';
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.busyloop;
...
//nSqry.OnCalcFields:=Base10.T1_Sub11CalcFields;
  mSqry.First;
  nSqry.First;
  mSqry.AfterScroll:=Base10.T1_Sub12AfterScroll;
  nSqry.AfterScroll:=Base10.T1_Sub11AfterScroll;
  Button023Click(Self);
  Button024Click(Self);
