...
procedure TSobo54.FormActivate(Sender: TObject);
begin
  nForm:='54';
  nSqry:=Base10.T5_Sub41;
  mSqry:=Base10.T5_Sub42;
end;

procedure TSobo54.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo54.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo54:=nil;
...
procedure TSobo54.Button001Click(Sender: TObject);
begin
...
procedure TSobo54.Button002Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_54_02(Self);
  end; }
end;

procedure TSobo54.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo54.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo54.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo54.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo54.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo54.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnX1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo54.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnX1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo54.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('54-01');
end;

procedure TSobo54.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('54-02');
end;

procedure TSobo54.Button016Click(Sender: TObject);
begin
  Tong40.print_54_01(Self);
end;

procedure TSobo54.Button017Click(Sender: TObject);
begin
  Tong40.print_54_02(Self);
end;

procedure TSobo54.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont1(DBGrid101,DBGrid201,StBar101,StBar201);
end;

procedure TSobo54.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo54.Button101Click(Sender: TObject);
...
procedure TSobo54.Button201Click(Sender: TObject);
...
procedure TSobo54.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo54.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo54.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo54.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo54.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo54.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo54.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo54.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo54.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo54.Edit115KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo54.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo54.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo54.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo54.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo54.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo54.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo54.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if mSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
  end;
...
procedure TSobo54.DBGrid101TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(nSqry,Column);
end;

procedure TSobo54.DBGrid201TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(mSqry,Column);
end;

procedure TSobo54.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo54.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
  ...
  nSqry.Filter:=St1;
  nSqry.Filtered:=True;
  Tong20.Srart_54_01(Self);
end;

procedure TSobo54.DBGrid201DblClick(Sender: TObject);
begin
  if(nSqry.RecordCount>0)Then begin
  Subu00.Menu202Click(Self);
  Sobo22.Edit103.Text:=Base10.T5_Sub41.FieldByName('Jubun').AsString;
  Sobo22.Edit101.Text:=Base10.T5_Sub41.FieldByName('Gdate').AsString;
  Sobo22.Edit104.Text:=Base10.T5_Sub41.FieldByName('Gcode').AsString;
  Sobo22.Edit105.Text:=Base10.T5_Sub41.FieldByName('Gname').AsString;
  Sobo22.Edit107.Text:=Base10.T5_Sub42.FieldByName('Hcode').AsString;
  Sobo22.Edit108.Text:=Base10.T5_Sub42.FieldByName('Hname').AsString;
  Sobo22.Label100.Visible:=False;
  Sobo22.Edit106.Visible:=False;
  Sobo22.Edit106.Items.Clear;
  if Base10.T5_Sub41.FieldByName('Gjisa').AsString<>'' then begin
  Sobo22.Label100.Visible:=True;
  Sobo22.Edit106.Visible:=True;
  Sobo22.Edit106.Items.Add(Base10.T5_Sub41.FieldByName('Gjisa').AsString);
...
procedure TSobo54.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo54.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo54.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo54.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo54.Button701Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
...
procedure TSobo54.Button702Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
