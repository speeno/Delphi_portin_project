...
begin
  ...
  if (St0='21')or(St0='22')or(St0='23')or(St0='24')or(St0='25')or(St0='29') Then begin
    ...
    ff1 := FindFirst( GetExecPath + 'Report\Report_2_11.frf', faAnyFile, SearchRec);
    ff2 := FindFirst( GetExecPath + 'Report\Report_2_13.frf', faAnyFile, SearchRec);
  ...
  if St0='28' Then begin
     if St1='1' Then begin
       ...
       if(ff1 = 0)then begin
         ...
         Sqlen := 'Select * From S3_Ssub Where '+Sp2+Sp1;
  ...
  if St0='49' Then begin
     ...
     if St1='1' Then begin
       ...
       ff1 := FindFirst( GetExecPath + 'Report\Report_4_93.frf', faAnyFile, SearchRec);
       ff2 := FindFirst( GetExecPath + 'Report\Report_4_94.frf', faAnyFile, SearchRec);

       if(ff1 = 0)then begin
         Bmark:=oSqry.GetBookmark; oSqry.DisableControls;

         Tong60.frReport40_01.Clear;
         Tong60.frReport40_01.LoadFromFile(GetExecPath + 'Report\Report_4_93.frf');
       ...
       if(ff2 = 0)then begin
         ...
         Tong60.frReport40_02.LoadFromFile(GetExecPath + 'Report\Report_4_94.frf');
...
begin
  ...
  While oSqry.EOF=False do begin
    ...
    if p_Scode='X' Then begin
      ...
      Sqlen := 'Select Gname,Gtel1,Gtel2 From G1_Ggeo Where Gcode=''@Gcode''';
    ...
    if p_Scode='Y' Then begin
      ...
      Sqlen := 'Select Gname,Gtel1,Gtel2 From G2_Ggwo Where Gcode=''@Gcode''';
      Translate(Sqlen, '@Gcode', p_Gcode);
    ...
    if p_Scode='Z' Then begin
      ...
      Sqlen := 'Select Gname,Gtel1,Gtel2 From G5_Ggeo Where Gcode=''@Gcode''';
      Translate(Sqlen, '@Gcode', p_Gcode);
    ...
    While(p_Sline<10)and(p_Count<=100)and
      ...
      Sqlen := 'Select Gname,Gjeja From G4_Book Where Gcode=''@Gcode''';
...
{ Tong40._Gg_Magn_('8');
  ...
  if oSqry.FieldByName('Scode').AsString='Y' Then begin
    ...
    Sqlen :=
    'Select Gnumb,Gname,Gposa,Gadd1,Gadd2,Guper,Gjomo '+
    'From G2_Ggwo Where Gcode=''@Gcode''';
    Translate(Sqlen, '@Gcode', p_Gcode);
...
begin
  ...
  While oSqry.EOF=False do begin
    ...
    'From G3_Gjeo Where Gcode=''@Gcode''';
    Translate(Sqlen, '@Gcode', p_Gcode);
...
if St0='1' Then begin
  ...
  While oSqry.EOF=False do begin
    ...
    Sqlen := 'Select Gbigo From G1_Ggeo Where Gcode=''@Gcode''';
    Translate(Sqlen, '@Gcode', p_Gcode);
    ...
    While(p_Count<=1000)and
      ...
      Sqlen := 'Select Gbigo From G4_Book Where Gcode=''@Gcode''';
      Translate(Sqlen, '@Gcode', p_Bcode);
...
if St0='3' Then begin
  ...
  While oSqry.EOF=False do begin
    if(oSqry.FieldByName('Gdate').AsString=p_Gdate)and
      ...
      Sqlen := 'Select Jubun From G4_Book Where Gcode=''@Gcode''';
...
begin
  ...
  Sqlen :='Select Max(Gdate)as Gdate From Sv_Chng '+
          'Where Gdate < '+#39+_Gdate+#39+
          ' and  Hcode = '+#39+_Hcode+#39;
  ...
  St1:=St1+'(Select Sum(Gssum) From H1_Ssub Y Where S.Gcode=Y.Gcode and '+St2+_S1_Ssub+' ) as Gosum,';
  St1:=St1+'(Select Sum(Gssum) From H1_Ssub Y Where S.Gcode=Y.Gcode and '+St3+_S1_Ssub+' ) as Gbsum ';
  St1:=St1+' From H1_Ssub S Where '+_S1_Ssub;
  _H1_Ssub:= St1;

  if ePrnt='2' then begin
  St1:='';
  St1:=St1+' Select S.Gcode,Sum(S.Gssum)as Gssum,';
  St1:=St1+' Sum(if('+St2+_S1_Ssub+',gssum,0))as Gosum,';
  St1:=St1+' Sum(if('+St3+_S1_Ssub+',gssum,0))as Gbsum ';
  St1:=St1+' From H1_Ssub S Where '+_S1_Ssub;
  _H1_Ssub:= St1;
  end;
  ...
  Sqlen :='Select Gcode,Sum(Gssum)as Gssum,Sum(Gsusu)as Gsusu '+
          'From Sv_Chng Where '+_Sv_Chng+' Group By Gcode ';
  ...
  Sqlen :='Select Gcode,Sum(Gsqut)as Gsqut,Sum(Gssum)as Gssum '+
          'From S1_Ssub Where '+_S1_Ssub+' Group By Gcode ';
  ...
  Sqlen :='Select Gcode,Sum(Gbsum)as Gbsum '+
          'From Sg_Gsum Where '+_Sg_Gsum+' Group By Gcode ';
...
var
  ...
  pDMode : PDevMode;
begin
  if lSqry.FieldByName('L62').Value<>2970 then begin
...
begin
  if mSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      Clear;
      LoadFromFile(GetExecPath + 'Report\Report_3_42.frf');
      ...
      if Sobo34.Edit106.Text='' Then begin
        FindObject('Memo03').Memo.Text:='';
        FindObject('Memo04').Memo.Text:='';
      end;
...
begin
  if nSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      Clear;
      LoadFromFile(GetExecPath + 'Report\Report_3_51.frf');
      ...
      if Sobo35.Edit106.Text='' Then begin
        FindObject('Memo03').Memo.Text:='';
        FindObject('Memo04').Memo.Text:='';
      end;
...
begin
  if mSqry.Active=True Then begin
    ...
    oSqry.GotoBookmark(Bmark); oSqry.FreeBookmark(Bmark); oSqry.EnableControls;
  { Application.CreateForm(TSeen36, Seen36);
    Seen36.QuickRep1SrartPrnt('1');
    Seen36.Free; }
  end;
end;
...
begin
  if mSqry.Active=True Then begin
    ...
    oSqry.GotoBookmark(Bmark); oSqry.FreeBookmark(Bmark); oSqry.EnableControls;
  { Application.CreateForm(TSeen38, Seen38);
    Seen38.QuickRep1SrartPrnt('1');
    Seen38.Free; }
  end;
end;
...
begin
  if mSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      Clear;
      LoadFromFile(GetExecPath + 'Report\Report_3_72.frf');
      ...
      if Sobo37.Edit106.Text='' Then begin
        FindObject('Memo03').Memo.Text:='';
        FindObject('Memo04').Memo.Text:='';
      end;
    ...
    oSqry.GotoBookmark(Bmark); oSqry.FreeBookmark(Bmark); oSqry.EnableControls;
  { Application.CreateForm(TSeen39, Seen39);
    Seen39.QuickRep1SrartPrnt('1');
    Seen39.Free; }
  end;
end;
...
begin
  if Base10.T4_Sub81.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      ...
      FindObject('Memo91').Memo.Text:=mSqry.FieldByName('Hname').AsString+mPrnt;
...
begin
  ...
  { With Tong60.frReport00_00 do begin
      ...
      FindObject('Memo91').Memo.Text:=Sobo42.Edit208.Text+mPrnt;
      FindObject('Memo02').Memo.Text:=Sobo42.Edit201.Text+' - '+Sobo42.Edit202.Text;
      FindObject('Memo04').Memo.Text:=Sobo42.Edit203.Text;
      ShowReport;
    end; }
...
begin
  if nSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      ...
      FindObject('Memo91').Memo.Text:=nSqry.FieldByName('Hname').AsString;
      FindObject('Memo02').Memo.Text:=Sobo44.Edit101.Text;
      ShowReport;
    end;
...
begin
  ...
  { With Tong60.frReport00_00 do begin
      ...
      FindObject('Memo91').Memo.Text:=Sobo44.Edit208.Text+mPrnt;
      FindObject('Memo02').Memo.Text:=Sobo44.Edit201.Text+' - '+Sobo44.Edit202.Text;
      FindObject('Memo04').Memo.Text:=Sobo44.Edit203.Text;
      ShowReport;
    end; }

    oSqry.GotoBookmark(Bmark); oSqry.FreeBookmark(Bmark); oSqry.EnableControls;
  { Application.CreateForm(TSeen43, Seen43);
    Seen43.QuickRep1SrartPrnt('4');
    Seen43.Free; }
  end;
end;
...
begin
  if nSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      Clear;
      LoadFromFile(GetExecPath + 'Report\Report_4_61.frf');
      FindObject('Memo91').Memo.Text:=Sobo46.Label301.Caption+mPrnt;
      ShowReport;
    end;

    oSqry.GotoBookmark(Bmark); oSqry.FreeBookmark(Bmark); oSqry.EnableControls;
  { Application.CreateForm(TSeen44, Seen44);
    Seen44.QuickRep1SrartPrnt('1');
    Seen44.Free; }
  end;
end;
...
begin
  if mSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      Clear;
      LoadFromFile(GetExecPath + 'Report\Report_4_62.frf');
      FindObject('Memo91').Memo.Text:=Sobo46.Label301.Caption+mPrnt;
      ShowReport;
    end;
...
begin
  if mSqry.Active=True Then begin
    ...
    With Tong60.frReport00_00 do begin
      ...
      FindObject('Memo91').Memo.Text:=Sobo49.Edit108.Text+mPrnt;
...
begin
  ...
  { With Tong60.frReport00_00 do begin
      Clear;
      LoadFromFile(GetExecPath + 'Report\Report_5_11.frf');
...
begin
  ...
  Sqlen :='Select Scode,Gcode,'+
          ...
          'From Sv_Gsum Where '+_Sv_Gsum+' Group By Scode,Gcode ';
  ...
  Sqlen :='Select Ocode,Gubun,Sum(Gssum)as Gssum '+
          'From H1_Ssub Where '+_H1_Ssub+' Group By Ocode,Gubun ';
...
begin
  ...
  Sqlen :='Select Gcode,Sum(Gsusu)as Gsusu,Sum(Gsqut)as Gsqut,Sum(Obqut)as Obqut,Sum(Obsum)as Obsum '+
          'From Sv_Ghng Where '+_Sv_Ghng+' Group By Gcode ';
  ...
  Sqlen :='Select Bcode,Scode,Gubun,Pubun,Sum(Gsqut)as Gsqut '+
          'From S1_Ssub Where '+_S1_Ssub+' Group By Bcode,Scode,Gubun,Pubun ';
  ...
  Sqlen :='Select Scode,Gcode,Sum(Gbsum)as Gbsum '+
          'From Sg_Csum Where '+_Sg_Csum+' Group By Scode,Gcode ';
...
{ Str1:'X', Str2:Date1, Str3:Date2, Str4:Code1, Str5:Code2 }
  ...
  {-Sv_Chng-}
  Sqlen :='Select Max(Gdate)as Gdate From Sv_Chng '+
          'Where Gdate < '+#39+Str2+#39+
          ' and  Hcode = '+#39+Str6+#39;
  St1:=Base10.Seek_Name(Sqlen);
  ...
  Sqlen :='Select Gcode,Gubun,Sum(Gsqut)as Gsqut,Sum(Gssum)as Gssum '+
          'From S1_Ssub Where '+_S1_Ssub+' Group By Gcode,Gubun ';
...
{ Str1:'X', Str2:Date1, Str3:Date2, Str4:Code1, Str5:Code2 }
  ...
  Sqlen :='Select Gdate,Gcode,Gubun,Pubun,Ocode,Oname,Gbigo,Gssum '+
          'From H1_Ssub Where '+St1+' Order By Gdate ';
  ...
  Sqlen :='Select Gdate,Gcode,Gbigo,Gbsum '+
          'From Sg_Gsum Where '+St1+' Order By Gdate ';
