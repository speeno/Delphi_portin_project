...
//Sqlen := Sqlen+' LIMIT 0,1000 ';
  ...
  ProgressBar1.Position:=ProgressBar1.Position+1;
    ...
    Sqlen := 'Select Gname From G2_Ggwo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
procedure TSobo57.DBGrid101TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(nSqry,Column);
end;

procedure TSobo57.DBGrid201TitleClick(Column: TColumn);
begin
