...
uses
  ...
  ZMySqlCon, MySqlClientTable, DBGridEh, ZQuery, ZMySqlQuery;
...
//D_Select: String = 'Scode'+'>'+#39+'9'+#39+' and ';
  D_Select: String = '';
  S_Where2: String = '';
...
type
  TBase10 = class(TDataModule)
    ...
    T1_Sub81NAMES: TStringField;
    T1_Sub81GDATE: TStringField;
    T1_Sub81NAME1: TStringField;
    T1_Sub81NAME2: TStringField;
    ...
    T4_Sub21IDNUM: TFloatField;
    T4_Sub21GDATE: TStringField;
    T4_Sub21GUBUN: TStringField;
    T4_Sub21HCODE: TStringField;
    T4_Sub21SCODE: TStringField;
    T4_Sub21GCODE: TStringField;
    T4_Sub21GNAME: TStringField;
    T4_Sub21TCODE: TStringField;
    T4_Sub21OCODE: TStringField;
    T4_Sub21ONAME: TStringField;
    T4_Sub21GSSUM: TFloatField;
    T4_Sub21PUBUN: TStringField;
    T4_Sub21GBIGO: TStringField;
    T4_Sub21SNAME: TStringField;
    ...
    Database_: TZMySqlDatabase;
    Transact_: TZMySqlTransact;
    Socket_: TMySqlClientTable;
...
begin
  ...
  if(T1_Sub61.State=dsInsert)Then begin
    ...
    '(Hcode, Gcode, Bcode, Grat1, Gssum) VALUES '+
    '(''@Hcode'',''@Gcode'',''@Bcode'',  @Grat1  ,  @Gssum  )';
    ...
    'Gcode=''@Gcode'',Bcode=''@Bcode'',Grat1=''@Grat1'',Gssum=  @Gssum  '+
...
begin
  ...
  mrYes: begin
    ...
    S2101:=S2101-T2_Sub11Gsqut.AsFloat;
    S2102:=S2102-T2_Sub11Gssum.AsFloat;
    T2_Sub11.Delete;
...
begin
  ...
  if(T2_Sub11.State=dsInsert)Then begin
    ...
    S2101:=S2101+T2_Sub11Gsqut.AsFloat+Gsqut;
    S2102:=S2102+T2_Sub11Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S2201:=S2201-T2_Sub21Gsqut.AsFloat;
    S2202:=S2202-T2_Sub21Gssum.AsFloat;
    T2_Sub21.Delete;
...
begin
  ...
  if(T2_Sub21.State=dsInsert)Then begin
    ...
    S2201:=S2201+T2_Sub21Gsqut.AsFloat+Gsqut;
    S2202:=S2202+T2_Sub21Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S2301:=S2301-T2_Sub31Gsqut.AsFloat;
    S2302:=S2302-T2_Sub31Gssum.AsFloat;
    T2_Sub31.Delete;
...
begin
  ...
  if(T2_Sub31.State=dsInsert)Then begin
    ...
    S2301:=S2301+T2_Sub31Gsqut.AsFloat+Gsqut;
    S2302:=S2302+T2_Sub31Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S2401:=S2401-T2_Sub41Gsqut.AsFloat;
    S2402:=S2402-T2_Sub41Gssum.AsFloat;
    T2_Sub41.Delete;
...
begin
  ...
  if(T2_Sub41.State=dsInsert)Then begin
    ...
    Translate(Sqlon, '@Pubun', T2_Sub41Pubun.AsString);
    Translate(Sqlen, '@Gbigo', T2_Sub41Gbigo.AsString);
    TransAuto(Sqlen, '@Gsqut', T2_Sub41Gsqut.AsString);
    TransAuto(Sqlen, '@Gdang', T2_Sub41Gdang.AsString);
    TransAuto(Sqlen, '@Grat1', T2_Sub41Grat1.AsString);
    ...
    S2401:=S2401+T2_Sub41Gsqut.AsFloat+Gsqut;
    S2402:=S2402+T2_Sub41Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S2501:=S2501-T2_Sub51Gsqut.AsFloat;
    S2502:=S2502-T2_Sub51Gssum.AsFloat;
    T2_Sub51.Delete;
...
begin
  ...
  if(T2_Sub51.State=dsInsert)Then begin
    ...
    Translate(Sqlon, '@Pubun', T2_Sub51Pubun.AsString);
    Translate(Sqlen, '@Gbigo', T2_Sub51Gbigo.AsString);
    TransAuto(Sqlen, '@Gsqut', T2_Sub51Gsqut.AsString);
    TransAuto(Sqlen, '@Gdang', T2_Sub51Gdang.AsString);
    TransAuto(Sqlen, '@Grat1', T2_Sub51Grat1.AsString);
    ...
    S2501:=S2501+T2_Sub51Gsqut.AsFloat+Gsqut;
    S2502:=S2502+T2_Sub51Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S2901:=S2901-T2_Sub91Gsqut.AsFloat;
    S2902:=S2902-T2_Sub91Gssum.AsFloat;
    T2_Sub91.Delete;
...
begin
  ...
  if(T2_Sub91.State=dsInsert)Then begin
    ...
    S2901:=S2901+T2_Sub91Gsqut.AsFloat+Gsqut;
    S2902:=S2902+T2_Sub91Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S4101:=S4101-T4_Sub11Gssum.AsFloat;
    T4_Sub11.Delete;
...
begin
  ...
  if(T4_Sub11.State=dsInsert)Then begin
    ...
    TransAuto(Sqlen, '@Idnum', T4_Sub11Idnum.AsString);
    Translate(Sqlen, '@Gdate', T4_Sub11Gdate.AsString);
    Translate(Sqlen, '@Gubun', T4_Sub11Gubun.AsString);
    Translate(Sqlen, '@Hcode', T4_Sub11Hcode.AsString);
    Translate(Sqlen, '@Scode', T4_Sub11Scode.AsString);
    Translate(Sqlen, '@Gcode', T4_Sub11Gcode.AsString);
    Translate(Sqlen, '@Gname', T4_Sub11Gname.AsString);
    Translate(Sqlen, '@Tcode', T4_Sub11Tcode.AsString);
    Translate(Sqlen, '@Ocode', T4_Sub11Ocode.AsString);
    Translate(Sqlen, '@Oname', T4_Sub11Oname.AsString);
    ...
    S4101:=S4101+T4_Sub11Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S4301:=S4301-T4_Sub31Gssum.AsFloat;
    T4_Sub31.Delete;
...
begin
  ...
  if(T4_Sub31.State=dsInsert)Then begin
    ...
    '(Gdate, Hcode, Gcode, Gname, Name1, Name2, Gnumb, Gbigo, Gssum) VALUES '+
    '(''@Gdate'',''@Hcode'',''@Gcode'',''@Gname'',''@Name1'',''@Name2'',''@Gnumb'',''@Gbigo'',  @Gssum  )';
    ...
    'Name1=''@Name1'',Name2=''@Name2'',Gnumb=''@Gnumb'',Gbigo=''@Gbigo'',Gssum=  @Gssum  '+
    'WHERE ID=@ID and Gdate=''@Sdate''';
    ...
    S4301:=S4301+T4_Sub31Gssum.AsFloat+Gssum;
...
begin
  ...
  mrYes: begin
    ...
    S5101:=S5101-T5_Sub11Gssum.AsFloat;
    S5102:=S5102-T5_Sub11Gosum.AsFloat;
    S5103:=S5103-T5_Sub11Gbsum.AsFloat;
    T5_Sub11.Delete;
...
begin
  ...
  if(T5_Sub11.State=dsInsert)Then begin
    ...
    Base10.Update_ID(nSqry,'SG_GSUM_ID_GEN');
    ...
    S5101:=S5101+T5_Sub11Gssum.AsFloat+Gssum;
    S5102:=S5102+T5_Sub11Gosum.AsFloat+Gosum;
    S5103:=S5103+T5_Sub11Gbsum.AsFloat+Gbsum;
...
begin
  ...
  mrYes: begin
    ...
    S5104:=S5104-T5_Sub12Gssum.AsFloat;
    S5105:=S5105-T5_Sub12Gosum.AsFloat;
    S5106:=S5106-T5_Sub12Gbsum.AsFloat;
    T5_Sub12.Delete;
...
begin
  ...
  if(T5_Sub12.State=dsInsert)Then begin
    ...
    S5104:=S5104+T5_Sub12Gssum.AsFloat+Gssum;
    S5105:=S5105+T5_Sub12Gosum.AsFloat+Gosum;
    S5106:=S5106+T5_Sub12Gbsum.AsFloat+Gbsum;
...
begin
  ...
  mrYes: begin
    ...
    S5201:=S5201-T5_Sub21Gssum.AsFloat;
    S5202:=S5202-T5_Sub21Gosum.AsFloat;
    S5203:=S5203-T5_Sub21Gbsum.AsFloat;
    T5_Sub21.Delete;
...
begin
  ...
  if(T5_Sub21.State=dsInsert)Then begin
    ...
    S5201:=S5201+T5_Sub21Gssum.AsFloat+Gssum;
    S5202:=S5202+T5_Sub21Gosum.AsFloat+Gosum;
    S5203:=S5203+T5_Sub21Gbsum.AsFloat+Gbsum;
...
begin
  ...
  mrYes: begin
    ...
    S5204:=S5204-T5_Sub22Gssum.AsFloat;
    S5205:=S5205-T5_Sub22Gosum.AsFloat;
    S5206:=S5206-T5_Sub22Gbsum.AsFloat;
    T5_Sub22.Delete;
...
begin
  ...
  if(T5_Sub22.State=dsInsert)Then begin
    ...
    S5204:=S5204+T5_Sub22Gssum.AsFloat+Gssum;
    S5205:=S5205+T5_Sub22Gosum.AsFloat+Gosum;
    S5206:=S5206+T5_Sub22Gbsum.AsFloat+Gbsum;
...
begin
  ...
  T4_Sub11Gubun.Value:='입금';
  T4_Sub11Pubun.Value:='현금';
  T4_Sub11Scode.Value:='X';
...
{ T5_Sub11Hcode.Value:=Sobo51.Edit107.Text;
  if Sobo51.Panel102.Caption='거래처명' Then
  T5_Sub11Scode.Value:='X';
  if Sobo51.Panel102.Caption='거 래 처' Then
  T5_Sub11Scode.Value:='Z';
...
begin
  ...
  St3 := 'From G1_Ggeo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
  ...
  St1 := 'Select Gname From G1_Gbun Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
begin
{
  Sqlen := 'Select %Gqut1,%Gsum1 From Gs_Gsum Where '+
...
begin
{
  Sqlen := 'Select %Gqut1,%Gsum1 From Gs_Csum Where '+
  'Gdate=''@Gdate'' and Scode=''@Scode'' and Gcode=''@Gcode''and Hcode=''@Hcode''';
...
begin
{
  Sqlen := 'Select %Gqut1,%Gsum1,%Gsum2 From Sv_Gsum Where '+
...
begin
{
  Sqlen := 'Select %Gqut1,%Gqut2,%Gsum1 From Sv_Csum Where '+
  'Gdate=''@Gdate'' and Scode=''@Scode'' and Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
begin
  ...
  Sqlen := 'Select %Gqut1,%Gsum1,%Gsum2,Gdate From Sv_Chng Where '+
...
begin
  ...
  Sqlen := 'Select %Gqut1,%Gqut2,%Gsum1,Gdate From Sv_Ghng Where '+
  'Scode=''@Scode'' and Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
begin
  ...
  Sqlen := 'Select %Gsum1,Gdate From H1_Gbun Where '+
  'Scode=''@Scode'' and Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
begin
  ...
  Sqlen := 'Select %Gsum1,Gdate From Sv_Gsum Where '+
  'Gdate=''@Gdate'' and Scode=''@Scode'' and Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
begin
  ...
  Sqlen := 'Select %Gsum1,Gdate From H5_Bang Where '+
...
{ Sqlen := 'Select Gname From G4_Book Where Gcode=''@Gcode''';
...
begin
  ...
  if _Gcode2='X' Then
  Str := 'Select Gname From G1_Ggeo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
  if _Gcode2='Y' Then
  Str := 'Select Gname From G2_Ggwo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
  if _Gcode2='Z' Then
  Str := 'Select Gname,Gposa From G5_Ggeo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
  if _Gcode2='B' Then
  Str := 'Select Gname From G4_Book Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
begin
  ...
  if _Gcode2='X' Then
  Str := 'Select Jubun From G1_Ggeo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
  if _Gcode2='Y' Then
  Str := 'Select Jubun From G2_Ggwo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
  if _Gcode2='Z' Then
  Str := 'Select Jubun From G5_Ggeo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
{ if _Gcode2='X' Then
  Str := 'Select Jubun From G1_Ggeo Where Gcode=''@Gcode''';
  if _Gcode2='Y' Then
  Str := 'Select Jubun From G2_Ggwo Where Gcode=''@Gcode''';
  if _Gcode2='Z' Then
  Str := 'Select Jubun From G5_Ggeo Where Gcode=''@Gcode''';
...
begin
  ...
  Sqlen := 'Select Hcode,Gcode,Gname From G7_Ggeo ';
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.busyloop;
  ...
  Sqlen := 'Select Hcode,Gcode,Gname,Ocode,Gubun,Gdang From G4_Book ';
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.busyloop;
  if Base10.Socket.body_data <> 'ERROR' then
