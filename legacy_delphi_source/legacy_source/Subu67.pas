...
procedure TSobo67.FormActivate(Sender: TObject);
begin
  nForm:='67';
  nSqry:=Base10.T6_Sub71;
  mSqry:=Base10.T6_Sub72;
end;

procedure TSobo67.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo67.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo67:=nil;
...
procedure TSobo67.Button001Click(Sender: TObject);
begin
...
procedure TSobo67.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_67_01(Self);
  end;
end;

procedure TSobo67.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo67.Button004Click(Sender: TObject);
begin
  Base10.OpenExit(nSqry);
  Base10.OpenExit(mSqry);
  Tong20.Srart_67_01(Self);
  Tong20.Srart_67_02(Self);
  Tong20.Chang_00_01('67');
  Edit101.SetFocus;
end;

procedure TSobo67.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('67');
end;

procedure TSobo67.Button006Click(Sender: TObject);
begin
  T00:=1;
  Button201Click(Self);
end;

procedure TSobo67.Button007Click(Sender: TObject);
begin
  T00:=0;
  Button201Click(Self);
end;

procedure TSobo67.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('67');
end;

procedure TSobo67.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('67');
end;

procedure TSobo67.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo67.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo67.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo67.Button013Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo67.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('67-01');
end;

procedure TSobo67.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('67-02');
end;

procedure TSobo67.Button016Click(Sender: TObject);
begin
  Tong40.print_67_01(Self);
end;

procedure TSobo67.Button017Click(Sender: TObject);
begin
  Tong40.print_67_02(Self);
end;

procedure TSobo67.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo67.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo67.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo67.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo67.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo67.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo67.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo67.Button101Click(Sender: TObject);
...
begin
  ...
  List1:=List1+1;
    ...
    if Base10.G4_Book.Locate('Hcode;Gcode',VarArrayOf([Edit107.Text,St4]),[loCaseInsensitive])=true then
    St5:=Base10.G4_Book.FieldByName('Gname').AsString;
    if St5='' then
    St5:=Base10.Seek_Code(St4,'B',Edit107.Text);

    if nSqry.Locate('Gdate;Gcode',VarArrayOf([St3,St4]),[loCaseInsensitive])=False then begin
      nSqry.Append;
...
procedure TSobo67.Button201Click(Sender: TObject);
var St1,St2,St3,St4,St5: String;
begin
  if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;
  ...
  List1:=List1+1;
    ...
    if mSqry.Locate('Gdate;Gcode',VarArrayOf([St3,St4]),[loCaseInsensitive])=False then begin
      mSqry.Append;
  ...
  List1:=List1+1;
    ...
    mSqry.Edit;
    mSqry.FieldByName('Gpsum').AsFloat:=mSqry.FieldByName('Gpsum').AsFloat+T01;
    mSqry.Post;
  end;
...
procedure TSobo67.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo67.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo67.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo67.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo67.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo67.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo67.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo67.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo67.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo67.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo67.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo67.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo67.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo67.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo67.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo67.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text+'.01');
end;

procedure TSobo67.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text+'.01');
end;

procedure TSobo67.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=Copy(DateToStr(ADate),1,7);
end;

procedure TSobo67.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=Copy(DateToStr(ADate),1,7);
end;

procedure TSobo67.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo67.Button701Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit104.Text;
...
procedure TSobo67.Button702Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit106.Text;
