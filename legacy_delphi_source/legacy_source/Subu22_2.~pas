...
uses
  ...
  DBClient, ToolEdit, dxCore, dxButtons;

type
  TSobo22_2 = class(TForm)
...
procedure TSobo22_2.FormActivate(Sender: TObject);
begin
  nForm:='22_2';
  nSqry:=T2_Sub21;
  mSqry:=T2_Sub22;
...
procedure TSobo22_2.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo22_2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo22_2:=nil;
...
procedure TSobo22_2.Button001Click(Sender: TObject);
begin
...
procedure TSobo22_2.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo22_2.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo22_2.Button004Click(Sender: TObject);
begin
{ if(Base10.Database.Database='book_07_db')or
    (Base10.Database.Database='chul_02_db')then begin
    Base10.OpenExit(nSqry);
    Tong20.Srart_22_01(Self);
    if Sobo22_2.Caption='입고명세서-(온라인)' then
    Sobo22_2.Caption:='입고명세서-(창고)' else
    Sobo22_2.Caption:='입고명세서-(온라인)';
    Edit101.SetFocus;
  end; }
end;

procedure TSobo22_2.Button005Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
...
procedure TSobo22_2.Button006Click(Sender: TObject);
begin
     Button018Click(Self);
end;

procedure TSobo22_2.Button007Click(Sender: TObject);
begin
  if nSqry.Active=True Then
     Button401Click(Self);
end;

procedure TSobo22_2.Button008Click(Sender: TObject);
begin
  if nSqry.Active=True Then
     Button601Click(Self);
end;

procedure TSobo22_2.Button009Click(Sender: TObject);
begin
  if nSqry.Active=True Then
     Button602Click(Self);
end;

procedure TSobo22_2.Button010Click(Sender: TObject);
begin
//Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo22_2.Button011Click(Sender: TObject);
begin
...
procedure TSobo22_2.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
//Base10.ColumnX0(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo22_2.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
//Base10.ColumnX4(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo22_2.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('22-01');
end;

procedure TSobo22_2.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('22-02');
end;

procedure TSobo22_2.Button016Click(Sender: TObject);
begin
//Tong40.print_22_01(Self);
end;

procedure TSobo22_2.Button017Click(Sender: TObject);
begin
//Tong40.print_22_02(Self);
end;

procedure TSobo22_2.Button018Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
...
procedure TSobo22_2.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button021Click(Sender: TObject);
begin
//Tong20.DBGridFont2(DBGrid101,StBar101);
end;

procedure TSobo22_2.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button023Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
...
procedure TSobo22_2.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button101Click(Sender: TObject);
var St1,St2: String;
begin
...
{ if System_Data > Edit101.Text then begin
  ...
  St2:=' Group By Hcode,Gdate,Sdate,ID';

  Sqlen := 'Select * From S4_Ssub Where '+D_Select+St1+St2;
...
procedure TSobo22_2.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button301Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button401Click(Sender: TObject);
begin
{ if(nSqry.FieldByName('Yesno').Value='1')or
    (nSqry.FieldByName('Yesno').Value='2')or
    (System_Data > Edit101.Text)then begin
...
procedure TSobo22_2.Button501Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button601Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button602Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Button901Click(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo22_2.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo22_2.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo22_2.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo22_2.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo22_2.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo22_2.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo22_2.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo22_2.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo22_2.Edit114KeyPress(Sender: TObject; var Key: Char);
var St1: String;
begin
  if Key=#13 Then begin
...
procedure TSobo22_2.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo22_2.DBGrid101Exit(Sender: TObject);
begin
  T2_Sub21BeforeClose(T2_Sub21);
end;

procedure TSobo22_2.DBGrid101Enter(Sender: TObject);
var DGrid: TDBGridEh;
begin
  DGrid:=DBGrid101;
...
procedure TSobo22_2.DBGrid101KeyPress(Sender: TObject; var Key: Char);
var sColumn: Boolean;
    sIndexs: Integer;
    i: Integer;
begin
...
procedure TSobo22_2.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var sColumn: Boolean;
    sIndexs: Integer;
begin
{ if nSqry.Active=True Then begin
...
procedure TSobo22_2.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo22_2.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo22_2.DBGrid101TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(nSqry,Column);
end;

procedure TSobo22_2.DBGrid201TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(mSqry,Column);
end;

procedure TSobo22_2.DataSource1DataChange(Sender: TObject; Field: TField);
begin
{ if nSqry.FieldByName('Code2').AsString='O' then
...
procedure TSobo22_2.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo22_2.MultiSelect(Sender: TObject);
begin
//
end;

procedure TSobo22_2.Edit301KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then
  Button701Click(Self);
end;

procedure TSobo22_2.Button701Click(Sender: TObject);
begin
//
end;

function TSobo22_2.Idnum(Sender: TObject): Integer;
var p_Idnum: Integer;
    Str: String;
begin
...
procedure TSobo22_2.Jubun(Sender: TObject);
var MeDlg: Integer;
    p_Jubun: Integer;
begin
...
//--입고명세서--//
procedure TSobo22_2.T2_Sub21AfterCancel(DataSet: TDataSet);
begin
//T2_Sub21AfterScroll(T2_Sub21);
end;

procedure TSobo22_2.T2_Sub21AfterScroll(DataSet: TDataSet);
begin
//
end;

procedure TSobo22_2.T2_Sub21AfterPost(DataSet: TDataSet);
begin
//
end;

procedure TSobo22_2.T2_Sub21AfterDelete(DataSet: TDataSet);
var MeDlg: Integer;
begin
...
procedure TSobo22_2.T2_Sub21BeforePost(DataSet: TDataSet);
begin
...
{ if(T2_Sub21.State=dsInsert)Then begin
    ...
    'Gdang=  @Gdang  ,Memo1=''@Memo1'',Gbigo=''@Gbigo'',Code1=''@Code1'', ';
    Sqlen :=
    'Code2=''@Code2'',Code3=''@Code3'',Time2=  now() '+
    ...
    Translate(Sqlon, '@Gbigo', T2_Sub21Gbigo.AsString);
    Translate(Sqlon, '@Code1', T2_Sub21Code1.AsString);
    Translate(Sqlen, '@Code2', T2_Sub21Code2.AsString);
    Translate(Sqlen, '@Code3', T2_Sub21Code3.AsString);
    TransAuto(Sqlen, '@ID',    T2_Sub21ID.AsString);
...
procedure TSobo22_2.T2_Sub21BeforeClose(DataSet: TDataSet);
begin
{ With T2_Sub21 do
  if(State in dsEditModes)Then Post; }
end;

procedure TSobo22_2.T2_Sub21NewRecord(DataSet: TDataSet);
begin
{ T2_Sub21Hcode.Value:=Hnnnn;
  T2_Sub21Gdate.Value:=Sobo22_2.Edit101.Text;
  T2_Sub21Sdate.Value:=Sobo22_2.Edit101.Text;
...
procedure TSobo22_2.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo22_2.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo22_2.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo22_2.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
