object Sobo59_2: TSobo59_2
  ...
  object Panel300: TFlatPanel
    ...
    object DBGrid301: TDBGridEh
      ...
      TitleFont.Name = '굴림'
      TitleFont.Style = [fsBold]
      OnKeyDown = DBGrid301KeyDown
      OnKeyPress = DBGrid301KeyPress
      OnTitleClick = DBGrid301TitleClick
      Columns = <
        item
          EditButtons = <>
          FieldName = 'GCODE'
  ...
  object T5_Sub91: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 17
    Top = 126
    object T5_Sub91ICODE: TFloatField
      FieldName = 'ICODE'
    end
    object T5_Sub91IDNUM: TStringField
      FieldName = 'IDNUM'
      Size = 5
    end
    object T5_Sub91GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T5_Sub91SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T5_Sub91GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T5_Sub91HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T5_Sub91BCODE: TStringField
      FieldName = 'BCODE'
      Size = 10
    end
    object T5_Sub91BNAME: TStringField
      FieldName = 'BNAME'
      Size = 100
    end
    object T5_Sub91GISBN: TStringField
      FieldName = 'GISBN'
    end
    object T5_Sub91GJISA: TStringField
      FieldName = 'GJISA'
      Size = 30
    end
    object T5_Sub91JUBUN: TStringField
      FieldName = 'JUBUN'
      Size = 2
    end
    object T5_Sub91GSQUT: TFloatField
      FieldName = 'GSQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T5_Sub91QSQUT: TFloatField
      FieldName = 'QSQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T5_Sub91GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 2
    end
    object T5_Sub91YESNO: TStringField
      FieldName = 'YESNO'
      Size = 5
    end
    object T5_Sub91TIME1: TStringField
      FieldName = 'TIME1'
      Size = 50
    end
  end
  ...
  object T5_Sub92: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 49
    Top = 126
    object T5_Sub92GDATE: TStringField
      FieldName = 'GDATE'
      Size = 10
    end
    object T5_Sub92HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T5_Sub92HNAME: TStringField
      FieldName = 'HNAME'
      Size = 50
    end
    object T5_Sub92CODE1: TStringField
      FieldName = 'CODE1'
      Size = 5
    end
  end
  object T5_Sub93: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 81
    Top = 126
    object T5_Sub93GDATE: TStringField
      FieldName = 'GDATE'
      Size = 10
    end
    object T5_Sub93HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T5_Sub93GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T5_Sub93GNAME: TStringField
      FieldName = 'GNAME'
      Size = 50
    end
    object T5_Sub93GJISA: TStringField
      FieldName = 'GJISA'
      Size = 30
    end
    object T5_Sub93JUBUN: TStringField
      FieldName = 'JUBUN'
      Size = 2
    end
    object T5_Sub93GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 2
    end
    object T5_Sub93YESNO: TStringField
      FieldName = 'YESNO'
      Size = 5
    end
    object T5_Sub93GISBN: TStringField
      FieldName = 'GISBN'
      Size = 30
    end
  end
  object T2_Sub71: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 113
    Top = 126
    object T2_Sub71ID: TFloatField
      FieldName = 'ID'
    end
    object T2_Sub71ICODE: TFloatField
      FieldName = 'ICODE'
    end
    object T2_Sub71IDNUM: TFloatField
      FieldName = 'IDNUM'
    end
    object T2_Sub71GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T2_Sub71SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T2_Sub71GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T2_Sub71GNAME: TStringField
      FieldName = 'GNAME'
      Size = 100
    end
    object T2_Sub71HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T2_Sub71HNAME: TStringField
      FieldName = 'HNAME'
      Size = 50
    end
    object T2_Sub71OCODE: TStringField
      DisplayWidth = 4
      FieldName = 'OCODE'
      Size = 1
    end
    object T2_Sub71BCODE: TStringField
      FieldName = 'BCODE'
      Size = 10
    end
    object T2_Sub71BNAME: TStringField
      FieldName = 'BNAME'
      Size = 100
    end
    object T2_Sub71GJEJA: TStringField
      FieldName = 'GJEJA'
      Size = 30
    end
    object T2_Sub71GUBUN: TStringField
      FieldName = 'GUBUN'
      Size = 4
    end
    object T2_Sub71JUBUN: TStringField
      FieldName = 'JUBUN'
      Size = 2
    end
    object T2_Sub71PUBUN: TStringField
      FieldName = 'PUBUN'
      Size = 4
    end
    object T2_Sub71GSQUT: TFloatField
      FieldName = 'GSQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T2_Sub71QSQUT: TFloatField
      FieldName = 'QSQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T2_Sub71GDANG: TFloatField
      FieldName = 'GDANG'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T2_Sub71GRAT1: TSmallintField
      FieldName = 'GRAT1'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T2_Sub71GSSUM: TFloatField
      FieldName = 'GSSUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T2_Sub71JEAGO: TFloatField
      FieldName = 'JEAGO'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T2_Sub71GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
    object T2_Sub71YESNO: TStringField
      FieldName = 'YESNO'
      Size = 5
    end
    object T2_Sub71GMEMO: TDateTimeField
      FieldName = 'GMEMO'
    end
    object T2_Sub71GJISA: TStringField
      FieldName = 'GJISA'
      Size = 30
    end
  end
