...
uses
  ...
  dxCore, dxButtons, ToolEdit, DBGridEh, CornerButton, DBClient;

type
  TSobo34_4 = class(TForm)
    ...
    T3_Sub42aBQUT: TFloatField;
    T3_Sub42aPQUT: TFloatField;
    T3_Sub42aPSUM: TFloatField;
    T3_Sub41aBQUT: TFloatField;
    T3_Sub41aPQUT: TFloatField;
    T3_Sub41aPSUM: TFloatField;
    T3_Sub41bBQUT: TFloatField;
    T3_Sub41bPQUT: TFloatField;
    T3_Sub41bPSUM: TFloatField;
    T3_Sub42bBQUT: TFloatField;
    T3_Sub42bPQUT: TFloatField;
    T3_Sub42bPSUM: TFloatField;
    Panel103: TFlatPanel;
    Edit108: TFlatEdit;
    Edit107: TFlatEdit;
    Button700: TFlatButton;
    T3_Sub41xSQUT: TFloatField;
    T3_Sub42xSQUT: TFloatField;
    ...
    procedure _Sv_Ghng_(_S1_Ssub,_Sg_Csum,_Sb_Csum,_Sv_Ghng: String);
  private
...
procedure TSobo34_4.FormActivate(Sender: TObject);
begin
  nForm:='34_4';
  nSqry:=T3_Sub41;
  mSqry:=T3_Sub42;
...
procedure TSobo34_4.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo34_4.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo34_4:=nil;
...
procedure TSobo34_4.Button001Click(Sender: TObject);
begin
...
procedure TSobo34_4.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo34_4.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo34_4.Button004Click(Sender: TObject);
begin
  Base10.OpenExit(nSqry);
  Base10.OpenExit(mSqry);
{ Tong20.Srart_34_01(Self);
...
{ if Sobo34_4.Panel102.Caption ='창고도서' Then begin
     Sobo34_4.Panel102.Caption:='도 서 명';
  end else
  if Sobo34_4.Panel102.Caption ='도 서 명' Then begin
     Sobo34_4.Panel102.Caption:='본사도서';
  end else
  if Sobo34_4.Panel102.Caption ='본사도서' Then begin
     Sobo34_4.Panel102.Caption:='창고도서';
  end; }
  Edit101.SetFocus;
end;

procedure TSobo34_4.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('34');
end;

procedure TSobo34_4.Button006Click(Sender: TObject);
begin
  T00:=1;
  Button201Click(Self);
end;

procedure TSobo34_4.Button007Click(Sender: TObject);
begin
  T00:=0;
  Button201Click(Self);
end;

procedure TSobo34_4.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('34');
end;

procedure TSobo34_4.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Out_01('34');
end;

procedure TSobo34_4.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo34_4.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo34_4.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY2(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo34_4.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY2(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo34_4.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('34-01');
end;

procedure TSobo34_4.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('34-02');
end;

procedure TSobo34_4.Button016Click(Sender: TObject);
begin
  Tong40.print_34_01(Self);
end;

procedure TSobo34_4.Button017Click(Sender: TObject);
begin
  Tong40.print_34_02(Self);
end;

procedure TSobo34_4.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo34_4.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo34_4.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo34_4.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo34_4.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo34_4.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo34_4.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo34_4.Button101Click(Sender: TObject);
begin
...
procedure TSobo34_4.Button102Click(Sender: TObject);
var St1,St2,St3,St4,St5,St6: String;
    nSumX,nSumY: Double;
    _S1_Ssub,_Sg_Csum,_Sb_Csum,_Sv_Ghng: String;
begin
  ...
  if Panel102.Caption='도 서 명' Then St2:='';
  ...
  List1:=List1+1;
    ...
    if nSqry.Locate('Gcode',St3,[loCaseInsensitive])=False then begin
      ...
      St4:=Base10.G4_Book.FieldByName('Gname').AsString;
      St5:=Base10.G4_Book.FieldByName('Ocode').AsString;
      St6:=Base10.G4_Book.FieldByName('Gubun').AsString;
      T03:=Base10.G4_Book.FieldByName('Gdang').AsFloat;
      end;
     ...
     if St4='' then begin
      ...
      if Base10.Socket.Body_Data <> 'NODATA' then begin
        ...
        T03:=StrToInt64Def(Base10.Socket.GetData(1, 4),0);
      end;
     end;
      ...
      //nSqry.FieldByName('Gsqut').AsFloat :=T03;
      end else
      if nSqry.Locate('Gcode',St5,[loCaseInsensitive])=False then begin
        ...
        nSqry.Append;
        nSqry.FieldByName('Gcode').AsString:=St5;
        nSqry.FieldByName('Gname').AsString:=St4;
        nSqry.FieldByName('Gdate').AsString:=St5;
        nSqry.FieldByName('Gubun').AsString:=St6;
      //nSqry.FieldByName('Gsqut').AsFloat :=T03;
    ...
    if St5='Y' Then begin
      ...
      if St3='폐기' Then begin
        if(St4='비품')Then begin
          ...
          nSqry.FieldByName('bPQUT').AsFloat:=nSqry.FieldByName('bPQUT').AsFloat+T01;
        end else begin
          nSqry.FieldByName('Gpqut').AsFloat:=nSqry.FieldByName('Gpqut').AsFloat+T01;
          nSqry.FieldByName('Gbsum').AsFloat:=nSqry.FieldByName('Gbsum').AsFloat+T01;

          nSqry.FieldByName('aPQUT').AsFloat:=nSqry.FieldByName('aPQUT').AsFloat+T01;
        end;
      end else
      if(St4='비품')or(St4='폐기')Then begin
        if St5='X' Then begin
          ...
          nSqry.FieldByName('bBQUT').AsFloat:=nSqry.FieldByName('bBQUT').AsFloat+T01;
          end;
          ...
          if(St4='폐기')Then begin
          //if(mChek='True')and(Base10.Database.Database='chul_09_db')then begin
          //  nSqry.FieldByName('Gpqut').AsFloat:=nSqry.FieldByName('Gpqut').AsFloat+T01;
          //  nSqry.FieldByName('Gbsum').AsFloat:=nSqry.FieldByName('Gbsum').AsFloat+T01;
          //end else begin
              nSqry.FieldByName('Gpqut').AsFloat:=nSqry.FieldByName('Gpqut').AsFloat+T01;
      ...
      if St3='반품' Then begin
        ...
        nSqry.FieldByName('aBQUT').AsFloat:=nSqry.FieldByName('aBQUT').AsFloat+T01;
      end;
    end;
    nSqry.Post;
  end;
  ...
  if(Edit105.Text<>'')and(St2='B')then
  St1:='Gdate'+'>='+#39+Edit101.Text+#39+' and '+
       'Gdate'+'<='+#39+Edit102.Text+#39+' and '+
       'Gcode'+'>='+#39+Edit103.Text+#39+' and '+
       'Gcode'+'<='+#39+Edit105.Text+#39+' and '+
  ...
  {-Sb_Csum-}
  Sqlen :=
  'Select Scode,Gcode,Sum(Gsqut)as Gsqut '+
  'From Sb_Csum Where '+D_Select+St1+
  ...
  List1:=List1+1;
    ...
    nSqry.Edit;
    if(SGrid.Cells[ 0,List1]='P')or(SGrid.Cells[ 0,List1]='P')then begin
    nSqry.FieldByName('bPSUM').AsFloat:=nSqry.FieldByName('bPSUM').AsFloat+T01;
    end;
    nSqry.Post;
  end;
  ...
  _Sg_Csum:='Gdate'+'> '+#39+St1+#39+' and '+
            'Gdate'+'< '+#39+Edit101.Text+#39+' and '+
            'Hcode'+' ='+#39+Edit107.Text+#39+' and '+
           '(Scode'+' ='+#39+'A'+#39+' or '+'Scode'+' ='+#39+'C'+#39+')';
  if St2='B' then
  _Sg_Csum:='Gdate'+'> '+#39+St1+#39+' and '+
            'Gdate'+'< '+#39+Edit101.Text+#39+' and '+
            'Hcode'+' ='+#39+Edit107.Text+#39+' and '+
  ...
  if(Edit105.Text<>'')and(St2='A')then
  _Sg_Csum:='Gdate'+'> '+#39+St1+#39+' and '+
            'Gdate'+'< '+#39+Edit101.Text+#39+' and '+
            'Gcode'+'>='+#39+Edit103.Text+#39+' and '+
            'Gcode'+'<='+#39+Edit105.Text+#39+' and '+
  ...
  _Sv_Ghng:='Gdate'+' ='+#39+St1+#39+' and '+
            ...
            'Scode'+' Like '+#39+'%'+St2+'%'+#39;
  if Edit105.Text<>'' Then
  _Sv_Ghng:='Gcode'+'>='+#39+Edit103.Text+#39+' and '+
            'Gcode'+'<='+#39+Edit105.Text+#39+' and '+
            'Gdate'+' ='+#39+St1+#39+' and '+
            'Hcode'+' ='+#39+Edit107.Text+#39+' and '+
            'Scode'+' Like '+#39+'%'+St2+'%'+#39;
  _Sv_Ghng_(_S1_Ssub,_Sg_Csum,_Sb_Csum,_Sv_Ghng);
  ...
  ProgressBar1.Position:=ProgressBar1.Position+1;
    ...
    nSqry.Edit;
    nSqry.FieldByName('GsumX').AsFloat:=nSqry.FieldByName('GsumX').AsFloat+
...
//Base10.Serise_Book(nSqry,'Gcode','GsumX','Giqut','Gisum','Goqut','Gjqut','Gbqut','Gpqut','Gpsum','GsumY','Gssum');
  ...
  //nSqry.FieldByName('Gjqut').AsFloat- nSqry.FieldByName('Gbqut').AsFloat+
    ...
    nSqry.FieldByName('Gsusu').AsFloat:=nSqry.FieldByName('Gssum').AsFloat;
    nSqry.FieldByName('GsumY').AsFloat:=nSqry.FieldByName('GsumY').AsFloat+
  ...
  //nSqry.FieldByName('Gbsum').AsFloat;
    ...
    nSqry.FieldByName('Gssum').AsFloat:=nSqry.FieldByName('Gssum').AsFloat-
    nSqry.FieldByName('aPqut').AsFloat- nSqry.FieldByName('bPqut').AsFloat+
    nSqry.FieldByName('bPsum').AsFloat;
  { nSqry.FieldByName('Gssum').AsFloat:=nSqry.FieldByName('Gssum').AsFloat-
    nSqry.FieldByName('Gisum').AsFloat+ nSqry.FieldByName('Gjsum').AsFloat+
    nSqry.FieldByName('Gosum').AsFloat; }

    if(nSqry.FieldByName('Goqut').AsFloat<>0)or(nSqry.FieldByName('Gbqut').AsFloat<>0)then
    nSqry.FieldByName('Gsqut').AsFloat:=
    nSqry.FieldByName('Goqut').AsFloat+ nSqry.FieldByName('Gbqut').AsFloat;
    ...
    mSqry.FieldByName('aBQUT').AsFloat:=
    mSqry.FieldByName('aBQUT').AsFloat+nSqry.FieldByName('aBQUT').AsFloat;
    mSqry.FieldByName('bBQUT').AsFloat:=
    mSqry.FieldByName('bBQUT').AsFloat+nSqry.FieldByName('bBQUT').AsFloat;
    mSqry.FieldByName('aPQUT').AsFloat:=
    mSqry.FieldByName('aPQUT').AsFloat+nSqry.FieldByName('aPQUT').AsFloat;
    mSqry.FieldByName('bPQUT').AsFloat:=
    mSqry.FieldByName('bPQUT').AsFloat+nSqry.FieldByName('bPQUT').AsFloat;
    mSqry.FieldByName('aPSUM').AsFloat:=
    mSqry.FieldByName('aPSUM').AsFloat+nSqry.FieldByName('aPSUM').AsFloat;
    mSqry.FieldByName('bPSUM').AsFloat:=
    mSqry.FieldByName('bPSUM').AsFloat+nSqry.FieldByName('bPSUM').AsFloat;
    mSqry.Post;
    nSqry.Next;
  end;
...
procedure TSobo34_4.Button103Click(Sender: TObject);
var St1,St2,St3,St4,St5,St6: String;
    nSumX,nSumY: Double;
...
begin
  ...
  List1:=List1+1;
    ...
    if nSqry.Locate('Gcode',St3,[loCaseInsensitive])=False then begin
     ...
     if St4='' then begin
      Sqlen := 'Select Gname,Ocode,Gubun From G4_Book Where '+D_Select+'Gcode=''@Gcode'' and Hcode=''@Hcode''';
  ...
  List1:=List1+1;
    ...
    nSqry.Edit;
    if(SGrid.Cells[ 0,List1]='C')or(SGrid.Cells[ 0,List1]='D')then begin
  ...
  {-Sb_Csum-}
  Sqlen := 'Select Gcode,Gubun,Gsqut From Sb_Csum Where '+D_Select+St1+St2;
...
procedure TSobo34_4.Button201Click(Sender: TObject);
var St1: String;
begin
  Refresh;
  if(T00=0)Then begin
...
procedure TSobo34_4.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo34_4.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo34_4.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo34_4.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo34_4.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo34_4.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo34_4.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo34_4.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo34_4.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo34_4.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo34_4.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
...
procedure TSobo34_4.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo34_4.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo34_4.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo34_4.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo34_4.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo34_4.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo34_4.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo34_4.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo34_4.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo34_4.Button701Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit104.Text;
...
procedure TSobo34_4.Button702Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit106.Text;
...
procedure TSobo34_4._Sv_Ghng_(_S1_Ssub,_Sg_Csum,_Sb_Csum,_Sv_Ghng: String);
...
begin
  ...
  {-Sb_Csum-}
  Sqlen :='Select Scode,Gcode,Sum(Gsqut)as Gsqut '+
          'From Sb_Csum Where '+D_Select+_Sb_Csum+' Group By Scode,Gcode ';
  ...
  List1:=List1+1;
    ...
    sSqry.Edit;
    if SGrid.Cells[ 0,List1]='P' then
    sSqry.FieldByName('Gpqut').AsFloat:=
    sSqry.FieldByName('Gpqut').AsFloat+StrToIntDef(SGrid.Cells[ 2,List1],0);
    sSqry.Post;
  end;
end;
