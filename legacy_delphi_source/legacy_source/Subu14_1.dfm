object Sobo14_1: TSobo14_1
  ...
  object Panel007: TFlatPanel
    ...
    object FlatPanel1: TFlatPanel
      ...
      ColorShadow = clInfoBk
      TabOrder = 4
      UseDockManager = True
    end
    object Edit103: TFlatMaskEdit
      Left = 290
      Top = 5
      Width = 81
      Height = 19
  ...
  object T1_Sub81: TClientDataSet
    Aggregates = <>
    Params = <>
    BeforeClose = T1_Sub81BeforeClose
    BeforePost = T1_Sub81BeforePost
    Left = 34
    Top = 158
    object T1_Sub81ID: TFloatField
      FieldName = 'ID'
    end
    object T1_Sub81HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    ...
    object T1_Sub81GISBN: TStringField
      FieldName = 'GISBN'
    end
    object T1_Sub81GPOST: TStringField
      FieldName = 'GPOST'
    end
    object T1_Sub81OPOST: TStringField
      FieldName = 'OPOST'
    end
