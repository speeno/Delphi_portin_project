...
procedure TSobo65.FormActivate(Sender: TObject);
begin
  nForm:='65';
  nSqry:=Base10.T6_Sub51;
  mSqry:=Base10.T6_Sub52;
end;

procedure TSobo65.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo65.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo65:=nil;
...
procedure TSobo65.Button001Click(Sender: TObject);
begin
...
procedure TSobo65.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_65_01(Self);
  end;
end;

procedure TSobo65.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo65.Button004Click(Sender: TObject);
begin
  Base10.OpenExit(nSqry);
  Base10.OpenExit(mSqry);
  Tong20.Srart_65_01(Self);
  Tong20.Srart_65_02(Self);
  Tong20.Chang_00_01('65');
  Edit101.SetFocus;
end;

procedure TSobo65.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('65');
end;

procedure TSobo65.Button006Click(Sender: TObject);
begin
  T00:=1;
  Button201Click(Self);
end;

procedure TSobo65.Button007Click(Sender: TObject);
begin
  T00:=0;
  Button201Click(Self);
end;

procedure TSobo65.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('65');
end;

procedure TSobo65.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Out_01('65');
end;

procedure TSobo65.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo65.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo65.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnX2(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo65.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnX2(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo65.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('65-01');
end;

procedure TSobo65.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('65-02');
end;

procedure TSobo65.Button016Click(Sender: TObject);
begin
  Tong40.print_65_01(Self);
end;

procedure TSobo65.Button017Click(Sender: TObject);
begin
  Tong40.print_65_02(Self);
end;

procedure TSobo65.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo65.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo65.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo65.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont1(DBGrid101,DBGrid201,StBar101,StBar201);
end;

procedure TSobo65.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo65.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo65.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo65.Button101Click(Sender: TObject);
var St1,St2,St3,St4,St5,St7: String;
    St9: Integer;
begin
  ...
  While St4<>'' do begin
    ...
    {-S1_Ssub-}
    Sqlen :=
    'Select Gcode,Scode,Gubun,Pubun,Gjisa,Sum(Gsqut)as Gsqut,Sum(Gssum)as Gssum '+
    'From S1_Ssub Where '+St1+
    'Group By Gcode,Scode,Gubun,Pubun,Gjisa ';
    ...
    List1:=List1+1;
      ...
      St3:='';
      St4:='';
    //St3:=Base10.Seek_Code(St2,'X',Edit111.Text);

      if Base10.G1_Ggeo.Locate('Hcode;Gcode',VarArrayOf(['',St2]),[loCaseInsensitive])=true then begin
        St3:=Base10.G1_Ggeo.FieldByName('Gname').AsString;
        St4:=Base10.G1_Ggeo.FieldByName('Gubun').AsString;
      end;
      if St3='' then
      if Base10.G1_Ggeo.Locate('Hcode;Gcode',VarArrayOf([Edit111.Text,St2]),[loCaseInsensitive])=true then begin
        St3:=Base10.G1_Ggeo.FieldByName('Gname').AsString;
        St4:=Base10.G1_Ggeo.FieldByName('Gubun').AsString;
      end;

      if St3='' then begin
      Sqlen := 'Select Gname,Gubun From G1_Ggeo Where Gcode=''@Gcode'' and Hcode=''@Hcode''';
      ...
      if nSqry.Locate('Gcode;Gjisa',VarArrayOf([St2,St5]),[loCaseInsensitive])=False then begin
        nSqry.Append;
        nSqry.FieldByName('Gcode').AsString:=St2;
        nSqry.FieldByName('Gname').AsString:=St3;
        nSqry.FieldByName('Gubun').AsString:=St4;
        nSqry.FieldByName('Gjisa').AsString:=St5;
        if St5<>'' then
        nSqry.FieldByName('Gname').AsString:=Base10.Seek_Jisa(St5,'2')+
                                         St3+Base10.Seek_Jisa(St5,'1');
      end;
...
procedure TSobo65.Button201Click(Sender: TObject);
var St1: String;
begin
  Refresh;
  if(T00=0)Then begin
...
procedure TSobo65.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
  ...
  if((Edit104.Focused=True)and(Edit104.SelStart=40)and(Length(Trim(Edit104.Text))=40))or
    ...
    ((Edit108.Focused=True)and(Edit108.SelStart=40)and(Length(Trim(Edit108.Text))=40))or
    ((Edit110.Focused=True)and(Edit110.SelStart=40)and(Length(Trim(Edit110.Text))=40))or
    ((Edit112.Focused=True)and(Edit112.SelStart=24)and(Length(Trim(Edit112.Text))=24))Then begin
      Edit114KeyPress(Self,St1);
  end;
end;

procedure TSobo65.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo65.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo65.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo65.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo65.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
  ...
  if Edit104.Focused=True Then begin
    ...
    Seek40.FilterTing(Edit104.Text,Edit111.Text);
  ...
  if Edit106.Focused=True Then begin
    ...
    Seek40.FilterTing(Edit106.Text,Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
      SelectNext(ActiveControl as TWinControl, True, True);
  ...
  if Edit108.Focused=True Then begin
    ...
    Seek40.Edit1.Text:=Edit108.Text;
    Seek40.FilterTing(Edit108.Text,Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
      SelectNext(ActiveControl as TWinControl, True, True);
      Edit107.Text:=Seek40.Query1Gcode.AsString;
      Edit108.Text:=Seek40.Query1Gname.AsString;
    end else
    if Seek40.ShowModal=mrOK Then begin
      SelectNext(ActiveControl as TWinControl, True, True);
      Edit107.Text:=Seek40.Query1Gcode.AsString;
  ...
  if Edit110.Focused=True Then begin
    ...
    Seek40.Edit1.Text:=Edit110.Text;
    Seek40.FilterTing(Edit110.Text,Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
      Edit109.Text:=Seek40.Query1Gcode.AsString;
      Edit110.Text:=Seek40.Query1Gname.AsString;
      Button101Click(Self);
    end else
    if Seek40.ShowModal=mrOK Then begin
      Edit109.Text:=Seek40.Query1Gcode.AsString;
...
procedure TSobo65.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo65.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo65.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo65.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo65.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo65.DBGrid101TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(mSqry,Column);
end;

procedure TSobo65.DBGrid201TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(nSqry,Column);
end;

procedure TSobo65.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo65.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo65.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo65.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo65.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo65.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo65.Button700Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
...
procedure TSobo65.Button701Click(Sender: TObject);
begin
    Seek40.Edit1.Text:='';
    Seek40.FilterTing(' ',Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
      Edit103.Text:=Seek40.Query1Gcode.AsString;
      Edit104.Text:=Seek40.Query1Gname.AsString;
    end else
...
procedure TSobo65.Button702Click(Sender: TObject);
begin
    Seek40.Edit1.Text:='';
    Seek40.FilterTing(' ',Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
...
procedure TSobo65.Button703Click(Sender: TObject);
begin
    Seek40.Edit1.Text:='';
    Seek40.FilterTing(' ',Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
...
procedure TSobo65.Button704Click(Sender: TObject);
begin
    Seek40.Edit1.Text:='';
    Seek40.FilterTing(' ',Edit111.Text);
    if Seek40.Query1.RecordCount=1 Then begin
