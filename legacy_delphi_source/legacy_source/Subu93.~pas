...
uses Chul, Base01, Tong02, Tong04, TcpLib, Subu91,
   Seak01, Seak02, Seak03, Seak04, Seak05, Seak06, Seak07, Seak08, Seak09,
   Seek01, Seek02, Seek03, Seek04, Seek05, Seek06, Seek07, Seek08, Seek09;

procedure TSobo93.FormActivate(Sender: TObject);
begin
  nForm:='93';
  nSqry:=T5_Sub31;
  mSqry:=T5_Sub32;
...
procedure TSobo93.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo93.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo93:=nil;
...
procedure TSobo93.Button001Click(Sender: TObject);
begin
...
procedure TSobo93.Button002Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
...
procedure TSobo93.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo93.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo93.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo93.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo93.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo93.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo93.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo93.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('53-01');
end;

procedure TSobo93.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('53-02');
end;

procedure TSobo93.Button016Click(Sender: TObject);
begin
  Tong40.print_53_01(Self);
end;

procedure TSobo93.Button017Click(Sender: TObject);
begin
  Tong40.print_53_02(Self);
end;

procedure TSobo93.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo93.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo93.Button101Click(Sender: TObject);
...
procedure TSobo93.Button201Click(Sender: TObject);
...
procedure TSobo93.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo93.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo93.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo93.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo93.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo93.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo93.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo93.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo93.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo93.Edit115KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo93.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo93.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo93.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo93.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo93.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo93.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo93.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if mSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
  end;
...
procedure TSobo93.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo93.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo93.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo93.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
  ...
  nSqry.Filter:=St1;
  nSqry.Filtered:=True;
  Tong20.Srart_53_01(Self);
end;

procedure TSobo93.DBGrid201DblClick(Sender: TObject);
begin
  if(nSqry.RecordCount>0)Then begin
  Subu00.Menu901Click(Self);
  Sobo91.Edit103.Text:=T5_Sub31.FieldByName('Jubun').AsString;
  Sobo91.Edit101.Text:=T5_Sub31.FieldByName('Gdate').AsString;
  Sobo91.Edit104.Text:=T5_Sub31.FieldByName('Gcode').AsString;
  Sobo91.Edit105.Text:=T5_Sub31.FieldByName('Gname').AsString;
  Sobo91.Edit107.Text:=T5_Sub32.FieldByName('Hcode').AsString;
  Sobo91.Edit108.Text:=T5_Sub32.FieldByName('Hname').AsString;
  Sobo91.Label100.Visible:=False;
  Sobo91.Edit106.Visible:=False;
  Sobo91.Edit106.Items.Clear;
  if T5_Sub31.FieldByName('Gjisa').AsString<>'' then begin
  Sobo91.Label100.Visible:=True;
  Sobo91.Edit106.Visible:=True;
  Sobo91.Edit106.Items.Add(T5_Sub31.FieldByName('Gjisa').AsString);
...
procedure TSobo93.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo93.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo93.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo93.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo93.Button701Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit104.Text;
...
procedure TSobo93.Button702Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit106.Text;
