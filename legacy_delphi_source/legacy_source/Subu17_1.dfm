object Sobo17_1: TSobo17_1
  ...
  object T1_Sub71: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 42
    Top = 158
    object T1_Sub71ID: TFloatField
      FieldName = 'ID'
    end
    object T1_Sub71CHEK1: TStringField
      FieldName = 'CHEK1'
      Size = 5
    end
    object T1_Sub71CHEK2: TStringField
      FieldName = 'CHEK2'
      Size = 5
    end
    object T1_Sub71SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T1_Sub71SNAME: TStringField
      FieldName = 'SNAME'
      KeyFields = 'GUBUN'
    end
    object T1_Sub71GUBUN: TStringField
      FieldName = 'GUBUN'
      Size = 5
    end
    object T1_Sub71JUBUN: TStringField
      FieldName = 'JUBUN'
      Size = 6
    end
    object T1_Sub71GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T1_Sub71GNAME: TStringField
      FieldName = 'GNAME'
      Size = 50
    end
    object T1_Sub71OCODE: TStringField
      FieldName = 'OCODE'
      Size = 5
    end
    object T1_Sub71ONAME: TStringField
      FieldName = 'ONAME'
      Size = 50
    end
    object T1_Sub71NAME1: TStringField
      FieldName = 'NAME1'
      Size = 50
    end
    object T1_Sub71NAME2: TStringField
      FieldName = 'NAME2'
      Size = 50
    end
    object T1_Sub71JUMIN: TStringField
      FieldName = 'JUMIN'
      Size = 14
    end
    object T1_Sub71GPPER: TStringField
      FieldName = 'GPPER'
    end
    object T1_Sub71GPOST: TStringField
      FieldName = 'GPOST'
      Size = 7
    end
    object T1_Sub71GADD1: TStringField
      FieldName = 'GADD1'
      Size = 44
    end
    object T1_Sub71GADD2: TStringField
      FieldName = 'GADD2'
      Size = 44
    end
    object T1_Sub71GADDS: TStringField
      FieldName = 'GADDS'
      Size = 80
    end
    object T1_Sub71GTEL1: TStringField
      FieldName = 'GTEL1'
      Size = 4
    end
    object T1_Sub71GTEL2: TStringField
      FieldName = 'GTEL2'
    end
    object T1_Sub71GTELS: TStringField
      FieldName = 'GTELS'
      Size = 25
    end
    object T1_Sub71GFAX1: TStringField
      FieldName = 'GFAX1'
      Size = 4
    end
    object T1_Sub71GFAX2: TStringField
      FieldName = 'GFAX2'
    end
    object T1_Sub71GFAXS: TStringField
      FieldName = 'GFAXS'
      Size = 25
    end
    object T1_Sub71BIGO2: TStringField
      FieldName = 'BIGO2'
      Size = 50
    end
    object T1_Sub71GNUM1: TStringField
      FieldName = 'GNUM1'
      Size = 10
    end
    object T1_Sub71GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
    object T1_Sub71GPOSA: TStringField
      FieldName = 'GPOSA'
      Size = 30
    end
    object T1_Sub71GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 12
    end
    object T1_Sub71GUPER: TStringField
      FieldName = 'GUPER'
      Size = 30
    end
    object T1_Sub71GJOMO: TStringField
      FieldName = 'GJOMO'
      Size = 30
    end
    object T1_Sub71HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T1_Sub71GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T1_Sub71GIQUT: TFloatField
      FieldName = 'GIQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T1_Sub71GISUM: TFloatField
      FieldName = 'GISUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T1_Sub71GOSUM: TFloatField
      FieldName = 'GOSUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T1_Sub71GSSUM: TFloatField
      FieldName = 'GSSUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
  end
  object T1_Sub72: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 74
    Top = 158
    object T1_Sub72ID: TFloatField
      FieldName = 'ID'
    end
    object T1_Sub72GCODE: TStringField
      FieldName = 'GCODE'
      Size = 10
    end
    object T1_Sub72GNAME: TStringField
      FieldName = 'GNAME'
      Size = 100
    end
    object T1_Sub72HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
  end
