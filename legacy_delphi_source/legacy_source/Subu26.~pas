...
type
  TSobo26 = class(TForm)
    ...
    procedure Seek_Post(Sender: TObject);//서가위치를 필드에 저장
  private
...
procedure TSobo26.FormActivate(Sender: TObject);
begin
  nForm:='26';
  nSqry:=Base10.T2_Sub61;
  mSqry:=Base10.T2_Sub62;
  tSqry:=Base10.T4_Sub81;
end;

procedure TSobo26.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo26.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo26:=nil;
...
procedure TSobo26.Button001Click(Sender: TObject);
begin
...
procedure TSobo26.Button002Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
...
procedure TSobo26.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo26.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo26.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo26.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo26.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo26.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo26.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo26.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('26-01');
end;

procedure TSobo26.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('26-02');
end;

procedure TSobo26.Button016Click(Sender: TObject);
begin
  Delete_Seek(Self);
  ...
  begin
    Seek_Post(Self);//별 내용 없어. 단지 nSqry의 GPost(서가위치), OPost(도서위치)에 서가위치, 도서위치를 저장함
    nSqry.IndexName := 'IDX'+'GPOST'+'DOWN';
    Tong40.PrinTing00('24','1','','','','','','','','');
    nSqry.IndexName := 'IDX'+'ID'+'DOWN';
  end
  else if(Base10.Database.Database='chul_02_db')or
      ((Base10.Database.Database='book_01_db')and(Base10.Database.Host='115.68.7.138'))or
      ((Base10.Database.Database='book_02_db')and(Base10.Database.Host='115.68.7.138'))or
      ((Base10.Database.Database='book_06_db')and(Base10.Database.Host='115.68.3.154'))or
      ((Base10.Database.Database='chul_07_db')and(Base10.Database.Host='115.68.3.153'))then
  begin
    Seek_Post(Self);//별 내용 없어. 단지 nSqry의 GPost(서가위치), OPost(도서위치)에 서가위치, 도서위치를 저장함
...
{
  if(Base10.Database.Database='chul_02_db')or
      ((Base10.Database.Database='book_01_db')and(Base10.Database.Host='115.68.7.138'))or
      ((Base10.Database.Database='book_02_db')and(Base10.Database.Host='115.68.7.138'))or
      ((Base10.Database.Database='book_06_db')and(Base10.Database.Host='115.68.3.154'))or
      ((Base10.Database.Database='chul_07_db')and(Base10.Database.Host='115.68.3.153'))then
...
procedure TSobo26.Button017Click(Sender: TObject);
begin
  mSqry.First;
  ...
  begin
   ...
   ((Base10.Database.Database='book_01_db')and(Base10.Database.Host='115.68.7.138'))or
   ((Base10.Database.Database='book_02_db')and(Base10.Database.Host='115.68.7.138'))or
   ((Base10.Database.Database='chul_07_db')and(Base10.Database.Host='115.68.3.153'))then begin
    Seek_Post(Self);
    nSqry.IndexName := 'IDX'+'QPOST'+'DOWN';
    Tong40.PrinTing00('24','1','','','','','','','','');
    nSqry.IndexName := 'IDX'+'ID'+'DOWN';
...
procedure TSobo26.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo26.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo26.Button101Click(Sender: TObject);
var St1,St2,St3: String;
  p_Scode,p_Gdate,p_Hcode,p_Gcode,p_Gubun,p_Jubun,p_Gjisa,p_Icode: String;
begin
//if Base10.Seek_Ggeo(Edit108.Text)='X' Then Exit;
  ...
  St1:='Gdate'+'>='+#39+Edit101.Text+#39+' and '+
       ...
       'Gubun'+' ='+#39+'출고'+#39+' and '+
       'Ocode'+' ='+#39+'B'+#39+' and '+
      '(Scode'+' ='+#39+'X'+#39+' or '+'Scode'+' ='+#39+'1'+#39+')';
  ...
  if(Base10.Database.Database='book_kb_db')or
    (Base10.Database.Database='chul_04_db')then
  ...
  { if nSqry.FieldByName('Gjisa').AsString<>'' then
    ...
    if(nSqry.FieldByName('Gdate').AsString=p_Gdate)and
      ...
      (nSqry.FieldByName('Gjisa').AsString=p_Gjisa)Then begin
    end else begin
      ...
      p_Icode:=nSqry.FieldByName('Icode').AsString;
      if p_Icode='' then
      p_Icode:=nSqry.FieldByName('ID').AsString;
    end;
  //if nSqry.FieldByName('Icode').AsString='' then
    nSqry.FieldByName('Icode').AsString:=p_Icode;
...
//nSqry.IndexName := 'IDX'+'BCODE'+'DOWN';
  ...
  nSqry.BeforePost:=Base10.T2_Sub61BeforePost;

  Tong40.Hide;
{ Tong40.Free; }
end;

procedure TSobo26.Button201Click(Sender: TObject);
...
procedure TSobo26.Button301Click(Sender: TObject);
begin
...
procedure TSobo26.Button400Click(Sender: TObject);
var St1: String;
begin
  Sqlen := 'Select Gname,Gadd1,Gadd2,Gtel1,Gtel2 From G1_Ggeo Where '+D_Select+
...
procedure TSobo26.Button401Click(Sender: TObject);
begin
...
procedure TSobo26.Button403Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
  Cpost:='26';
...
procedure TSobo26.Button501Click(Sender: TObject);
...
procedure TSobo26.Button509Click(Sender: TObject);
...
procedure TSobo26.Button601Click(Sender: TObject);
begin
...
procedure TSobo26.Button609Click(Sender: TObject);
...
procedure TSobo26.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo26.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo26.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo26.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo26.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo26.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo26.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo26.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo26.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo26.Edit115KeyPress(Sender: TObject; var Key: Char);
var St1: String;
begin
  if Key=#13 Then begin
...
procedure TSobo26.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo26.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo26.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo26.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo26.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var St1: String;
begin
  if nSqry.Active=True Then begin
...
procedure TSobo26.DBGrid201KeyPress(Sender: TObject; var Key: Char);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
...
procedure TSobo26.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
  ...
  if sColumn=False Then begin
    ...
    if Key=VK_DELETE Then Base10.T2_Sub61AfterDelete(nSqry);
  //if Key=VK_ESCAPE Then Edit101.SetFocus;
  end; end;
end;

procedure TSobo26.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo26.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo26.DataSource1DataChange(Sender: TObject; Field: TField);
begin
...
procedure TSobo26.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
...
procedure TSobo26.DBGrid201DblClick(Sender: TObject);
begin
  if(nSqry.RecordCount>0)Then begin
  Subu00.Menu201Click(Self);
  Sobo21.Edit103.Text:=Base10.T2_Sub61.FieldByName('Jubun').AsString;
  Sobo21.Edit101.Text:=Base10.T2_Sub61.FieldByName('Gdate').AsString;
  Sobo21.Edit104.Text:=Base10.T2_Sub62.FieldByName('Gcode').AsString;
  Sobo21.Edit105.Text:=Base10.T2_Sub62.FieldByName('Gname').AsString;
  Sobo21.Edit107.Text:=Base10.T2_Sub62.FieldByName('Hcode').AsString;
  Sobo21.Edit108.Text:=Base10.T2_Sub62.FieldByName('Hname').AsString;
  Sobo21.Label100.Visible:=False;
  Sobo21.Edit106.Visible:=False;
  Sobo21.Edit106.Items.Clear;
  if Base10.T2_Sub61.FieldByName('Gjisa').AsString<>'' then begin
  Sobo21.Label100.Visible:=True;
  Sobo21.Edit106.Visible:=True;
  Sobo21.Edit106.Items.Add(Base10.T2_Sub61.FieldByName('Gjisa').AsString);
...
procedure TSobo26.Delete_Seek(Sender: TObject);
var St1: String;
begin
...
procedure TSobo26.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo26.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo26.Button701Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
...
procedure TSobo26.Button702Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
...
procedure TSobo26.Edit205Click(Sender: TObject);
begin
...
procedure TSobo26.Edit205Exit(Sender: TObject);
begin
  StaticText1.Visible:=False;
  StaticText2.Visible:=False;
  StaticText3.Visible:=False;
...
procedure TSobo26.StaticText1Click(Sender: TObject);
begin
  StaticText1.Visible:=False;
  Edit209.SetFocus;
end;

procedure TSobo26.StaticText2Click(Sender: TObject);
begin
  StaticText2.Visible:=False;
  Edit210.SetFocus;
end;

procedure TSobo26.StaticText3Click(Sender: TObject);
begin
  StaticText3.Visible:=False;
  Edit211.SetFocus;
end;

procedure TSobo26.StaticText4Click(Sender: TObject);
begin
  StaticText4.Visible:=False;
  Edit212.SetFocus;
end;

procedure TSobo26.DBGrid201DrawColumnCell(Sender: TObject;
...
procedure TSobo26.Seek_Post(Sender: TObject);
begin
  nSqry.BeforePost:=nil;
  DataSource2.Enabled:=False;
  DataSource1.Enabled:=False;
  nSqry.First;
  While nSqry.EOF=False do begin
    Sqlen := 'Select Gpost,Opost From G4_Book '+
    ...
    if Base10.Socket.Body_Data <> 'NODATA' then begin
      ...
      nSqry.Edit;
      if(Base10.Database.Database='chul_02_db')or
        (Base10.Database.Database='chul_08_db')or
       ((Base10.Database.Database='book_01_db')and(Base10.Database.Host='115.68.7.138'))then
      nSqry.FieldByName('Qpost').AsString:=Trim(Copy(AutoFrx(Base10.Socket.GetData(1, 1)),1,10))
                                          +nSqry.FieldByName('Bcode').AsString
      else
      nSqry.FieldByName('Qpost').AsString:=nSqry.FieldByName('Bcode').AsString;
    //Format('%09s',[FormatFloat('000000000',nSqry.FieldByName('Bcode').AsInteger)] );
      nSqry.FieldByName('Gpost').AsString:=Trim(Copy(AutoFrx(Base10.Socket.GetData(1, 1)),1,20));//서가위치
      nSqry.FieldByName('Opost').AsString:=Trim(Copy(AutoFrx(Base10.Socket.GetData(1, 2)),1,20));//보관위치
      nSqry.Post;
    end;
