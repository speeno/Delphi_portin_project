...
procedure TSeek50.FilterSing(Str,Sth:String);
var St1,St2: String;
begin
  ...
  Sqlen := 'Select Gubun,Jubun,Gcode,Ocode,Gname,Gposa,'+
           'Gtel1,Gtel2,Gadd1,Gadd2 From G5_Ggeo Where '+D_Select+St1;
...
procedure TSeek50.FilterTing(Str,Sth:String);
var St1,St2: String;
begin
  Base10.OpenExit(Query1);
  Base10.OpenShow(Query1);
...
procedure TSeek50.FilterSeek(Str,Sth:String);
begin
//
end;

procedure TSeek50.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then
  FilterTing(Edit1.Text,Edit3.Text);
end;

procedure TSeek50.Button001Click(Sender: TObject);
begin
  FilterTing(Edit1.Text,Edit3.Text);
end;

procedure TSeek50.DBGrid101DblClick(Sender: TObject);
begin
  ModalResult:=mrOK;
end;

procedure TSeek50.Edit1Enter(Sender: TObject);
begin
  FilterTing(Edit1.Text,Edit3.Text);
end;

procedure TSeek50.FormShow(Sender: TObject);
begin
  DBGrid101.SetFocus;
end;

procedure TSeek50.Query1CalcFields(DataSet: TDataSet);
var St1,St2: String;
begin
