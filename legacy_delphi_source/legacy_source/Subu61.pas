...
procedure TSobo61.FormActivate(Sender: TObject);
begin
  nForm:='61';
  nSqry:=Base10.T6_Sub11;
  mSqry:=Base10.T6_Sub12;
end;

procedure TSobo61.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo61.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo61:=nil;
...
procedure TSobo61.Button001Click(Sender: TObject);
begin
...
procedure TSobo61.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_61_01(Self);
  end;
end;

procedure TSobo61.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo61.Button004Click(Sender: TObject);
begin
  Base10.OpenExit(nSqry);
  Base10.OpenExit(mSqry);
  Tong20.Srart_61_01(Self);
  Tong20.Srart_61_02(Self);
  Tong20.Chang_00_01('61');
  Edit101.SetFocus;
end;

procedure TSobo61.Button005Click(Sender: TObject);
begin
  Tong20.Chang_00_02('61');
end;

procedure TSobo61.Button006Click(Sender: TObject);
begin
  T00:=1;
  Button201Click(Self);
end;

procedure TSobo61.Button007Click(Sender: TObject);
begin
  T00:=0;
  Button201Click(Self);
end;

procedure TSobo61.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('61');
end;

procedure TSobo61.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Out_01('61');
end;

procedure TSobo61.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo61.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo61.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY2(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo61.Button013Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY2(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo61.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('61-01');
end;

procedure TSobo61.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('61-02');
end;

procedure TSobo61.Button016Click(Sender: TObject);
begin
  Tong40.print_61_01(Self);
end;

procedure TSobo61.Button017Click(Sender: TObject);
begin
  Tong40.print_61_02(Self);
end;

procedure TSobo61.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo61.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo61.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo61.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo61.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo61.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo61.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo61.Button101Click(Sender: TObject);
...
procedure TSobo61.Button201Click(Sender: TObject);
...
begin
  ...
  List1:=List1+1;
    ...
    if mSqry.Locate('Gcode;Gjisa',VarArrayOf([St3,St6]),[loCaseInsensitive])=False then begin
      ...
      if St7='' then
      St7:=Base10.Seek_Code(St3,St4,Edit107.Text);
...
procedure TSobo61.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo61.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo61.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo61.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo61.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo61.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo61.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo61.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo61.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo61.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo61.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo61.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo61.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo61.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo61.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo61.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo61.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo61.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo61.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo61.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo61.Button701Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit104.Text;
...
procedure TSobo61.Button702Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit106.Text;
