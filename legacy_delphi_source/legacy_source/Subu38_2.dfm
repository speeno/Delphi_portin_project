object Sobo38_2: TSobo38_2
  ...
  object T3_Sub81: TClientDataSet
    Aggregates = <>
    Params = <>
    BeforeClose = T3_Sub81BeforeClose
    BeforePost = T3_Sub81BeforePost
    AfterPost = T3_Sub81AfterPost
    AfterCancel = T3_Sub81AfterCancel
    BeforeScroll = T3_Sub81AfterScroll
    AfterScroll = T3_Sub81AfterScroll
    OnNewRecord = T3_Sub81NewRecord
    Left = 42
    Top = 154
    object T3_Sub81ID: TFloatField
      FieldName = 'ID'
    end
    object T3_Sub81HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T3_Sub81GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T3_Sub81GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T3_Sub81GNAME: TStringField
      FieldName = 'GNAME'
      Size = 50
    end
    object T3_Sub81GUBUN: TStringField
      FieldName = 'GUBUN'
      Size = 5
    end
    object T3_Sub81GSQUT: TFloatField
      FieldName = 'GSQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T3_Sub81GDANG: TFloatField
      FieldName = 'GDANG'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T3_Sub81GSSUM: TFloatField
      FieldName = 'GSSUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T3_Sub81GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
  end
  object T3_Sub82: TClientDataSet
    ...
    object T3_Sub82GUBUN: TStringField
      FieldName = 'GUBUN'
      Size = 10
    end
  end
