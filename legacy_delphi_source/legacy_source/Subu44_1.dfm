object Sobo44_1: TSobo44_1
  ...
  object T4_Sub41: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 42
    Top = 127
    object T4_Sub41ID: TFloatField
      FieldName = 'ID'
    end
    object T4_Sub41GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T4_Sub41SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T4_Sub41GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T4_Sub41GNAME: TStringField
      FieldName = 'GNAME'
      Size = 24
    end
    object T4_Sub41HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T4_Sub41HNAME: TStringField
      FieldName = 'HNAME'
      Size = 24
    end
    object T4_Sub41NAME1: TStringField
      FieldName = 'NAME1'
      Size = 30
    end
    object T4_Sub41NAME2: TStringField
      FieldName = 'NAME2'
      Size = 30
    end
    object T4_Sub41GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 30
    end
    object T4_Sub41GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
    object T4_Sub41GSSUM: TFloatField
      FieldName = 'GSSUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
  end
  object T4_Sub42: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 74
    Top = 127
    object T4_Sub42ID: TFloatField
      FieldName = 'ID'
    end
    object T4_Sub42GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T4_Sub42SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T4_Sub42GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T4_Sub42GNAME: TStringField
      FieldName = 'GNAME'
      Size = 24
    end
    object T4_Sub42HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T4_Sub42HNAME: TStringField
      FieldName = 'HNAME'
      Size = 24
    end
    object T4_Sub42NAME1: TStringField
      FieldName = 'NAME1'
      Size = 30
    end
    object T4_Sub42NAME2: TStringField
      FieldName = 'NAME2'
      Size = 30
    end
    object T4_Sub42GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 30
    end
    object T4_Sub42GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
    object T4_Sub42GSSUM: TFloatField
      FieldName = 'GSSUM'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
