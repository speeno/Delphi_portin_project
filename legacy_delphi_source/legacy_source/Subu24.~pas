...
procedure TSobo24.FormActivate(Sender: TObject);
begin
  nForm:='24';
  nSqry:=Base10.T2_Sub41;
  mSqry:=Base10.T2_Sub42;
end;

procedure TSobo24.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo24.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo24:=nil;
...
procedure TSobo24.Button001Click(Sender: TObject);
begin
...
procedure TSobo24.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo24.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo24.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button008Click(Sender: TObject);
begin
//Tong20.Zoom_Int_01('24');
end;

procedure TSobo24.Button009Click(Sender: TObject);
begin
//Tong20.Zoom_Out_01('24');
end;

procedure TSobo24.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo24.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo24.Button013Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('24-01');
end;

procedure TSobo24.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('24-02');
end;

procedure TSobo24.Button016Click(Sender: TObject);
begin
  Tong40.print_24_01(Self);
end;

procedure TSobo24.Button017Click(Sender: TObject);
begin
{ Tong40.print_24_02(Self); }
end;

procedure TSobo24.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button021Click(Sender: TObject);
begin
//Tong20.DBGridFont2(DBGrid101,StBar101);
end;

procedure TSobo24.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Button101Click(Sender: TObject);
var St1,St2: String;
begin
  ...
  nSqry.BeforePost:=Base10.T2_Sub41BeforePost;

  Tong40.Hide;
{ Tong40.Free; }
end;

procedure TSobo24.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo24.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo24.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo24.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo24.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo24.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo24.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo24.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo24.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo24.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo24.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo24.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo24.DBGrid101Exit(Sender: TObject);
begin
  Base10.T2_Sub41BeforeClose(Base10.T2_Sub41);
end;

procedure TSobo24.DBGrid201Exit(Sender: TObject);
begin
//
end;

procedure TSobo24.DBGrid101Enter(Sender: TObject);
begin
  Base10.T2_Sub41AfterScroll(Base10.T2_Sub41);
end;

procedure TSobo24.DBGrid201Enter(Sender: TObject);
begin
//
end;

procedure TSobo24.DBGrid101KeyPress(Sender: TObject; var Key: Char);
var sColumn: Boolean;
    sIndexs: Integer;
...
procedure TSobo24.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
  ...
  if sColumn=False Then begin
    ...
    if Key=VK_DELETE Then Base10.T2_Sub41AfterDelete(nSqry);
    if Key=VK_ESCAPE Then Edit101.SetFocus;
  end; end;
end;

procedure TSobo24.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo24.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo24.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo24.DBGrid201TitleClick(Column: TColumnEh);
begin
//
end;

procedure TSobo24.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo24.DataSource2DataChange(Sender: TObject; Field: TField);
begin
//
end;

procedure TSobo24.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo24.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo24.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo24.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo24.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
