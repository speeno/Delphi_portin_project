...
uses Chul, Base01, Subu19, Tong02, Tong04, TcpLib, Seok01,
   Seak01, Seak02, Seak03, Seak04, Seak05, Seak06, Seak07, Seak08, Seak09,
   Seek01, Seek02, Seek03, Seek04, Seek05, Seek06, Seek07, Seek08, Seek09;

procedure TSobo15.FormPaint(Sender: TObject);
begin
{ Button023Click(Self);
  Button024Click(Self); }
  Sobo15.OnPaint:=Nil;
  Sobo15.OnShow:=FormShow;
  FormShow(Self);
end;

procedure TSobo15.FormActivate(Sender: TObject);
begin
  nForm:='15';
  nSqry:=Base10.T1_Sub51;
  mSqry:=Base10.T1_Sub52;
end;

procedure TSobo15.FormShow(Sender: TObject);
begin
  Refresh;
...
procedure TSobo15.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo15:=nil;
...
procedure TSobo15.Button001Click(Sender: TObject);
begin
...
procedure TSobo15.Button002Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
  if Seak20.ShowModal=mrOK then
     Tong20.Srart_15_01(Self);
  end;
end;

procedure TSobo15.Button003Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo15.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button007Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Seok10.ShowModal;
end;

procedure TSobo15.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button010Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnX0(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo15.Button013Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnX0(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo15.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('15-01');
end;

procedure TSobo15.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('15-02');
end;

procedure TSobo15.Button016Click(Sender: TObject);
begin
  Tong40.print_15_01(Self);
end;

procedure TSobo15.Button017Click(Sender: TObject);
begin
  Tong40.print_15_02(Self);
end;

procedure TSobo15.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button021Click(Sender: TObject);
begin
//
end;

procedure TSobo15.Button022Click(Sender: TObject);
begin
  nSqry.SaveToFile('.\Data\G5_Ggeo.cds');
end;

procedure TSobo15.Button023Click(Sender: TObject);
begin
  ...
  Edit128.Text := nSqry.FieldByName('Pubun').AsString;
  Edit129.Text := nSqry.FieldByName('Email').AsString;
  Edit130.Text := nSqry.FieldByName('Gnum1').AsString;
...
procedure TSobo15.Button024Click(Sender: TObject);
begin
  Edit201.Text := mSqry.FieldByName('Gcode').AsString;
  Edit202.Text := mSqry.FieldByName('Gname').AsString;
end;

procedure TSobo15.Button101Click(Sender: TObject);
begin
...
procedure TSobo15.Button102Click(Sender: TObject);
var MeDlg: Integer;
    St1,St2,Sq1,Sq2,Sq3,Sq4: String;
begin
...
mrYes: begin
  ...
  if nSqry.State=dsInsert Then begin
    ...
    '  Yesno, Name1, Name2, Pubun, Email, Hcode, '+
    '  Gnum1, Grat1, Grat2, Grat3, Grat4, Grat5, '+
    '  Grat6, Grat7, Grat8, Grat9, Gqut1) VALUES ';
    Sq1 :=
    '(''@Gubun'',''@Jubun'',''@Gcode'',''@Ocode'',''@Gname'',''@Gposa'', '+
    ' ''@Gnumb'',''@Guper'',''@Gjomo'',''@Gtel1'',''@Gtel2'',''@Gfax1'', ';
    Sq2 :=
    ...
    Sq3 :=
    ' ''@Gnum1'',  @Grat1  ,  @Grat2  ,  @Grat3  ,  @Grat4  ,  @Grat5  , '+
    '   @Grat6  ,  @Grat7  ,  @Grat8  ,  @Grat9  ,  @Gqut1  )';

  { St1 := 'Select Gcode From G1_Gbun Where '+D_Select+'Gname=''@Gname'' and Hcode=''@Hcode'' ';
    ...
    Base10.InSert_ID(nSqry,'G1_GGEO_ID_GEN');
  end else begin

    Sq1 := 'UPDATE G1_Ggeo SET '+
    ...
    Sq3 :=
    'Yesno=''@Yesno'',Name1=''@Name1'',Name2=''@Name2'',Pubun=''@Pubun'', '+
    'Email=''@Email'',Gnum1=''@Gnum1'', ';
    Sq4 :=
  ...
  { St1 := 'Select Gcode From G1_Gbun Where '+D_Select+'Gname=''@Gname'' and Hcode=''@Hcode'' ';
    ...
    Translate(Sq3, '@Name1', Edit126.Text);
    Translate(Sq3, '@Name2', Edit127.Text);
    Translate(Sq3, '@Pubun', Edit128.Text);
    Translate(Sq3, '@Email', Edit129.Text);
    Translate(Sq3, '@Gnum1', Edit130.Text);

    TransAuto(Sq4, '@Grat3', FloatToStr(Edit120.Value));
    TransAuto(Sq4, '@Grat4', FloatToStr(Edit121.Value));
    TransAuto(Sq4, '@Grat5', FloatToStr(Edit122.Value));
    TransAuto(Sq4, '@Grat6', FloatToStr(Edit123.Value));
    TransAuto(Sq4, '@Grat7', '0');
    TransAuto(Sq4, '@Grat8', '0');
    TransAuto(Sq4, '@Gqut1', FloatToStr(Edit124.Value));
    Translate(Sq4, '@Gcode', Edit103.Text);
    Translate(Sq4, '@Hcode', Label300.Caption);

    if CheckBox1.Checked=True then
    Translate(Sq3, '@Yesno', 'True') else
    Translate(Sq3, '@Yesno', 'False');

    if CheckBox2.Checked=True then
    TransAuto(Sq4, '@Grat9', '1') else
    TransAuto(Sq4, '@Grat9', '0');

    Sqlen:=Sq1+Sq2+Sq3+Sq4;
  ...
  nSqry.FieldByName('Pubun').AsString := Edit128.Text;
  nSqry.FieldByName('Email').AsString := Edit129.Text;
  nSqry.FieldByName('Gnum1').AsString := Edit130.Text;
  ...
  if Base10.G1_Ggeo.Active=True Then
  if Base10.G1_Ggeo.Locate('Hcode;Gcode',VarArrayOf([Label300.Caption,nSqry.FieldByName('Gcode').AsString]),[loCaseInsensitive])=true then begin
     Base10.G1_Ggeo.Edit;
     Base10.G1_Ggeo.FieldByName('Gubun').AsString:=nSqry.FieldByName('Gubun').AsString;
     Base10.G1_Ggeo.FieldByName('Pubun').AsString:=nSqry.FieldByName('Pubun').AsString;
     Base10.G1_Ggeo.FieldByName('Gname').AsString:=nSqry.FieldByName('Gname').AsString;
     Base10.G1_Ggeo.Post;
  end;
...
procedure TSobo15.Button103Click(Sender: TObject);
var MeDlg: Integer;
begin
...
procedure TSobo15.Button104Click(Sender: TObject);
begin
  Cpost:='15';
...
procedure TSobo15.Button201Click(Sender: TObject);
begin
  mSqry.Insert;
...
procedure TSobo15.Button202Click(Sender: TObject);
var MeDlg: Integer;
begin
MeDlg := MessageDlg('저장 하시겠습니까?', mtConfirmation, [mbYes, mbNo], 0);
case MeDlg of
mrYes: begin
  if mSqry.State=dsInsert Then begin
    ...
    Sqlen := 'INSERT INTO G1_Gbun ( Gcode, Gname, Hcode ) VALUES '+
             '(''@Gcode'',''@Gname'',''@Hcode'')';
    ...
    Base10.InSert_ID(mSqry,'G1_GBUN_ID_GEN');
  end else begin

    Sqlen := 'UPDATE G1_Gbun SET Gcode=''@Gcode'',Gname=''@Gname'' '+
...
procedure TSobo15.Button203Click(Sender: TObject);
var MeDlg: Integer;
begin
MeDlg := MessageDlg('삭제 하시겠습니까?', mtConfirmation, [mbYes, mbNo], 0);
case MeDlg of
mrYes: begin
  ...
  Sqlen := 'DELETE FROM G1_Gbun WHERE Gcode=''@Gcode'' and Hcode=''@Hcode'' ';
  Translate(Sqlen, '@Gcode', Edit201.Text);
  Translate(Sqlen, '@Hcode', '');
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.BusyLoop;
...
procedure TSobo15.Edit101Exit(Sender: TObject);
var St1,St2: String;
begin
  if Edit103.Text='' Then begin
    ...
    if Copy(Edit103.Text,1,1)<>'9' then begin
    ShowMessage('코드를 (9)로 시작해 주세요.');
    Edit103.SetFocus; Exit;
    end;

    St1 := 'Select Gcode From G1_Ggeo Where '+D_Select+'Gcode=''@Gcode'' and Hcode=''@Hcode'' ';
    ...
    if St2<>'' Then begin
    ShowMessage('거래처에 코드가 이미 등록되어있습니다. 다시 입력하세요.');
    Edit103.SetFocus; Exit;
    end;
  end;
end;

procedure TSobo15.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo15.Edit101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo15.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo15.Edit102KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo15.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo15.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo15.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo15.Edit112KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGrid;
    Edits: TFlatComboBox;
begin
...
procedure TSobo15.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
procedure TSobo15.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
    Button202Click(Self);
    DBGrid201.SetFocus;
...
procedure TSobo15.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then begin
    Button202Click(Self);
...
procedure TSobo15.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then
...
procedure TSobo15.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo15.Edit115KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGrid;
    Edits: TFlatComboBox;
begin
  Hands:=Edit128.Handle;
  Edits:=Edit128;
  if Key=#13 Then begin
    if Edits.DropDownCount=9 Then Edits.DropDownCount:=8 else
    if Edits.DropDownCount=8 Then Edits.DropDownCount:=9;
...
procedure TSobo15.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var Edits: TFlatComboBox;
begin
  Edits:=Edit128;
  if Edits.DropDownCount=9 Then begin
...
procedure TSobo15.DBGrid101DblClick(Sender: TObject);
begin
  nSqry.Edit;
  ...
  Sqlen := 'UPDATE G1_Ggeo SET Scode=''@Scode'' '+
           'WHERE Gcode=''@Gcode'' and Hcode=''@Hcode'' ';
...
procedure TSobo15.DBGrid101Enter(Sender: TObject);
begin
  if nSqry.State=dsInsert Then Button102Click(Self);
end;

procedure TSobo15.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo15.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo15.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo15.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo15.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo15.DBGrid201Exit(Sender: TObject);
var St1: String;
begin
  Edit101.Items.Clear;
  St1:='Hcode'+'='+#39+Label300.Caption+#39;
  Sqlen := 'Select * From G1_Gbun Where '+D_Select+St1+' Order By Gcode';
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.busyloop;
...
procedure TSobo15.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo15.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo15.SeachClick(Str1,Str2: String);
var St1: String;
begin
  ...
  Sqlen := 'Select ID,Hcode,Gubun,Jubun,Pubun,Scode,Gcode,Ocode,Gname,Gposa,Gnumb,Guper,'+
           '    Gjomo,Gpost,Gadd1,Gadd2,Gtel1,Gtel2,Gfax1,Gfax2,Grat1,Grat2,Grat3,Grat4,'+
           '    Grat5,Grat6,Grat7,Grat8,Grat9,Gqut1,Yesno,Name1,Name2,Gpper,Gbigo'+
           ' From G1_Ggeo Where '+D_Select+St1+' Order By Gcode';
  ...
  List1:=List1+1;
    ...
    Sqlen := 'Select Gcode From G1_Ggeo Where '+D_Select+'Hcode=''@Hcode'' and Gcode=''@Gcode''';
    Translate(Sqlen, '@Hcode', '');
    Translate(Sqlen, '@Gcode', SGrid.Cells[ 6,List1]);
    if Base10.Seek_Name(Sqlen)='' then begin

    St1:=SGrid.Cells[ 2,List1];
    if mSqry.Locate('Gcode',St1,[loCaseInsensitive])=True then
    St1:=mSqry.FieldByName('Gname').Value;

    nSqry.Append;
    nSqry.FieldByName('Sname').AsString:=St1;
    nSqry.FieldByName('ID').AsString   :=SGrid.Cells[ 0,List1];
    nSqry.FieldByName('Hcode').AsString:=SGrid.Cells[ 1,List1];
    nSqry.FieldByName('Gubun').AsString:=SGrid.Cells[ 2,List1];
    nSqry.FieldByName('Jubun').AsString:=SGrid.Cells[ 3,List1];
    nSqry.FieldByName('Pubun').AsString:=SGrid.Cells[ 4,List1];
    nSqry.FieldByName('Scode').AsString:=SGrid.Cells[ 5,List1];
    nSqry.FieldByName('Gcode').AsString:=SGrid.Cells[ 6,List1];
    nSqry.FieldByName('Ocode').AsString:=SGrid.Cells[ 7,List1];
    nSqry.FieldByName('Gname').AsString:=SGrid.Cells[ 8,List1];
    nSqry.FieldByName('Gposa').AsString:=SGrid.Cells[ 9,List1];
    nSqry.FieldByName('Gnumb').AsString:=SGrid.Cells[10,List1];
    nSqry.FieldByName('Guper').AsString:=SGrid.Cells[11,List1];
    nSqry.FieldByName('Gjomo').AsString:=SGrid.Cells[12,List1];
    nSqry.FieldByName('Gpost').AsString:=SGrid.Cells[13,List1];
    nSqry.FieldByName('Gadd1').AsString:=SGrid.Cells[14,List1];
    nSqry.FieldByName('Gadd2').AsString:=SGrid.Cells[15,List1];
    nSqry.FieldByName('Gadds').AsString:=SGrid.Cells[14,List1]+
                                     ' '+SGrid.Cells[15,List1];
    nSqry.FieldByName('Gtel1').AsString:=SGrid.Cells[16,List1];
    nSqry.FieldByName('Gtel2').AsString:=SGrid.Cells[17,List1];
    nSqry.FieldByName('Gtels').AsString:=SGrid.Cells[16,List1]+
                                     '-'+SGrid.Cells[17,List1];
    nSqry.FieldByName('Gfax1').AsString:=SGrid.Cells[18,List1];
    nSqry.FieldByName('Gfax2').AsString:=SGrid.Cells[19,List1];
    nSqry.FieldByName('Gfaxs').AsString:=SGrid.Cells[18,List1]+
                                     '-'+SGrid.Cells[19,List1];
    nSqry.FieldByName('Grat1').AsString:=SGrid.Cells[20,List1];
    nSqry.FieldByName('Grat2').AsString:=SGrid.Cells[21,List1];
    nSqry.FieldByName('Grat3').AsString:=SGrid.Cells[22,List1];
    nSqry.FieldByName('Grat4').AsString:=SGrid.Cells[23,List1];
    nSqry.FieldByName('Grat5').AsString:=SGrid.Cells[24,List1];
    nSqry.FieldByName('Grat6').AsString:=SGrid.Cells[25,List1];
    nSqry.FieldByName('Grat7').AsString:=SGrid.Cells[26,List1];
    nSqry.FieldByName('Grat8').AsString:=SGrid.Cells[27,List1];
    nSqry.FieldByName('Grat9').AsString:=SGrid.Cells[28,List1];
    nSqry.FieldByName('Gqut1').AsString:=SGrid.Cells[29,List1];
    nSqry.FieldByName('Yesno').AsString:=SGrid.Cells[30,List1];
    nSqry.FieldByName('Name1').AsString:=SGrid.Cells[31,List1];
    nSqry.FieldByName('Name2').AsString:=SGrid.Cells[32,List1];
    nSqry.FieldByName('Gpper').AsString:=SGrid.Cells[33,List1];
    nSqry.FieldByName('Gbigo').AsString:=SGrid.Cells[34,List1];
    nSqry.Post;
  ...
  mSqry.First;
  nSqry.First;
  mSqry.AfterScroll:=Base10.T1_Sub52AfterScroll;
  nSqry.AfterScroll:=Base10.T1_Sub51AfterScroll;
  Button023Click(Self);
  Button024Click(Self);
