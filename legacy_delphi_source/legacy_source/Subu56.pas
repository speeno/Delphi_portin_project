...
uses
  ...
  TFlatRadioButtonUnit, DBGridEh, dxCore, dxButtons;
...
procedure TSobo56.FormActivate(Sender: TObject);
begin
  nForm:='56';
  nSqry:=Base10.T5_Sub61;
  mSqry:=Base10.T5_Sub62;
end;

procedure TSobo56.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo56.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo56:=nil;
...
procedure TSobo56.Button001Click(Sender: TObject);
begin
...
procedure TSobo56.Button002Click(Sender: TObject);
begin
  if mSqry.Active=True Then begin
     oSqry:=mSqry;
  if Seak20.ShowModal=mrOK then
     mSqry.Filtered:=False;
     Tong20.Srart_56_02(Self);
  end;
end;

procedure TSobo56.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo56.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo56.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo56.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo56.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo56.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo56.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo56.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('56-01');
end;

procedure TSobo56.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('56-02');
end;

procedure TSobo56.Button016Click(Sender: TObject);
begin
  Tong40.print_56_01(Self);
end;

procedure TSobo56.Button017Click(Sender: TObject);
begin
  Tong40.print_56_02(Self);
end;

procedure TSobo56.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo56.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo56.Button101Click(Sender: TObject);
...
procedure TSobo56.Button201Click(Sender: TObject);
...
procedure TSobo56.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo56.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo56.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo56.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo56.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo56.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo56.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo56.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo56.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo56.Edit115KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo56.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo56.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
{ if Edit106.Focused=True Then begin
  ...
  if Edit106.Focused=True Then begin
    ...
    Seek10.FilterTing(Edit106.Text,Edit103.Text);
...
procedure TSobo56.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo56.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo56.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo56.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo56.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if mSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
  end;
...
procedure TSobo56.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo56.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo56.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo56.DataSource2DataChange(Sender: TObject; Field: TField);
var St1,St2: String;
begin
  ...
  nSqry.Filter:=St1;
  nSqry.Filtered:=True;
  Tong20.Srart_56_01(Self);
end;

procedure TSobo56.DBGrid201DblClick(Sender: TObject);
begin
...
procedure TSobo56.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo56.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo56.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo56.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo56.Button701Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit104.Text;
...
procedure TSobo56.Button702Click(Sender: TObject);
begin
  Seek10.Edit1.Text:=Edit106.Text;
  if Edit106.Text='' then
  Seek10.FilterTing('',Edit103.Text) else
  Seek10.FilterTing(Edit106.Text,Edit103.Text);
  if Seek10.Query1.RecordCount=1 Then begin
    Edit105.Text:=Seek10.Query1Gcode.AsString;
    Edit106.Text:=Seek10.Query1Gname.AsString;
