...
function TSeok30.CurrText: TTextAttributes;
begin
...
begin
  ...
  Sqlen := 'Select Gcode,Gname From G7_Ggeo Order By Gcode';
...
begin
  ...
  Sqlen := 'Select Gdate From Me_Sage Where Hcode=''@Hcode'' Order By Gdate DESC';
...
{ Sqlen := 'Select Date1,Date2,Gbigo From Me_Sage Where Hcode=''@Hcode'' and Gdate=''@Gdate'' ';
  Translate(Sqlen, '@Hcode', Query1.FieldByName('Gcode').AsString);
...
begin
  ...
  Sqlen := 'Select Gdate From Me_Sage Where Hcode=''@Hcode'' and Gdate=''@Gdate'' ';
  Translate(Sqlen, '@Hcode', Query1.FieldByName('Gcode').AsString);
  ...
  { Sqlen := 'UPDATE Me_Sage SET '+
    'Date1=''@Date1'',Date2=''@Date2'',Gbigo=''@Gbigo'' '+
    'WHERE Hcode=''@Hcode'' and Gdate=''@Gdate'' ';

    Translate(Sqlen, '@Hcode', Query1.FieldByName('Gcode').AsString);
    Translate(Sqlen, '@Gdate', Edit103.Text);
    Translate(Sqlen, '@Date1', Edit101.Text);
    Translate(Sqlen, '@Date2', Edit102.Text);
    Translate(Sqlen, '@Gbigo', Editor.Lines.Text);
  ...
  { Sqlen := 'INSERT INTO Me_Sage '+
    '(Hcode, Gdate, Date1, Date2, Gbigo) VALUES '+
    '(''@Hcode'',''@Gdate'',''@Date1'',''@Date2'',''@Gbigo'')';
