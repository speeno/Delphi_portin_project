...
uses
  ...
  Ping, DIMime, Registry, Printers, MDIWallp, OleCtrls, SHDocVw, MSHTML, AppEvnts;
...
type
  TSubu00 = class(TForm)
    ...
    procedure Menu103_1Click(Sender: TObject);
    ...
    procedure Menu107_1Click(Sender: TObject);
    ...
    procedure Menu204_9Click(Sender: TObject);
    ...
    procedure Menu302_1Click(Sender: TObject);
    ...
    procedure Menu308_1Click(Sender: TObject);
    procedure Menu309Click(Sender: TObject);
    procedure Menu319Click(Sender: TObject);
    procedure Menu329Click(Sender: TObject);
    procedure Menu339Click(Sender: TObject);
    procedure Menu349Click(Sender: TObject);
    procedure Menu359Click(Sender: TObject);
    procedure Menu310Click(Sender: TObject);
    procedure Menu401Click(Sender: TObject);
    procedure Menu402Click(Sender: TObject);
    procedure Menu402_1Click(Sender: TObject);
    procedure Menu403Click(Sender: TObject);
    procedure Menu404Click(Sender: TObject);
    procedure Menu405Click(Sender: TObject);
    procedure Menu405_1Click(Sender: TObject);
    ...
    procedure Menu509_1Click(Sender: TObject);
    procedure Menu509_2Click(Sender: TObject);
    procedure Menu509_3Click(Sender: TObject);
    ...
    procedure Menu801Click(Sender: TObject);
    procedure Menu802Click(Sender: TObject);
    procedure Menu803Click(Sender: TObject);
    procedure Menu804Click(Sender: TObject);
    procedure Menu805Click(Sender: TObject);
    procedure Menu901Click(Sender: TObject);
    procedure Menu903Click(Sender: TObject);
    procedure Menu906Click(Sender: TObject);
    procedure Menu907Click(Sender: TObject);
    procedure Menu908Click(Sender: TObject);
    procedure Menu909Click(Sender: TObject);
    procedure Menu202_1Click(Sender: TObject);
    procedure Menu202_2Click(Sender: TObject);
    procedure Menu304_1Click(Sender: TObject);
    procedure Menu304_2Click(Sender: TObject);
    procedure Menu304_3Click(Sender: TObject);
    procedure Menu304_4Click(Sender: TObject);
    procedure Menu011Click(Sender: TObject);
    procedure Menu012Click(Sender: TObject);
    procedure Menu013Click(Sender: TObject);
    procedure Menu021Click(Sender: TObject);
    procedure Menu022Click(Sender: TObject);
    procedure Menu023Click(Sender: TObject);
    procedure Message_Show(Sender: TObject);
    procedure Post_Show(Sender: TObject);
    procedure Post_Html(Sender: TObject);
    procedure Timer2Timer(Sender: TObject);
    procedure WebBrowser1NewWindow2(Sender: TObject; var ppDisp: IDispatch; var Cancel: WordBool);
    procedure AutoUpdateX(Sender: TObject);
    function Get_FileDateTime(cPath:String):TDateTime;
...
uses Base01,Tong02,Tong03,Tong04,TcpLib,Seok03,Seok04,Seak04_1,Seok08,
     ...
     Subu22_1,Subu22_2,Subu23_1,Subu24_9,Subu42_1,Subu55_1,Subu58_1,Subu71,
     Subu39_1,Subu39_2,Subu39_3,Subu39_4,Subu39_5,Subu32_1,Subu17_1,
     Subu34_1,Subu34_2,Subu34_3,Subu34_4,Subu59_1,Subu59_2,Subu59_3,Subu38_1,
     Subu91,Subu93,Subu96,Subu97,Subu98,Subu99,Subu13_1,Subu45_1,
...
var SetupIni : TIniFile;
    StrList : TStrings;
    Reg: TRegistry;
    ChulpanKey,Chul001Key,Chul002Key,Chul003Key : String;
begin
...
//nPort:=9999;
  ...
  if nPort=9999 then ShowMessage('00');
...
{ if nPcip='' then
  ...
  //--한국도서유통--//
{ Base10.Database.Host:='115.68.7.138';
  Base10.Database.Login:='book_kb_user';
  Base10.Database.Password:='book_kb_pw';
  Base10.Database.Database:='book_kb_db'; }
  Base10.Database.Host:=MimeDecodeString('MTE1LjY4LjcuMTM4');
  Base10.Database.Login:=MimeDecodeString('Ym9va19rYl91c2Vy');
  Base10.Database.Password:=MimeDecodeString('Ym9va19rYl9wdw==');
  Base10.Database.Database:=MimeDecodeString('Ym9va19rYl9kYg==');
  ...
  try
    ...
    ePrnt:='2'; //MySQL
    if nPort=9999 then ShowMessage('01');

    Base10.Database.Connected:=True;
    if nPort=9999 then ShowMessage('02');
    ...
    //Reg.RootKey:=HKEY_LOCAL_MACHINE;
      if Reg.OpenKey('HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\RunOnce', False) then begin
         ...
         Chul001Key:=MimeDecodeString(Reg.ReadString('Chul001Key'));
         Chul002Key:=MimeDecodeString(Reg.ReadString('Chul002Key'));
         Chul003Key:=MimeDecodeString(Reg.ReadString('Chul003Key'));
      end;
    finally
      Reg.CloseKey;
      Reg.Free;
    ...
    if(Hnnnn<>ChulpanKey)and(Hnnnn<>Chul001Key)and
      (Hnnnn<>Chul002Key)and(Hnnnn<>Chul003Key)then begin
  ...
  if Hnnnn='0000' then begin
    S_Where0:='(';
    S_Where1:='(';
    S_Where2:='(';
    Sqlen := 'Select Gcode From G7_Ggeo '+
             'Where '+D_Select+'Chek5 = ''@Chek5'' '+'Order By Gcode';
    ...
    List1:=List1+1;
      if List1=1 then begin
        S_Where0:=S_Where0       +'S.Hcode <> '+SGrid.Cells[ 0,List1];
        S_Where1:=S_Where1       +'Hcode <> '+SGrid.Cells[ 0,List1];
        S_Where2:=S_Where2       +'Gcode <> '+SGrid.Cells[ 0,List1];
      end else begin
        S_Where0:=S_Where0+' and '+'S.Hcode <> '+SGrid.Cells[ 0,List1];
        S_Where1:=S_Where1+' and '+'Hcode <> '+SGrid.Cells[ 0,List1];
        S_Where2:=S_Where2+' and '+'Gcode <> '+SGrid.Cells[ 0,List1];
      end;
    end;
    S_Where0:=S_Where0+')';
    S_Where1:=S_Where1+')';
...
{ if Hnnnn='000b' then begin
    S_Where0:='(';
    S_Where1:='(';
    S_Where2:='(';
    Sqlen := 'Select Gcode From G7_Ggeo '+
             'Where '+D_Select+'Chek5 = ''@Chek5'' '+'Order By Gcode';
    Translate(Sqlen, '@Chek5', 'show2');
    Base10.Socket.RunSQL(Sqlen);
    Base10.Socket.busyloop;
    if Base10.Socket.body_data <> 'ERROR' then
       Base10.Socket.MakeGrid(SGrid)
    ...
    List1:=List1+1;
      if List1=1 then begin
        ...
        S_Where0:=S_Where0+' or '+'S.Hcode = '+SGrid.Cells[ 0,List1];
        S_Where1:=S_Where1+' or '+'Hcode = '+SGrid.Cells[ 0,List1];
        S_Where2:=S_Where2+' or '+'Gcode = '+SGrid.Cells[ 0,List1];
      end;
    end;
    S_Where0:=S_Where0+')';
    S_Where1:=S_Where1+')';
  ...
  if nPort=9999 then ShowMessage('03');

  TSobo30.Create( self );
  if nPort=9999 then ShowMessage('04');

  Base10.Init_Show(Self);
  if nPort=9999 then ShowMessage('05');
  Message_Show(Self);
  if nPort=9999 then ShowMessage('06');

  if nPort<>9000 then begin
  WebBrowser1.Navigate('www.websend.kr\post.htm');
  WebBrowser1.Width := 0;
  end;
  if nPort=9999 then ShowMessage('07');
end;
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button001Click(Self);
  if nForm='39_1' Then Sobo39_1.Button001Click(Self);
  if nForm='39_2' Then Sobo39_2.Button001Click(Self);
  if nForm='39_3' Then Sobo39_3.Button001Click(Self);
  if nForm='39_4' Then Sobo39_4.Button001Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button001Click(Self);
  if nForm='59_2' Then Sobo59_2.Button001Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button002Click(Self);
  if nForm='39_1' Then Sobo39_1.Button002Click(Self);
  if nForm='39_2' Then Sobo39_2.Button002Click(Self);
  if nForm='39_3' Then Sobo39_3.Button002Click(Self);
  if nForm='39_4' Then Sobo39_4.Button002Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button002Click(Self);
  if nForm='59_2' Then Sobo59_2.Button002Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button003Click(Self);
  if nForm='39_1' Then Sobo39_1.Button003Click(Self);
  if nForm='39_2' Then Sobo39_2.Button003Click(Self);
  if nForm='39_3' Then Sobo39_3.Button003Click(Self);
  if nForm='39_4' Then Sobo39_4.Button003Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button003Click(Self);
  if nForm='59_2' Then Sobo59_2.Button003Click(Self);
...
{ if nForm='31' Then Sobo31.Button004Click(Self);
  ...
  if nForm='32_1' Then Sobo32_1.Button004Click(Self);
  if nForm='39_1' Then Sobo39_1.Button004Click(Self);
  if nForm='39_2' Then Sobo39_2.Button004Click(Self);
  if nForm='39_3' Then Sobo39_3.Button004Click(Self);
  if nForm='39_4' Then Sobo39_4.Button004Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button004Click(Self);
  if nForm='59_2' Then Sobo59_2.Button004Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button005Click(Self);
  if nForm='39_1' Then Sobo39_1.Button005Click(Self);
  if nForm='39_2' Then Sobo39_2.Button005Click(Self);
  if nForm='39_3' Then Sobo39_3.Button005Click(Self);
  if nForm='39_4' Then Sobo39_4.Button005Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button005Click(Self);
  if nForm='59_2' Then Sobo59_2.Button005Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button006Click(Self);
  if nForm='39_1' Then Sobo39_1.Button006Click(Self);
  if nForm='39_2' Then Sobo39_2.Button006Click(Self);
  if nForm='39_3' Then Sobo39_3.Button006Click(Self);
  if nForm='39_4' Then Sobo39_4.Button006Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button006Click(Self);
  if nForm='59_2' Then Sobo59_2.Button006Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button007Click(Self);
  if nForm='39_1' Then Sobo39_1.Button007Click(Self);
  if nForm='39_2' Then Sobo39_2.Button007Click(Self);
  if nForm='39_3' Then Sobo39_3.Button007Click(Self);
  if nForm='39_4' Then Sobo39_4.Button007Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button007Click(Self);
  if nForm='59_2' Then Sobo59_2.Button007Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button008Click(Self);
  if nForm='39_1' Then Sobo39_1.Button008Click(Self);
  if nForm='39_2' Then Sobo39_2.Button008Click(Self);
  if nForm='39_3' Then Sobo39_3.Button008Click(Self);
  if nForm='39_4' Then Sobo39_4.Button008Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button008Click(Self);
  if nForm='59_2' Then Sobo59_2.Button008Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button009Click(Self);
  if nForm='39_1' Then Sobo39_1.Button009Click(Self);
  if nForm='39_2' Then Sobo39_2.Button009Click(Self);
  if nForm='39_3' Then Sobo39_3.Button009Click(Self);
  if nForm='39_4' Then Sobo39_4.Button009Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button009Click(Self);
  if nForm='59_2' Then Sobo59_2.Button009Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button010Click(Self);
  if nForm='39_1' Then Sobo39_1.Button010Click(Self);
  if nForm='39_2' Then Sobo39_2.Button010Click(Self);
  if nForm='39_3' Then Sobo39_3.Button010Click(Self);
  if nForm='39_4' Then Sobo39_4.Button010Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button010Click(Self);
  if nForm='59_2' Then Sobo59_2.Button010Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button011Click(Self);
  if nForm='39_1' Then Sobo39_1.Button011Click(Self);
  if nForm='39_2' Then Sobo39_2.Button011Click(Self);
  if nForm='39_3' Then Sobo39_3.Button011Click(Self);
  if nForm='39_4' Then Sobo39_4.Button011Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button011Click(Self);
  if nForm='59_2' Then Sobo59_2.Button011Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button012Click(Self);
  if nForm='34_1' Then Sobo34_1.Button012Click(Self);
  if nForm='34_2' Then Sobo34_2.Button012Click(Self);
  if nForm='34_3' Then Sobo34_3.Button012Click(Self);
  if nForm='34_4' Then Sobo34_4.Button012Click(Self);
  if nForm='39_1' Then Sobo39_1.Button012Click(Self);
  if nForm='39_2' Then Sobo39_2.Button012Click(Self);
  if nForm='39_3' Then Sobo39_3.Button012Click(Self);
  if nForm='39_4' Then Sobo39_4.Button012Click(Self);
  ...
  if nForm='42_1' Then Sobo42_1.Button012Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button012Click(Self);
  if nForm='59_2' Then Sobo59_2.Button012Click(Self);
  ...
  if nForm='93' Then Sobo93.Button012Click(Self);
  if nForm='98' Then Sobo98.Button012Click(Self);
end;
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button013Click(Self);
  if nForm='34_1' Then Sobo34_1.Button013Click(Self);
  if nForm='34_2' Then Sobo34_2.Button013Click(Self);
  if nForm='34_3' Then Sobo34_3.Button013Click(Self);
  if nForm='34_4' Then Sobo34_4.Button013Click(Self);
  if nForm='39_1' Then Sobo39_1.Button013Click(Self);
  if nForm='39_2' Then Sobo39_2.Button013Click(Self);
  if nForm='39_3' Then Sobo39_3.Button013Click(Self);
  if nForm='39_4' Then Sobo39_4.Button013Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button013Click(Self);
  if nForm='59_2' Then Sobo59_2.Button013Click(Self);
  ...
  if nForm='93' Then Sobo93.Button013Click(Self);
end;
...
{ FormActivate(Self);
  ...
  if nForm='32_1' Then Sobo32_1.Button014Click(Self);
  if nForm='39_1' Then Sobo39_1.Button014Click(Self);
  if nForm='39_2' Then Sobo39_2.Button014Click(Self);
  if nForm='39_3' Then Sobo39_3.Button014Click(Self);
  if nForm='39_4' Then Sobo39_4.Button014Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button014Click(Self);
  if nForm='59_2' Then Sobo59_2.Button014Click(Self);
...
{ FormActivate(Self);
  ...
  if nForm='32_1' Then Sobo32_1.Button015Click(Self);
  if nForm='39_1' Then Sobo39_1.Button015Click(Self);
  if nForm='39_2' Then Sobo39_2.Button015Click(Self);
  if nForm='39_3' Then Sobo39_3.Button015Click(Self);
  if nForm='39_4' Then Sobo39_4.Button015Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button015Click(Self);
  if nForm='59_2' Then Sobo59_2.Button015Click(Self);
...
begin
  ...
  if nForm='38' Then Seok30.Button016Click(Self);
  if nForm='39' Then Sobo39.Button016Click(Self);
  if nForm='30' Then Sobo30.Button016Click(Self);
  if nForm='32_1' Then Sobo32_1.Button016Click(Self);
  if nForm='34_1' Then Sobo34_1.Button016Click(Self);
  if nForm='39_1' Then Sobo39_1.Button016Click(Self);
  if nForm='39_2' Then Sobo39_2.Button016Click(Self);
  if nForm='39_3' Then Sobo39_3.Button016Click(Self);
  if nForm='39_4' Then Sobo39_4.Button016Click(Self);
  ...
  if nForm='45_1' Then Sobo45_1.Button016Click(Self);
  ...
  if nForm='55_1' Then Sobo55_1.Button016Click(Self);
  if nForm='58_1' Then Sobo58_1.Button016Click(Self);
  if nForm='59_1' Then Sobo59_1.Button016Click(Self);
  if nForm='59_2' Then Sobo59_2.Button016Click(Self);
  ...
  if nForm='91' Then Sobo91.Button016Click(Self);
  if nForm='96' Then Sobo96.Button016Click(Self);
  if nForm='97' Then Sobo97.Button016Click(Self);
  if nForm='98' Then Sobo98.Button016Click(Self);
  if nForm='99' Then Sobo99.Button016Click(Self);
end;
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button017Click(Self);
  if nForm='34_1' Then Sobo34_1.Button017Click(Self);
  if nForm='39_1' Then Sobo39_1.Button017Click(Self);
  if nForm='39_2' Then Sobo39_2.Button017Click(Self);
  if nForm='39_3' Then Sobo39_3.Button017Click(Self);
  if nForm='39_4' Then Sobo39_4.Button017Click(Self);
  ...
  if nForm='55_1' Then Sobo55_1.Button017Click(Self);
  if nForm='58_1' Then Sobo58_1.Button017Click(Self);
  if nForm='59_1' Then Sobo59_1.Button017Click(Self);
  if nForm='59_2' Then Sobo59_2.Button017Click(Self);
  ...
  if nForm='99' Then Sobo99.Button017Click(Self);
end;
...
begin
  ...
  if Sobo40.Edit101.Text=Logn3 then begin
    St1:= InputBox('Password변경', '비밀번호를 입력 하세요.  ', '');
    if St1 <> '' then begin
      Sqlen := 'UPDATE Id_Logn SET Gcode=''@Gcode'' '+
               'WHERE Hcode=''@Hcode'' ';
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Print;
  if nForm='39_1' Then Sobo39_1.Print;
  if nForm='39_2' Then Sobo39_2.Print;
  if nForm='39_3' Then Sobo39_3.Print;
  if nForm='39_4' Then Sobo39_4.Print;
  ...
  if nForm='59_1' Then Sobo59_1.Print;
  if nForm='59_2' Then Sobo59_2.Print;
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button021Click(Self);
  if nForm='39_1' Then Sobo39_1.Button021Click(Self);
  if nForm='39_2' Then Sobo39_2.Button021Click(Self);
  if nForm='39_3' Then Sobo39_3.Button021Click(Self);
  if nForm='39_4' Then Sobo39_4.Button021Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button021Click(Self);
  if nForm='59_2' Then Sobo59_2.Button021Click(Self);
...
begin
  ...
  if nForm='32_1' Then Sobo32_1.Button022Click(Self);
  if nForm='39_1' Then Sobo39_1.Button022Click(Self);
  if nForm='39_2' Then Sobo39_2.Button022Click(Self);
  if nForm='39_3' Then Sobo39_3.Button022Click(Self);
  if nForm='39_4' Then Sobo39_4.Button022Click(Self);
  ...
  if nForm='59_1' Then Sobo59_1.Button022Click(Self);
  if nForm='59_2' Then Sobo59_2.Button022Click(Self);
...
procedure TSubu00.Menu103_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub17';
  nUse2:=Base10.Seek_Uses('F17');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo13_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo13_1 := TSobo13_1.Create( self );

    if nUse2='O' then begin
    Sobo13_1.DBGrid101.ReadOnly:=False;
    end;
    if nUse2='R' then begin
    Sobo13_1.DBGrid101.ReadOnly:=True;
    end;
...
procedure TSubu00.Menu107_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub11';
  nUse2:=Base10.Seek_Uses('F11');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo17_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo17_1 := TSobo17_1.Create( self );

    if nUse2='O' then begin
    Sobo17_1.Panel002.Enabled:=True;
    Sobo17_1.Panel004.Enabled:=True;
    Sobo17_1.DBGrid101.OnKeyDown:=Sobo17.DBGrid101KeyDown;
    Sobo17_1.DBGrid101.OnKeyPress:=Sobo17.DBGrid101KeyPress;
    Sobo17_1.DBGrid101.OnDblClick:=Sobo17.DBGrid101DblClick;
    Sobo17_1.DBGrid201.OnKeyDown:=Sobo17.DBGrid201KeyDown;
    Sobo17_1.DBGrid201.OnKeyPress:=Sobo17.DBGrid201KeyPress;
    end;
    if nUse2='R' then begin
    Sobo17_1.Panel002.Enabled:=False;
    Sobo17_1.Panel004.Enabled:=False;
    Sobo17_1.DBGrid101.OnKeyDown:=nil;
    Sobo17_1.DBGrid101.OnKeyPress:=nil;
    Sobo17_1.DBGrid101.OnDblClick:=nil;
    Sobo17_1.DBGrid201.OnKeyDown:=nil;
    Sobo17_1.DBGrid201.OnKeyPress:=nil;
    end;
...
procedure TSubu00.Menu204_9Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub24';
  nUse2:=Base10.Seek_Uses('F24');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo24_9 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo24_9 := TSobo24_9.Create( self );

    if nUse2='O' then begin
    Sobo24_9.DBGrid101.ReadOnly:=False;
    end;
    if nUse2='R' then begin
    Sobo24_9.DBGrid101.ReadOnly:=True;
    end;
...
procedure TSubu00.Menu302_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub34';
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo32_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo32_1 := TSobo32_1.Create( self );
...
begin
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo38 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo38 := TSobo38.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu308_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub29';
  nUse2:=Base10.Seek_Uses('F29');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo38_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo38_1 := TSobo38_1.Create( self );
...
procedure TSubu00.Menu319Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub38';
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo39_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo39_1 := TSobo39_1.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu329Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub39';
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo39_2 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo39_2 := TSobo39_2.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu339Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub39';
  nUse2:=Base10.Seek_Uses('F39');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo39_3 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo39_3 := TSobo39_3.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu349Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub39';
  nUse2:=Base10.Seek_Uses('F39');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo39_4 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo39_4 := TSobo39_4.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu359Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub39';
  nUse2:=Base10.Seek_Uses('F39');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo39_5 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo39_5 := TSobo39_5.Create( self );
...
var I:Integer;
begin
  Sqlen:='Select Gname From Id_Logn Where '+D_Select+'Hcode=''@Hcode''';
  Translate(Sqlen, '@Hcode', '0001');
  Logn3:=Base10.Seek_Name(Sqlen);
  ...
  if Logn3='' then begin
    ...
    Seok80.Label3.Caption:=Logn3;
    Seok80.ShowModal;
  end;
end;

procedure TSubu00.Menu304_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub34';
  nUse2:=Base10.Seek_Uses('F34');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo34_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo34_1 := TSobo34_1.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu304_2Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub34';
  nUse2:=Base10.Seek_Uses('F34');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo34_2 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo34_2 := TSobo34_2.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu304_3Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub34';
  nUse2:=Base10.Seek_Uses('F34');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo34_3 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo34_3 := TSobo34_3.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu304_4Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub34';
  nUse2:=Base10.Seek_Uses('F34');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo34_4 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo34_4 := TSobo34_4.Create( self );
...
if Sobo40.ShowModal=mrOK Then begin
if Sobo40.Edit101.Text=Logn3 then begin
  nUse2:=nUse1+'Sub46';
...
procedure TSubu00.Menu402_1Click(Sender: TObject);
var I:Integer;
begin
  Sqlen:='Select Gpass From Id_Logn Where '+D_Select+'Hcode=''@Hcode''';
  Translate(Sqlen, '@Hcode', '0001');
...
if Sobo40.Edit101.Text=Logn3 then begin
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo42_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo42_1 := TSobo42_1.Create( self );

    if nUse2='O' then begin
    Sobo42_1.DBGrid101.ReadOnly:=False;
    end;
    if nUse2='R' then begin
    Sobo42_1.DBGrid101.ReadOnly:=True;
    end;
...
procedure TSubu00.Menu405_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub43';
  nUse2:=Base10.Seek_Uses('F43');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo45_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo45_1 := TSobo45_1.Create( self );

    if nUse2='O' then begin
    Sobo45_1.DBGrid101.ReadOnly:=False;
    Sobo45_1.DBGrid201.ReadOnly:=False;
    Sobo45_1.DBGrid201.ReadOnly:=False;
    end;
    if nUse2='R' then begin
    Sobo45_1.DBGrid101.ReadOnly:=True;
    Sobo45_1.DBGrid201.ReadOnly:=True;
    Sobo45_1.DBGrid201.ReadOnly:=True;
    end;
...
var I:Integer;
begin
{ Sqlen:='Select Gcode From Id_Logn Where '+D_Select+'Hcode=''@Hcode''';
  Translate(Sqlen, '@Hcode', '0001');
  Logn3:=Base10.Seek_Name(Sqlen);

if Sobo40.ShowModal=mrOK Then
if(Sobo40.Edit101.Text=Logn3)and(Logn3<>'')then begin
  Sqlen := 'UPDATE Id_Logn SET Gcode=''@Gcode'' '+
           'WHERE Hcode=''@Hcode'' ';
  Translate(Sqlen, '@Gcode', '');
  Translate(Sqlen, '@Hcode', '0001');
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.BusyLoop;
  if Base10.Socket.Body_Data = 'ERROR' then ShowMessage(E_Update); }
...
procedure TSubu00.Menu509_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub54';
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo59_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo59_1 := TSobo59_1.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu509_2Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub23';
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo59_2 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo59_2 := TSobo59_2.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu509_3Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub23';
  nUse2:=Base10.Seek_Uses('F23');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo59_3 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo59_3 := TSobo59_3.Create( self );
...
procedure TSubu00.Menu801Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub71';
  nUse2:=Base10.Seek_Uses('F71');
  if nUse2<>'X' then begin
    ...
    Sobo23_1 := TSobo23_1.Create( self );

    if nUse2='O' then begin
    Sobo23_1.DBGrid101.ReadOnly:=False;
    end;
    if nUse2='R' then begin
    Sobo23_1.DBGrid101.ReadOnly:=True;
    end;
...
procedure TSubu00.Menu802Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub72';
  nUse2:=Base10.Seek_Uses('F72');
  if nUse2<>'X' then begin
...
procedure TSubu00.Menu803Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub73';
  nUse2:=Base10.Seek_Uses('F73');
  if nUse2<>'X' then begin
...
procedure TSubu00.Menu804Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub74';
  nUse2:=Base10.Seek_Uses('F74');
  if nUse2<>'X' then begin

    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo55_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo55_1 := TSobo55_1.Create( self );

    if nUse2='O' then begin
    Sobo55_1.DBGrid101.ReadOnly:=False;
    Sobo55_1.DBGrid201.ReadOnly:=False;
    end;
    if nUse2='R' then begin
    Sobo55_1.DBGrid101.ReadOnly:=True;
    Sobo55_1.DBGrid201.ReadOnly:=True;
    end;
...
procedure TSubu00.Menu805Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub75';
  nUse2:=Base10.Seek_Uses('F75');
  if nUse2<>'X' then begin

    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo58_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo58_1 := TSobo58_1.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu901Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub21';
  nUse2:=Base10.Seek_Uses('F21');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo91 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo91 := TSobo91.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu903Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub21';
  nUse2:=Base10.Seek_Uses('F21');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo93 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo93 := TSobo93.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu906Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub21';
  nUse2:=Base10.Seek_Uses('F21');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo96 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo96 := TSobo96.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu907Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub21';
  nUse2:=Base10.Seek_Uses('F21');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo97 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo97 := TSobo97.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu908Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub21';
  nUse2:=Base10.Seek_Uses('F21');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo98 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo98 := TSobo98.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu909Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub21';
  nUse2:=Base10.Seek_Uses('F21');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo99 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo99 := TSobo99.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu202_1Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub27';
  ...
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo22_1 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo22_1 := TSobo22_1.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu202_2Click(Sender: TObject);
var I:Integer;
begin
  nUse2:=nUse1+'Sub27';
  nUse2:=Base10.Seek_Uses('F27');
  if nUse2<>'X' then begin
    ...
    for I:=0 to MDIChildCount - 1 do
    if MDIChildren[I] is TSobo22_2 then begin
       MDIChildren[I].Show;
       Exit;
    end;
    Sobo22_2 := TSobo22_2.Create( self );

  end else
    ShowMessage(E_Connect);
end;

procedure TSubu00.Menu011Click(Sender: TObject);
begin
  nSqry.Append;
end;

procedure TSubu00.Menu012Click(Sender: TObject);
begin
  nSqry.Post;
end;

procedure TSubu00.Menu013Click(Sender: TObject);
begin
  Keybd_event(VK_DELETE,MapVirtualKey(VK_DELETE,0),0,0);
  Keybd_event(VK_DELETE,MapVirtualKey(VK_DELETE,0),KEYEVENTF_KEYUP,0);
end;

procedure TSubu00.Menu021Click(Sender: TObject);
begin
  mSqry.Append;
end;

procedure TSubu00.Menu022Click(Sender: TObject);
begin
  mSqry.Post;
end;

procedure TSubu00.Menu023Click(Sender: TObject);
begin
  Keybd_event(VK_DELETE,MapVirtualKey(VK_DELETE,0),0,0);
  Keybd_event(VK_DELETE,MapVirtualKey(VK_DELETE,0),KEYEVENTF_KEYUP,0);
end;

procedure TSubu00.Message_Show(Sender: TObject);
var
  Reg: TRegistry;
...
begin
  ...
  //Reg.RootKey := HKEY_CURRENT_USER;
    if Reg.OpenKey('HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\RunOnce', False) then begin
       MgDate1:=Reg.ReadString('MgDate1');
       MgDate2:=Reg.ReadString('MgDate2');
       MgDate3:=Reg.ReadString('MgDate3');
       MgDate4:=Reg.ReadString('MgDate4');
    end;
  finally
    Reg.CloseKey;
    Reg.Free;
  ...
  if Base10.Socket.Body_Data <> 'NODATA' then begin
    Base10.Socket.MakeData;
  //if(MgDate1<>Base10.Socket.GetData(1, 1))or(MgDate2<>Base10.Socket.GetData(1, 2))then
    if(MgDate1<System_Data)or(MgDate2<>Base10.Socket.GetData(1, 2))then
    Seok40.Show
    else begin
      Sqlen := 'Select Date1,Date2 From Me_Sage Where Hcode=''@Hcode'' and Date1<=''@Date1'' and Date2>=''@Date2'' ';
      ...
      Base10.Socket.busyloop;
      if Base10.Socket.Body_Data <> 'NODATA' then begin
      //if(MgDate3<>Base10.Socket.GetData(1, 1))or(MgDate4<>Base10.Socket.GetData(1, 2))then
        if(MgDate3<System_Data)or(MgDate4<>Base10.Socket.GetData(1, 2))then
        Seok40.Show;
      end;
    end;
  end else begin
...
procedure TSubu00.Post_Show(Sender: TObject);
...
begin
  if nPort<>9000 then begin
    try
      ...
      Document.ParentWindow.execScript( 'sample4_execDaumPostcode();', 'javascript');
    except
      SetupIni := TIniFile.Create(GetExecPath + 'Config.Ini');
      With SetupIni do begin
        WriteString('Client', 'Port', '9000');
      end;
      SetupIni.Free;
...
procedure TSubu00.Post_Html(Sender: TObject);
begin
  if Cpost='11' then begin
  Sobo11.Edit111.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo11.Edit116.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  end;
  if Cpost='12' then begin
  Sobo12.Edit111.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo12.Edit116.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  end;
  if Cpost='15' then begin
  Sobo15.Edit111.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo15.Edit116.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  end;
  if Cpost='17' then begin
  Sobo17.Edit111.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo17.Edit116.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  end;
  if Cpost='17-1' then begin
  Sobo17_1.Edit111.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo17_1.Edit116.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  end;
  if Cpost='21' then begin
  Sobo21.Edit208.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo21.Edit203.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo21.Edit205Exit(Self);
  end;
  if Cpost='22' then begin
  Sobo22.Edit208.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo22.Edit203.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo22.Edit205Exit(Self);
  end;
  if Cpost='23' then begin
  Sobo23.Edit208.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo23.Edit203.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo23.Edit205Exit(Self);
  end;
  if Cpost='23-1' then begin
  Sobo23_1.Edit208.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo23_1.Edit203.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo23_1.Edit205Exit(Self);
  end;
  if Cpost='26' then begin
  Sobo26.Edit212.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo26.Edit207.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo26.Edit205Exit(Self);
  end;
  if Cpost='91' then begin
  Sobo91.Edit208.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo91.Edit203.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo91.Edit205Exit(Self);
  end;
  if Cpost='96' then begin
  Sobo96.Edit212.Text :=WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value;
  Sobo96.Edit207.Text :=WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value;
  Sobo96.Edit205Exit(Self);
  end;
  WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value:='';
  WebBrowser1.OleObject.Document.all.item('sample4_postcode2').value:='';
  WebBrowser1.OleObject.Document.all.item('sample4_roadAddress').value:='';
  WebBrowser1.OleObject.Document.all.item('sample4_jibunAddress').value:='';
  WebBrowser1.OleObject.Document.all.item('sample4_roadAddressEnglish').value:='';
  WebBrowser1.OleObject.Document.all.item('sample4_jibunAddressEnglish').value:='';
end;

procedure TSubu00.Timer2Timer(Sender: TObject);
begin
  Ccout:=Ccout+1;
  if WebBrowser1.OleObject.Document.all.item('sample4_postcode1').value<>'' then begin
     Post_Html(Self);
     Ccout:=0;
     Timer2.Enabled := False;
  end;

  if Ccout>1000 then begin
    Ccout:=0;
    Timer2.Enabled := False;
  end;
end;

procedure TSubu00.WebBrowser1NewWindow2(Sender: TObject; var ppDisp: IDispatch; var Cancel: WordBool);
begin
  Timer2.Enabled := True;
end;

procedure TSubu00.AutoUpdateX(Sender: TObject);
var AutoUp1,AutoUp2: String;
    Date1, Date2 : TDateTime;
begin
  if FileExists(GetExecPath + 'AutoUpdateY.dll') then begin
    AutoUp1 := GetExecPath + 'AutoUpdateY.exe';
    AutoUp2 := GetExecPath + 'AutoUpdateY.dll';

    Date1:=Get_FileDateTime(AutoUp1);
    Date2:=Get_FileDateTime(AutoUp2);

    if Date1<>Date2 then
    CopyFile(PChar(AutoUp2), PChar(AutoUp1), False);
  end;
end;

function TSubu00.Get_FileDateTime(cPath:String):TDateTime;
var
  Handle : THandle;
  oFile : Integer;
begin
  try
    result := 0;
    if FileExists(cPath) then begin
      Handle  := FileOpen(cPath,fmOpenRead or fmShareDenyNone);
      try
        oFile   := FileGetDate(Handle);
        result  := FileDateToDateTime(oFile);
      finally
        FileClose(Handle);
      end;
    end;
...
function TSubu00.Get_FileSize(const FileName : String): int64;
var
  FileHandle: Integer;
begin
...
procedure TSubu00.ApplicationEvents1Message(var Msg: tagMSG; var Handled: Boolean);
var I: SmallInt;
begin
...
begin
  ...
  if GetLastError() = ERROR_ALREADY_EXISTS then begin
    MessageBox(Application.Handle, '프로그램이 이미 실행중입니다.', '중복실행', MB_OK);
