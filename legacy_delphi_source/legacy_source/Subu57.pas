...
uses Chul, Base01, Tong02, Tong04, TcpLib, Subu22,
   Seak01, Seak02, Seak03, Seak04, Seak05, Seak06, Seak07, Seak08, Seak09,
   Seek01, Seek02, Seek03, Seek04, Seek05, Seek06, Seek07, Seek08, Seek09;

procedure TSobo57.FormActivate(Sender: TObject);
begin
  nForm:='57';
  nSqry:=Base10.T5_Sub71;
  mSqry:=Base10.T5_Sub72;
end;

procedure TSobo57.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo57.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo57:=nil;
...
procedure TSobo57.Button001Click(Sender: TObject);
begin
...
procedure TSobo57.Button002Click(Sender: TObject);
begin
  if mSqry.Active=True Then begin
     oSqry:=mSqry;
  if Seak20.ShowModal=mrOK then
     mSqry.Filtered:=False;
     Tong20.Srart_57_02(Self);
  end;
end;

procedure TSobo57.Button003Click(Sender: TObject);
begin
{ if mSqry.Active=True Then begin
     oSqry:=mSqry;
     Seak30.ShowModal;
...
procedure TSobo57.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button006Click(Sender: TObject);
begin
{ T00:=1;
  Button201Click(Self); }
end;

procedure TSobo57.Button007Click(Sender: TObject);
begin
{ T00:=0;
  Button201Click(Self); }
end;

procedure TSobo57.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo57.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo57.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo57.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo57.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('57-01');
end;

procedure TSobo57.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('57-02');
end;

procedure TSobo57.Button016Click(Sender: TObject);
begin
  Tong40.print_57_01(Self);
end;

procedure TSobo57.Button017Click(Sender: TObject);
begin
  Tong40.print_57_02(Self);
end;

procedure TSobo57.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont3(DBGrid101,DBGrid201);
end;

procedure TSobo57.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo57.Button101Click(Sender: TObject);
...
{ if Hnnnn='4100' then
  ...
  ProgressBar1.Position:=ProgressBar1.Position+1;
    ...
    if Base10.G2_Ggwo.Locate('Hcode;Gcode',VarArrayOf(['',nSqry.FieldByName('Gcode').AsString]),[loCaseInsensitive])=true then
    nSqry.FieldByName('Gname').AsString:=Base10.G2_Ggwo.FieldByName('Gname').AsString;

    if nSqry.FieldByName('Gname').AsString='' then
    if Base10.G2_Ggwo.Locate('Hcode;Gcode',VarArrayOf([nSqry.FieldByName('Hcode').AsString,nSqry.FieldByName('Gcode').AsString]),[loCaseInsensitive])=true then
    nSqry.FieldByName('Gname').AsString:=Base10.G2_Ggwo.FieldByName('Gname').AsString;
    ...
    Sqlen := 'Select Gname From G2_Ggwo Where '+D_Select+'Gcode=''@Gcode'' and Hcode=''@Hcode''';
...
procedure TSobo57.Button201Click(Sender: TObject);
...
procedure TSobo57.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo57.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo57.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo57.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo57.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo57.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo57.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo57.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo57.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo57.Edit115KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo57.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo57.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
{ if Edit106.Focused=True Then begin
  ...
  if Edit106.Focused=True Then begin
    ...
    Seek20.FilterTing(Edit106.Text,Edit103.Text);
...
procedure TSobo57.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo57.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo57.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo57.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo57.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if mSqry.Active=True Then begin
  if Key=VK_ESCAPE Then Edit101.SetFocus;
  end;
...
procedure TSobo57.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo57.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo57.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo57.DataSource2DataChange(Sender: TObject; Field: TField);
var St1,St2: String;
begin
  ...
  nSqry.Filter:=St1;
  nSqry.Filtered:=True;
  Tong20.Srart_57_01(Self);
end;

procedure TSobo57.DBGrid201DblClick(Sender: TObject);
begin
  if(nSqry.RecordCount>0)Then begin
  Subu00.Menu202Click(Self);
  Sobo22.Edit103.Text:=Base10.T5_Sub71.FieldByName('Jubun').AsString;
  Sobo22.Edit101.Text:=Base10.T5_Sub71.FieldByName('Gdate').AsString;
  Sobo22.Edit104.Text:=Base10.T5_Sub71.FieldByName('Gcode').AsString;
  Sobo22.Edit105.Text:=Base10.T5_Sub71.FieldByName('Gname').AsString;
  Sobo22.Edit107.Text:=Base10.T5_Sub72.FieldByName('Hcode').AsString;
  Sobo22.Edit108.Text:=Base10.T5_Sub72.FieldByName('Hname').AsString;
  Sobo22.Label100.Visible:=False;
  Sobo22.Edit106.Visible:=False;
  Sobo22.Edit106.Items.Clear;
  if Base10.T5_Sub71.FieldByName('Gjisa').AsString<>'' then begin
  Sobo22.Label100.Visible:=True;
  Sobo22.Edit106.Visible:=True;
  Sobo22.Edit106.Items.Add(Base10.T5_Sub71.FieldByName('Gjisa').AsString);
  Sobo22.Edit106.ItemIndex:=0;
  end;
  Sobo22.Button101Click(Self);
  end;
end;

procedure TSobo57.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo57.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo57.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo57.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo57.Button701Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit104.Text;
...
procedure TSobo57.Button702Click(Sender: TObject);
begin
  Seek20.Edit1.Text:=Edit106.Text;
  if Edit106.Text='' then
  Seek20.FilterTing('',Edit103.Text) else
  Seek20.FilterTing(Edit106.Text,Edit103.Text);
  if Seek20.Query1.RecordCount=1 Then begin
    Edit105.Text:=Seek20.Query1Gcode.AsString;
    Edit106.Text:=Seek20.Query1Gname.AsString;
