...
uses
  ...
  DBGridEh, ToolEdit, DBClient, dxCore, dxButtons;
...
procedure TSobo98.FormActivate(Sender: TObject);
begin
  nForm:='98';
  nSqry:=T2_Sub81;
  mSqry:=T2_Sub82;
...
procedure TSobo98.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo98.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo98:=nil;
...
procedure TSobo98.Button001Click(Sender: TObject);
begin
...
procedure TSobo98.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo98.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo98.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button008Click(Sender: TObject);
begin
  Tong20.Zoom_Int_01('27');
end;

procedure TSobo98.Button009Click(Sender: TObject);
begin
  Tong20.Zoom_Out_01('27');
end;

procedure TSobo98.Button010Click(Sender: TObject);
begin
//Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo98.Button011Click(Sender: TObject);
begin
//Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo98.Button012Click(Sender: TObject);
begin
  if nSqry.Active=True Then begin
    oSqry:=nSqry;
    ColumnX1(oSqry);
...
procedure TSobo98.Button013Click(Sender: TObject);
begin
{ oSqry:=mSqry;
  Base10.ColumnX1(oSqry,DBGrid201,ProgressBar1); }
end;

procedure TSobo98.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('27-01');
end;

procedure TSobo98.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('27-02');
end;

procedure TSobo98.Button016Click(Sender: TObject);
begin
{ nSqry.First;
...
procedure TSobo98.Button017Click(Sender: TObject);
begin
{ nSqry.First;
  While nSqry.EOF=False do begin
    if(nSqry.FieldByName('Code5').AsString='O')then
...
procedure TSobo98.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button021Click(Sender: TObject);
begin
//Tong20.DBGridFont1(DBGrid101,DBGrid201,StBar101,StBar201);
end;

procedure TSobo98.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button101Click(Sender: TObject);
...
procedure TSobo98.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button301Click(Sender: TObject);
begin
...
procedure TSobo98.Button401Click(Sender: TObject);
begin
    if nSqry.Active=True Then begin
...
procedure TSobo98.Button501Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Button509Click(Sender: TObject);
begin
//
end;

procedure TSobo98.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo98.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo98.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo98.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo98.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo98.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo98.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo98.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo98.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo98.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo98.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo98.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo98.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo98.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo98.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo98.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo98.DBGrid201TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(mSqry,Column);
end;

procedure TSobo98.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
  Button301Click(Self);
end;

procedure TSobo98.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo98.DBGrid101DblClick(Sender: TObject);
begin
  if(nSqry.RecordCount>0)Then begin
  Subu00.Menu901Click(Self);
  Sobo91.Edit103.Text:=T2_Sub81.FieldByName('Jubun').AsString;
  Sobo91.Edit101.Text:=Edit101.Text;
  Sobo91.Edit104.Text:=T2_Sub81.FieldByName('Gcode').AsString;
  Sobo91.Edit105.Text:=T2_Sub81.FieldByName('Gname').AsString;
  Sobo91.Edit107.Text:=T2_Sub81.FieldByName('Hcode').AsString;
  Sobo91.Edit108.Text:=T2_Sub81.FieldByName('Hname').AsString;
  Sobo91.Edit109.Text:='';
  ...
  Sobo91.Edit106.Items.Add(T2_Sub81.FieldByName('Gjisa').AsString);
...
procedure TSobo98.DBGrid101DrawColumnCell(Sender: TObject;
...
procedure TSobo98.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo98.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo98.Button701Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
...
procedure TSobo98.Button702Click(Sender: TObject);
begin
    Seak80.Edit1.Text:='';
    Seak80.FilterTing('');
    if Seak80.Query1.RecordCount=1 Then begin
...
procedure TSobo98.Edit205Click(Sender: TObject);
begin
...
procedure TSobo98.Edit205Exit(Sender: TObject);
begin
  StaticText1.Visible:=False;
  StaticText2.Visible:=False;
  StaticText3.Visible:=False;
...
procedure TSobo98.StaticText1Click(Sender: TObject);
begin
  StaticText1.Visible:=False;
  Edit205.SetFocus;
end;

procedure TSobo98.StaticText2Click(Sender: TObject);
begin
  StaticText2.Visible:=False;
  Edit206.SetFocus;
end;

procedure TSobo98.StaticText3Click(Sender: TObject);
begin
  StaticText3.Visible:=False;
  Edit207.SetFocus;
end;

procedure TSobo98.ColumnX1(TableX: TClientDataSet);
var I: Integer;
  St1: Integer;
cFieldname: string;
