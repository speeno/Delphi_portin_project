object Seek40: TSeek40
  ...
  object Query1: TClientDataSet
    ...
    object Query1GJEJA: TStringField
      FieldName = 'GJEJA'
      Size = 30
    end
    object Query1GDANG: TFloatField
      FieldName = 'GDANG'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object Query1GBJIL: TStringField
      FieldName = 'GBJIL'
      Size = 6
    end
    object Query1GRAT9: TSmallintField
      FieldName = 'GRAT9'
    end
  end
end
