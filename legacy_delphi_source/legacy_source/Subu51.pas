...
procedure TSobo51.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo51.DBGrid201TitleClick(Column: TColumnEh);
begin
//
end;
...
procedure TSobo51.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo51.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo51.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo51.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo51.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo51.Button801Click(Sender: TObject);
...
begin
  ...
  { if Sobo52.Caption='재고변경관리-(본사)' then begin
    ...
    sSqry.First;
    While sSqry.EOF=False do begin
      T01:=T01+sSqry.FieldByName('Gbqut').AsFloat;
      sSqry.Next;
    end;
    ...
    if T01<>0 then begin
      ...
      nSqry.FieldByName('Scode').AsString:=St9;
...
procedure TSobo51.Button802Click(Sender: TObject);
var St1,St2,St3,St4,St9: String;
    _S1_Ssub,_Sg_Csum,_Sv_Ghng: String;
begin
