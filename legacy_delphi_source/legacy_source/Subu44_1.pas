...
uses
  ...
  CornerButton, dxCore, dxButtons, DBClient;

type
  TSobo44_1 = class(TForm)
...
procedure TSobo44_1.FormActivate(Sender: TObject);
begin
  nForm:='44_1';
  nSqry:=T4_Sub41;
  mSqry:=T4_Sub42;
...
procedure TSobo44_1.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo44_1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo44_1:=nil;
...
procedure TSobo44_1.Button001Click(Sender: TObject);
begin
...
procedure TSobo44_1.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo44_1.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo44_1.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo44_1.Button011Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid201, Caption);
end;

procedure TSobo44_1.Button012Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo44_1.Button013Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo44_1.Button014Click(Sender: TObject);
begin
  Tong20.Print_00_00('44-01');
end;

procedure TSobo44_1.Button015Click(Sender: TObject);
begin
  Tong20.Print_00_00('44-02');
end;

procedure TSobo44_1.Button016Click(Sender: TObject);
begin
  Tong40.print_44_01(Self);
end;

procedure TSobo44_1.Button017Click(Sender: TObject);
begin
{ Tong40.print_44_02(Self); }
end;

procedure TSobo44_1.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont4(DBGrid101);
end;

procedure TSobo44_1.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo44_1.Button101Click(Sender: TObject);
var St1,St2: String;
begin
...
procedure TSobo44_1.Button201Click(Sender: TObject);
var St1,St2: String;
begin
  nSqry.First;
  mSqry.First;
  While nSqry.EOF=False do begin
    ...
    St2:=nSqry.FieldByName('Scode').AsString;
    if mSqry.Locate('Hcode;Scode',VarArrayOf([St1,St2]),[loCaseInsensitive])=False then begin
      mSqry.Append;
  ...
  mSqry.IndexName := 'IDX'+'HCODE'+'DOWN';
  nSqry.First;
  mSqry.First;
end;

procedure TSobo44_1.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo44_1.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo44_1.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo44_1.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo44_1.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo44_1.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo44_1.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo44_1.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo44_1.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo44_1.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo44_1.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo44_1.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo44_1.DBGrid101Enter(Sender: TObject);
begin
//
end;

procedure TSobo44_1.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo44_1.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo44_1.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo44_1.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo44_1.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo44_1.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo44_1.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo44_1.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
  St1:='Hcode'+'='+#39+mSqry.FieldByName('Hcode').AsString+#39;
  nSqry.Filter:=St1;
  nSqry.Filtered:=True;
  Tong20.Srart_44_01(Self);
end;

procedure TSobo44_1.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo44_1.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo44_1.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo44_1.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo44_1.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
