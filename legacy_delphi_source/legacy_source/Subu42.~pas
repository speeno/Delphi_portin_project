...
uses
  ...
  CornerButton, dxCore, dxButtons, DBGridEh;
...
procedure TSobo42.FormActivate(Sender: TObject);
begin
  nForm:='42';
  nSqry:=Base10.T4_Sub21;
  mSqry:=Base10.T4_Sub22;
end;

procedure TSobo42.FormShow(Sender: TObject);
begin
  T00:=0;
  Edit101.Text:=FormatDateTime('yyyy"."mm"',Date);
end;

procedure TSobo42.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo42:=nil;
...
procedure TSobo42.Button001Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button002Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button003Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button008Click(Sender: TObject);
begin
//Tong20.Zoom_Int_01('42');
end;

procedure TSobo42.Button009Click(Sender: TObject);
begin
//Tong20.Zoom_Out_01('42');
end;

procedure TSobo42.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo42.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo42.Button013Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('42-01');
end;

procedure TSobo42.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('42-02');
end;

procedure TSobo42.Button016Click(Sender: TObject);
begin
  Tong40.print_42_01(Self);
end;

procedure TSobo42.Button017Click(Sender: TObject);
begin
{ Tong40.print_42_02(Self); }
end;

procedure TSobo42.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont4(DBGrid101);
end;

procedure TSobo42.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Button101Click(Sender: TObject);
var St1,St2: String;
begin
//if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;
  ...
  Sqlen := 'Select Hcode,Sum26,Sum27,Sum28 From T2_Ssub Where '+D_Select+St1+St2;
  ...
  List1:=List1+1;
    ...
    nSqry.FieldByName('Hcode').Value:=SGrid.Cells[ 0,List1];
  ...
  St1:='Sdate'+'>='+#39+Edit101.Text+'.00'+#39+' and '+
       'Sdate'+'<='+#39+Edit101.Text+'.99'+#39;

  St1:='Sdate'+' ='+#39+Edit101.Text+#39;
  ...
  List1:=List1+1;
    ...
    if nSqry.Locate('Hcode',St2,[loCaseInsensitive])=True then begin
      nSqry.Edit;
...
procedure TSobo42.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo42.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo42.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo42.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo42.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo42.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo42.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo42.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo42.Edit113KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    Edits: TFlatComboBox;
begin
...
procedure TSobo42.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
procedure TSobo42.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo42.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo42.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo42.DBGrid201Exit(Sender: TObject);
begin
//
end;

procedure TSobo42.DBGrid101Enter(Sender: TObject);
begin
//
end;

procedure TSobo42.DBGrid201Enter(Sender: TObject);
begin
//
end;

procedure TSobo42.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo42.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo42.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo42.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo42.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo42.DBGrid201TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo42.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo42.DataSource2DataChange(Sender: TObject; Field: TField);
var St1: String;
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo42.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
