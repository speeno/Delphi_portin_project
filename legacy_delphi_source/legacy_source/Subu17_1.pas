...
function TSobo17_1.CurrText: TRxTextAttributes;
begin
...
procedure TSobo17_1.GetFontNames;
var
  DC: HDC;
begin
  DC := GetDC(0);
...
procedure TSobo17_1.FontNameChange(Sender: TObject);
begin
//if FUpdating then Exit;
  CurrText.Name := FontName.Items[FontName.ItemIndex];
end;

procedure TSobo17_1.FontSizeChange(Sender: TObject);
begin
//if FUpdating then Exit;
  CurrText.Size := StrToInt(FontSize.Text);
end;

procedure TSobo17_1.BoldButtonClick(Sender: TObject);
begin
//if FUpdating then Exit;
...
procedure TSobo17_1.ItalicButtonClick(Sender: TObject);
begin
//if FUpdating then Exit;
...
procedure TSobo17_1.UnderlineButtonClick(Sender: TObject);
begin
//if FUpdating then Exit;
...
procedure TSobo17_1.LeftAlignClick(Sender: TObject);
begin
//if FUpdating then Exit;
  Editor.Paragraph.Alignment := TParaAlignment(TComponent(Sender).Tag);
end;

procedure TSobo17_1.CenterAlignClick(Sender: TObject);
begin
//if FUpdating then Exit;
  Editor.Paragraph.Alignment := TParaAlignment(TComponent(Sender).Tag);
end;

procedure TSobo17_1.RightAlignClick(Sender: TObject);
begin
//if FUpdating then Exit;
  Editor.Paragraph.Alignment := TParaAlignment(TComponent(Sender).Tag);
end;

procedure TSobo17_1.BulletsButtonClick(Sender: TObject);
begin
//if FUpdating then Exit;
  Editor.Paragraph.Numbering := TRxNumbering(BulletsButton.Down);
end;

procedure TSobo17_1.UndoButtonClick(Sender: TObject);
begin
...
procedure TSobo17_1.FormPaint(Sender: TObject);
begin
{ Button023Click(Self);
  Button024Click(Self); }
  Sobo17_1.OnPaint:=Nil;
  Sobo17_1.OnShow:=FormShow;
  FormShow(Self);
end;

procedure TSobo17_1.FormActivate(Sender: TObject);
begin
  nForm:='17_1';
  nSqry:=T1_Sub71;
  mSqry:=T1_Sub72;
...
procedure TSobo17_1.FormShow(Sender: TObject);
begin
  GetFontNames;
  FontSize.Text := '10';
...
procedure TSobo17_1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo17_1:=nil;
...
procedure TSobo17_1.Button001Click(Sender: TObject);
begin
...
procedure TSobo17_1.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo17_1.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo17_1.Button004Click(Sender: TObject);
begin
{ nSqry.Edit;
...
procedure TSobo17_1.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button008Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button009Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button010Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnX0(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo17_1.Button013Click(Sender: TObject);
begin
  oSqry:=mSqry;
  Base10.ColumnX0(oSqry,DBGrid201,ProgressBar1);
end;

procedure TSobo17_1.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('17-01');
end;

procedure TSobo17_1.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('17-01');
end;

procedure TSobo17_1.Button016Click(Sender: TObject);
begin
//Tong40.print_17_01(Self);
end;

procedure TSobo17_1.Button017Click(Sender: TObject);
begin
//Tong40.print_17_02(Self);
end;

procedure TSobo17_1.Button018Click(Sender: TObject);
begin
//Tong40.print_17_03(Self);
end;

procedure TSobo17_1.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button021Click(Sender: TObject);
begin
//
end;

procedure TSobo17_1.Button022Click(Sender: TObject);
begin
  nSqry.SaveToFile('.\Data\G7_Ggeo.cds');
end;

procedure TSobo17_1.Button023Click(Sender: TObject);
begin
...
procedure TSobo17_1.Button024Click(Sender: TObject);
begin
  Edit201.Text := mSqry.FieldByName('Gcode').AsString;
  Edit202.Text := mSqry.FieldByName('Gname').AsString;
end;

procedure TSobo17_1.Button101Click(Sender: TObject);
begin
...
procedure TSobo17_1.Button102Click(Sender: TObject);
var MeDlg: Integer;
    St1,St2: String;
    Sq1,Sq2: String;
begin
...
procedure TSobo17_1.Button103Click(Sender: TObject);
var MeDlg: Integer;
begin
...
procedure TSobo17_1.Button104Click(Sender: TObject);
begin
  Cpost:='17-1';
...
procedure TSobo17_1.Button201Click(Sender: TObject);
begin
  mSqry.Insert;
...
procedure TSobo17_1.Button202Click(Sender: TObject);
var MeDlg: Integer;
begin
MeDlg := MessageDlg('저장 하시겠습니까?', mtConfirmation, [mbYes, mbNo], 0);
case MeDlg of
...
procedure TSobo17_1.Button203Click(Sender: TObject);
var MeDlg: Integer;
begin
MeDlg := MessageDlg('삭제 하시겠습니까?', mtConfirmation, [mbYes, mbNo], 0);
case MeDlg of
...
procedure TSobo17_1.Edit101Exit(Sender: TObject);
var St1,St2: String;
begin
...
procedure TSobo17_1.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo17_1.Edit101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo17_1.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo17_1.Edit102KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo17_1.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo17_1.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo17_1.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo17_1.Edit112KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGrid;
    Edits: TFlatComboBox;
begin
...
procedure TSobo17_1.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
procedure TSobo17_1.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
    Button202Click(Self);
    DBGrid201.SetFocus;
...
procedure TSobo17_1.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then begin
    Button202Click(Self);
...
procedure TSobo17_1.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then
...
procedure TSobo17_1.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo17_1.Edit115KeyPress(Sender: TObject; var Key: Char);
var Hands: THandle;
    DGrid: TDBGrid;
    Edits: TFlatComboBox;
begin
...
procedure TSobo17_1.Edit115KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var Edits: TFlatComboBox;
begin
  Edits:=Edit127;
  if Edits.DropDownCount=9 Then begin
...
procedure TSobo17_1.DBGrid101DblClick(Sender: TObject);
begin
{ nSqry.Edit;
  if(nSqry.FieldByName('Ocode').AsString='1')then
     nSqry.FieldByName('Ocode').AsString:=''
...
procedure TSobo17_1.DBGrid101Enter(Sender: TObject);
begin
  if nSqry.State=dsInsert Then Button102Click(Self);
end;

procedure TSobo17_1.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo17_1.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if nSqry.Active=True Then begin
...
procedure TSobo17_1.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo17_1.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TSobo17_1.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo17_1.DBGrid201Exit(Sender: TObject);
begin
  Edit101.Items.Clear;
...
procedure TSobo17_1.DBGrid101TitleClick(Column: TColumn);
begin
  Base10.ColumnSX(nSqry,Column);
end;

procedure TSobo17_1.DataSource1DataChange(Sender: TObject; Field: TField);
begin
...
procedure TSobo17_1.DataSource2DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(mSqry.RecNo)+'/'+IntToStr(mSqry.RecordCount);
end;

procedure TSobo17_1.SeachClick(Str1,Str2: String);
var St1: String;
begin
  Tong40.Show;
  Tong40.Update;
  ...
  Sqlen := 'Select distinct Bigo2 From G7_Ggeo '+
           'Where '+D_Select+'Bigo2 is not null '+
           'Order By Bigo2';
  Base10.Socket.RunSQL(Sqlen);
  Base10.Socket.busyloop;
  if Base10.Socket.Body_Data <> 'NODATA' then begin
  ...
  mSqry.First;
  nSqry.First;
  mSqry.AfterScroll:=T1_Sub72AfterScroll;
  nSqry.AfterScroll:=T1_Sub71AfterScroll;
  Button023Click(Self);
  Button024Click(Self);
...
procedure TSobo17_1.FormCreate(Sender: TObject);
begin
//Application.OnMessage:= AnyMessage;
end;

procedure TSobo17_1.AnyMessage(var Msg: TMsg; var Handled: Boolean);
begin
...
procedure TSobo17_1.RadioButtonClick(Sender: TObject);
begin
...
procedure TSobo17_1.Button300Click(Sender: TObject);
begin
  {-G7_Ggeo-}
  Sqlen := 'Select '+
...
procedure TSobo17_1.Button301Click(Sender: TObject);
...
procedure TSobo17_1.Button302Click(Sender: TObject);
begin
...
procedure TSobo17_1.Button700Click(Sender: TObject);
var Temp1: TStream;
begin
...
procedure TSobo17_1.Button701Click(Sender: TObject);
...
procedure TSobo17_1.Button702Click(Sender: TObject);
begin
...
procedure TSobo17_1.T1_Sub71AfterScroll(DataSet: TDataSet);
begin
  Sobo17_1.Button023Click(Self);
end;

procedure TSobo17_1.T1_Sub72AfterScroll(DataSet: TDataSet);
begin
  Sobo17_1.Button024Click(Self);
end;
