...
procedure TSobo39_1.FormActivate(Sender: TObject);
begin
  nForm:='39_1';
  nSqry:=T3_Sub01;
//mSqry:=T3_Sub01;
...
procedure TSobo39_1.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo39_1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo39_1:=nil;
...
procedure TSobo39_1.Button001Click(Sender: TObject);
begin
...
procedure TSobo39_1.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo39_1.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo39_1.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button008Click(Sender: TObject);
begin
//Tong20.Zoom_Int_01('52');
end;

procedure TSobo39_1.Button009Click(Sender: TObject);
begin
//Tong20.Zoom_Out_01('52');
end;

procedure TSobo39_1.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo39_1.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo39_1.Button013Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('52-01');
end;

procedure TSobo39_1.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('52-02');
end;

procedure TSobo39_1.Button016Click(Sender: TObject);
begin
  Tong40.print_39_11(Self);
end;

procedure TSobo39_1.Button017Click(Sender: TObject);
begin
{ Tong40.print_52_02(Self); }
end;

procedure TSobo39_1.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont4(DBGrid101);
end;

procedure TSobo39_1.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Button101Click(Sender: TObject);
var St1,St2: String;
begin
...
procedure TSobo39_1.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo39_1.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo39_1.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo39_1.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo39_1.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo39_1.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo39_1.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_1.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_1.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_1.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_1.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo39_1.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_1.DBGrid101Exit(Sender: TObject);
begin
  T3_Sub01BeforeClose(T3_Sub01);
end;

procedure TSobo39_1.DBGrid201Exit(Sender: TObject);
begin
//
end;

procedure TSobo39_1.DBGrid101Enter(Sender: TObject);
begin
  T3_Sub01AfterScroll(T3_Sub01);
end;

procedure TSobo39_1.DBGrid201Enter(Sender: TObject);
begin
//
end;

procedure TSobo39_1.DBGrid101KeyPress(Sender: TObject; var Key: Char);
var sColumn: Boolean;
    sIndexs: Integer;
...
procedure TSobo39_1.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var sColumn: Boolean;
    sIndexs: Integer;
begin
  if nSqry.Active=True Then begin
...
procedure TSobo39_1.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_1.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_1.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo39_1.DBGrid201TitleClick(Column: TColumnEh);
begin
//
end;

procedure TSobo39_1.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo39_1.DataSource2DataChange(Sender: TObject; Field: TField);
begin
//
end;

procedure TSobo39_1.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo39_1.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo39_1.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo39_1.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo39_1.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo39_1.Button701Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit104.Text;
...
procedure TSobo39_1.Button702Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit106.Text;
...
//--원장변경--//
procedure TSobo39_1.T3_Sub01AfterCancel(DataSet: TDataSet);
begin
  T3_Sub01AfterScroll(T3_Sub01);
end;

procedure TSobo39_1.T3_Sub01AfterScroll(DataSet: TDataSet);
begin
  Gdate:= T3_Sub01.FieldByName('Gdate').AsString;
  Gsqut:=-T3_Sub01.FieldByName('Gsqut').AsFloat;
end;

procedure TSobo39_1.T3_Sub01AfterPost(DataSet: TDataSet);
begin
//
end;

procedure TSobo39_1.T3_Sub01AfterDelete(DataSet: TDataSet);
var MeDlg: Integer;
begin
...
procedure TSobo39_1.T3_Sub01BeforePost(DataSet: TDataSet);
begin
...
procedure TSobo39_1.T3_Sub01BeforeClose(DataSet: TDataSet);
begin
  With T3_Sub01 do
  if(State in dsEditModes)Then Post;
end;

procedure TSobo39_1.T3_Sub01NewRecord(DataSet: TDataSet);
begin
  T3_Sub01Hcode.Value:=Sobo39_1.Edit107.Text;
  T3_Sub01Scode.Value:='B';
