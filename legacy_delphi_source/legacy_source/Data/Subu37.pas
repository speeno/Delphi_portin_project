...
type
  TSobo37 = class(TForm)
    ...
    T3_Sub71ID: TFloatField;
    T3_Sub71GDATE: TStringField;
    T3_Sub71SCODE: TStringField;
    T3_Sub71GCODE: TStringField;
    T3_Sub71GNAME: TStringField;
    T3_Sub71HCODE: TStringField;
    T3_Sub71HNAME: TStringField;
    T3_Sub71NAME1: TStringField;
    T3_Sub71NAME2: TStringField;
    T3_Sub71GNUMB: TStringField;
    T3_Sub71GBIGO: TStringField;
    T3_Sub71GQUT1: TFloatField;
    T3_Sub72: TClientDataSet;
    T3_Sub72ID: TFloatField;
    T3_Sub72GDATE: TStringField;
    T3_Sub72SCODE: TStringField;
    T3_Sub72GCODE: TStringField;
    T3_Sub72GNAME: TStringField;
    T3_Sub72HCODE: TStringField;
    T3_Sub72HNAME: TStringField;
    T3_Sub72NAME1: TStringField;
    T3_Sub72NAME2: TStringField;
    T3_Sub72GNUMB: TStringField;
    T3_Sub72GBIGO: TStringField;
    T3_Sub72GQUT1: TFloatField;
    T3_Sub71GQUT2: TFloatField;
    T3_Sub72GQUT2: TFloatField;
...
procedure TSobo37.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo37.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo37.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo37.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;
...
procedure TSobo37.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo37.DBGrid101Enter(Sender: TObject);
begin
//
end;
...
procedure TSobo37.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(mSqry,Column);
end;

procedure TSobo37.DBGrid201TitleClick(Column: TColumnEh);
begin
...
procedure TSobo37.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo37.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo37.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo37.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo37.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
