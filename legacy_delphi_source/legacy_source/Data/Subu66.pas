...
//if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;
  ...
  List1:=List1+1;
    ...
    if nSqry.Locate('Gcode;Gjisa',VarArrayOf([St3,St6]),[loCaseInsensitive])=False then begin
      if St2='X' then begin
...
//if Base10.Seek_Ggeo(Edit107.Text)='X' Then Exit;
  ...
  'From S1_Ssub Where '+D_Select+St1+
  'Group By Hcode,Scode,Gubun,Pubun ';
...
procedure TSobo66.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo66.DBGrid201TitleClick(Column: TColumnEh);
begin
