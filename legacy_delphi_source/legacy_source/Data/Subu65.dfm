object Sobo65: TSobo65
  ...
  object Label303: TmyLabel3d
    ...
    Width = 13
    Height = 52
    Caption = '상'#13#10'세'#13#10'검'#13#10'색'
    Font.Charset = HANGEUL_CHARSET
    Font.Color = clTeal
    Font.Height = -13
    Font.Name = '굴림'
  ...
  object Panel003: TFlatPanel
    ...
    object DBGrid201: TDBGridEh
      ...
      FooterRowCount = 1
      ImeName = '한국어 입력 시스템 (IME 2000)'
      Options = [dgTitles, dgIndicator, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgMultiSelect]
      ParentFont = False
      SumList.Active = True
      TabOrder = 0
      TitleFont.Charset = HANGEUL_CHARSET
  ...
  object DataSource1: TDataSource
    DataSet = Base10.T6_Sub51
    OnDataChange = DataSource1DataChange
    Left = 42
    Top = 126
  end
  object DataSource2: TDataSource
    DataSet = Base10.T6_Sub52
