...
type
  TSobo39_2 = class(TForm)
    ...
    T3_Sub01GBQUT: TFloatField;
    T3_Sub01GIQUT: TFloatField;
    T3_Sub01GOQUT: TFloatField;
    T3_Sub01GPQUT: TFloatField;
...
procedure TSobo39_2.FormActivate(Sender: TObject);
begin
  nForm:='39_2';
  nSqry:=T3_Sub01;
//mSqry:=T3_Sub01;
...
procedure TSobo39_2.FormShow(Sender: TObject);
begin
  T00:=0;
...
procedure TSobo39_2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action:=caFree;
  Sobo39_2:=nil;
...
procedure TSobo39_2.Button001Click(Sender: TObject);
begin
...
procedure TSobo39_2.Button002Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
...
procedure TSobo39_2.Button003Click(Sender: TObject);
begin
{ if nSqry.Active=True Then begin
     oSqry:=nSqry;
     Seak30.ShowModal;
...
procedure TSobo39_2.Button004Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button005Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button006Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button007Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button008Click(Sender: TObject);
begin
//Tong20.Zoom_Int_01('52');
end;

procedure TSobo39_2.Button009Click(Sender: TObject);
begin
//Tong20.Zoom_Out_01('52');
end;

procedure TSobo39_2.Button010Click(Sender: TObject);
begin
  Tong20.DBGridSaveHtml(DBGrid101, Caption);
end;

procedure TSobo39_2.Button011Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button012Click(Sender: TObject);
begin
  oSqry:=nSqry;
  Base10.ColumnY1(oSqry,DBGrid101,ProgressBar1);
end;

procedure TSobo39_2.Button013Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button014Click(Sender: TObject);
begin
//Tong20.Print_00_00('52-01');
end;

procedure TSobo39_2.Button015Click(Sender: TObject);
begin
//Tong20.Print_00_00('52-02');
end;

procedure TSobo39_2.Button016Click(Sender: TObject);
begin
  Tong40.print_39_21(Self);
end;

procedure TSobo39_2.Button017Click(Sender: TObject);
begin
{ Tong40.print_52_02(Self); }
end;

procedure TSobo39_2.Button018Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button019Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button020Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button021Click(Sender: TObject);
begin
  Tong20.DBGridFont4(DBGrid101);
end;

procedure TSobo39_2.Button022Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button023Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button024Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Button101Click(Sender: TObject);
var St1,St2,St3: String;
    _Sb_Csum,_Sv_Ghng: String;
begin
  ...
  ProgressBar1.Position:=ProgressBar1.Position+1;
    ...
    if nSqry.Locate('Gcode',St3,[loCaseInsensitive])=False then begin
      ...
      nSqry.Append;
      nSqry.FieldByName('Gcode').Value:=St3;
      nSqry.FieldByName('Gname').Value:=St2;
    end;

    nSqry.Edit;
    nSqry.FieldByName('GsumX').AsFloat:=
    nSqry.FieldByName('GsumX').AsFloat+sSqry.FieldByName('Gbqut').AsFloat;
    nSqry.FieldByName('GsumY').AsFloat:=
    nSqry.FieldByName('GsumY').AsFloat+sSqry.FieldByName('Gbqut').AsFloat;
    nSqry.Post;
    sSqry.Next;
  end;
...
procedure TSobo39_2.Button201Click(Sender: TObject);
begin
//
end;

procedure TSobo39_2.Edit101Change(Sender: TObject);
var St1: Char;
begin
  St1:=#13;
...
procedure TSobo39_2.Edit101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo39_2.Edit102KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
end;

procedure TSobo39_2.Edit111KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSobo39_2.Edit111KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key=VK_UP   Then PerForm(WM_NEXTDLGCTL,1,0);
  if Key=VK_DOWN Then PerForm(WM_NEXTDLGCTL,0,0);
end;

procedure TSobo39_2.Edit112KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_2.Edit112KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_2.Edit113KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_2.Edit113KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_2.Edit114KeyPress(Sender: TObject; var Key: Char);
begin
  if Key=#13 Then begin
...
procedure TSobo39_2.Edit114KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_2.DBGrid101Exit(Sender: TObject);
begin
//
end;

procedure TSobo39_2.DBGrid201Exit(Sender: TObject);
begin
//
end;

procedure TSobo39_2.DBGrid101Enter(Sender: TObject);
begin
//
end;

procedure TSobo39_2.DBGrid201Enter(Sender: TObject);
begin
//
end;

procedure TSobo39_2.DBGrid101KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_2.DBGrid101KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_2.DBGrid201KeyPress(Sender: TObject; var Key: Char);
begin
//
end;

procedure TSobo39_2.DBGrid201KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
//
end;

procedure TSobo39_2.DBGrid101TitleClick(Column: TColumnEh);
begin
  Base10.ColumnS9(nSqry,Column);
end;

procedure TSobo39_2.DBGrid201TitleClick(Column: TColumnEh);
begin
//
end;

procedure TSobo39_2.DataSource1DataChange(Sender: TObject; Field: TField);
begin
  Panel009.Caption:=IntToStr(nSqry.RecNo)+'/'+IntToStr(nSqry.RecordCount);
end;

procedure TSobo39_2.DataSource2DataChange(Sender: TObject; Field: TField);
begin
//
end;

procedure TSobo39_2.DateEdit1ButtonClick(Sender: TObject);
begin
  DateEdit1.Date :=StrToDate(Edit101.Text);
end;

procedure TSobo39_2.DateEdit1AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit101.Text :=DateToStr(ADate);
end;

procedure TSobo39_2.DateEdit2ButtonClick(Sender: TObject);
begin
  DateEdit2.Date :=StrToDate(Edit102.Text);
end;

procedure TSobo39_2.DateEdit2AcceptDate(Sender: TObject; var ADate: TDateTime; var Action: Boolean);
begin
  Edit102.Text :=DateToStr(ADate);
end;

procedure TSobo39_2.Button700Click(Sender: TObject);
begin
  Seak80.Edit1.Text:=Edit108.Text;
...
procedure TSobo39_2.Button701Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit104.Text;
...
procedure TSobo39_2.Button702Click(Sender: TObject);
begin
  Seek40.Edit1.Text:=Edit106.Text;
