object Sobo39_5: TSobo39_5
  ...
  object T3_Sub01: TClientDataSet
    Aggregates = <>
    Params = <>
    BeforeClose = T3_Sub01BeforeClose
    BeforePost = T3_Sub01BeforePost
    AfterPost = T3_Sub01AfterPost
    AfterCancel = T3_Sub01AfterCancel
    BeforeScroll = T3_Sub01AfterScroll
    AfterScroll = T3_Sub01AfterScroll
    OnNewRecord = T3_Sub01NewRecord
    Left = 42
    Top = 158
    object T3_Sub01ID: TFloatField
      FieldName = 'ID'
    end
    object T3_Sub01GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T3_Sub01HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T3_Sub01SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T3_Sub01GCODE: TStringField
      FieldName = 'GCODE'
      Size = 10
    end
    object T3_Sub01GNAME: TStringField
      FieldName = 'GNAME'
      Size = 100
    end
    object T3_Sub01GUBUN: TStringField
      FieldName = 'GUBUN'
      Size = 4
    end
    object T3_Sub01GSQUT: TFloatField
      FieldName = 'GSQUT'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T3_Sub01GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
  end
