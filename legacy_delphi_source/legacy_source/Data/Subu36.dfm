object Sobo36: TSobo36
  ...
  object T3_Sub61: TClientDataSet
    Aggregates = <>
    Params = <>
    BeforeClose = T3_Sub61BeforeClose
    BeforePost = T3_Sub61BeforePost
    AfterPost = T3_Sub61AfterPost
    AfterCancel = T3_Sub61AfterCancel
    BeforeScroll = T3_Sub61AfterScroll
    AfterScroll = T3_Sub61AfterScroll
    OnNewRecord = T3_Sub61NewRecord
    Left = 42
    Top = 254
    object T3_Sub61ID: TFloatField
      FieldName = 'ID'
    end
    object T3_Sub61GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T3_Sub61SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T3_Sub61GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T3_Sub61GNAME: TStringField
      FieldName = 'GNAME'
      Size = 50
    end
    object T3_Sub61HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T3_Sub61HNAME: TStringField
      FieldName = 'HNAME'
      Size = 50
    end
    object T3_Sub61NAME1: TStringField
      FieldName = 'NAME1'
      Size = 30
    end
    object T3_Sub61NAME2: TStringField
      FieldName = 'NAME2'
      Size = 30
    end
    object T3_Sub61GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 30
    end
    object T3_Sub61GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
    object T3_Sub61GQUT1: TFloatField
      FieldName = 'GQUT1'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T3_Sub61GQUT2: TFloatField
      FieldName = 'GQUT2'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
  end
  object T3_Sub62: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 74
    Top = 254
    object T3_Sub62ID: TFloatField
      FieldName = 'ID'
    end
    object T3_Sub62GDATE: TStringField
      FieldName = 'GDATE'
      EditMask = '!0000.!90.90;1; '
      Size = 10
    end
    object T3_Sub62SCODE: TStringField
      FieldName = 'SCODE'
      Size = 1
    end
    object T3_Sub62GCODE: TStringField
      FieldName = 'GCODE'
      Size = 5
    end
    object T3_Sub62GNAME: TStringField
      FieldName = 'GNAME'
      Size = 50
    end
    object T3_Sub62HCODE: TStringField
      FieldName = 'HCODE'
      Size = 5
    end
    object T3_Sub62HNAME: TStringField
      FieldName = 'HNAME'
      Size = 50
    end
    object T3_Sub62NAME1: TStringField
      FieldName = 'NAME1'
      Size = 30
    end
    object T3_Sub62NAME2: TStringField
      FieldName = 'NAME2'
      Size = 30
    end
    object T3_Sub62GNUMB: TStringField
      FieldName = 'GNUMB'
      Size = 30
    end
    object T3_Sub62GBIGO: TStringField
      FieldName = 'GBIGO'
      Size = 50
    end
    object T3_Sub62GQUT1: TFloatField
      FieldName = 'GQUT1'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
    object T3_Sub62GQUT2: TFloatField
      FieldName = 'GQUT2'
      DisplayFormat = '###,###,###0'
      EditFormat = '#########0'
    end
