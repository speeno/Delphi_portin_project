...
CAPTION_ALLOWLIST_MISMATCH: frozenset[tuple[str, str, str]] = frozenset(
    {
        # 2026-09-22 사용자 요청 — 메뉴명의 「(마스터)」 접미 제거(DEC-296). 레거시 caption 과의 차이는
        # 「-통합」 접미·출판사 표기뿐.
        ("Subu11", "거래처관리-통합", "거래처관리"),
        ("Subu14", "도서관리-통합", "도서관리"),
        ("Subu17", "출판사관리", "출판사·출고거래처"),
        # 2026-08-23 운영 요청 — 메뉴명을 「재고금액」으로 신설(레거시 caption 은
        # 「재고 및 재고금액」). 같은 화면·같은 dfm, 표기만 축약.
        ("Subu34_1", "재고 및 재고금액", "재고금액"),
        # 2026-08-25 사용자 요청 — 「거래처판매」 → 「거래처별판매」(레거시 caption 은
        # 「거래처판매」). 같은 화면·같은 dfm, 표기만 변경 (DEC-196).
        ("Subu62", "거래처판매", "거래처별판매"),
    }
)
