...
def _routes_for(server_id: str, args: argparse.Namespace) -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            # DEC-295 — 저자 엑셀 필드 카탈로그(거래처 customer-fields 동형).
            "group": "masters.export.author_fields",
            "path": "/api/v1/masters/exports/author-fields",
            "ok_status": {200},
        },
        {
        ...
        {
            "group": "dashboard.external.weather_grid_from_point",
            "path": f"/api/v1/dashboard/external/weather-grid-from-point?serverId={sid}&lat=37.5665&lon=126.978",
            "ok_status": {200},
        },
        {
